...
export default class RepBambelloPlant9 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepBambelloPlant9 =
      this.onSubmitleavesPerPlantRepBambelloPlant9.bind(this);
    ...
    this.leavesPerPlantRepBambelloPlant9Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepBambelloPlant9')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepBambelloPlant9: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepBambelloPlant9')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepBambelloPlant9: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepBambelloPlant9')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepBambelloPlant9: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepBambelloPlant9')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepBambelloPlant9: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepBambelloPlant9')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepBambelloPlant9: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepBambelloPlant9')
        .then(text6Value => {
          this.setState({
            leafLengthRepBambelloPlant9: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepBambelloPlant9')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepBambelloPlant9')
        .then(text8Value => {
          this.setState({
            stmDiameterRepBambelloPlant9: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepBambelloPlant9')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepBambelloPlant9: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('bambelloPlant9Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepBambelloPlant9')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepBambelloPlant9: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 1,
            });
            this.setState({
              trussNumber2RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 2,
            });
            this.setState({
              trussNumber3RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 3,
            });
            this.setState({
              trussNumber4RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 4,
            });
            this.setState({
              trussNumber5RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 5,
            });
            this.setState({
              trussNumber6RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 6,
            });
            this.setState({
              trussNumber7RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 7,
            });
            this.setState({
              trussNumber8RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 8,
            });
            this.setState({
              trussNumber9RepBambelloPlant9:
                parseInt(this.state.trussNumberRepBambelloPlant9) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepBambelloPlant9')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepBambelloPlant9: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepBambelloPlant9')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepBambelloPlant9: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepBambelloPlant9')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepBambelloPlant9: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepBambelloPlant9')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepBambelloPlant9: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepBambelloPlant9')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepBambelloPlant9: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepBambelloPlant9')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepBambelloPlant9: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepBambelloPlant9')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepBambelloPlant9: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepBambelloPlant9')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepBambelloPlant9: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepBambelloPlant9')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepBambelloPlant9: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepBambelloPlant9')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepBambelloPlant9: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepBambelloPlant9')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepBambelloPlant9: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepBambelloPlant9')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepBambelloPlant9: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepBambelloPlant9')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepBambelloPlant9: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepBambelloPlant9')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepBambelloPlant9: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepBambelloPlant9')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepBambelloPlant9: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepBambelloPlant9')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepBambelloPlant9: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepBambelloPlant9')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepBambelloPlant9: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepBambelloPlant9')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepBambelloPlant9: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepBambelloPlant9')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepBambelloPlant9: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepBambelloPlant9')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepBambelloPlant9: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepBambelloPlant9')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepBambelloPlant9: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepBambelloPlant9')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepBambelloPlant9: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepBambelloPlant9')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepBambelloPlant9: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepBambelloPlant9')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepBambelloPlant9: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepBambelloPlant9')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepBambelloPlant9: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepBambelloPlant9')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepBambelloPlant9: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepBambelloPlant9')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepBambelloPlant9: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepBambelloPlant9')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepBambelloPlant9: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepBambelloPlant9')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepBambelloPlant9: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepBambelloPlant9')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepBambelloPlant9: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepBambelloPlant9')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepBambelloPlant9: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepBambelloPlant9')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepBambelloPlant9: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepBambelloPlant9')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepBambelloPlant9: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepBambelloPlant9')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepBambelloPlant9: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepBambelloPlant9')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepBambelloPlant9: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepBambelloPlant9')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepBambelloPlant9: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepBambelloPlant9')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepBambelloPlant9: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepBambelloPlant9')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepBambelloPlant9: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepBambelloPlant9')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepBambelloPlant9: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepBambelloPlant9')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepBambelloPlant9: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepBambelloPlant9')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepBambelloPlant9: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepBambelloPlant9')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepBambelloPlant9: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepBambelloPlant9')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepBambelloPlant9: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepBambelloPlant9')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepBambelloPlant9: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepBambelloPlant9)
        ? parseInt(this.state.setFruitsRepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits1RepBambelloPlant9)
        ? parseInt(this.state.setFruits1RepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits2RepBambelloPlant9)
        ? parseInt(this.state.setFruits2RepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits3RepBambelloPlant9)
        ? parseInt(this.state.setFruits3RepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits4RepBambelloPlant9)
        ? parseInt(this.state.setFruits4RepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits5RepBambelloPlant9)
        ? parseInt(this.state.setFruits5RepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits6RepBambelloPlant9)
        ? parseInt(this.state.setFruits6RepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits7RepBambelloPlant9)
        ? parseInt(this.state.setFruits7RepBambelloPlant9)
        : 0) +
      (parseInt(this.state.setFruits8RepBambelloPlant9)
        ? parseInt(this.state.setFruits8RepBambelloPlant9)
        : 0) +
    ...
    this.setItem(
      'fruitLoadRepBambelloPlant9',
      this.state.fruitLoadRepBambelloPlant9,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepBambelloPlant9 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepBambelloPlant9
            ? this.state.setFruitsRepBambelloPlant9
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepBambelloPlant9
            ? this.state.pruningNumberRepBambelloPlant9
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepBambelloPlant9)
          ? parseInt(this.state.trussNumberRepBambelloPlant9)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepBambelloPlant9: add,
        pruningHarRepBambelloPlant9: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepBambelloPlant9);
    ...
    this.setItem(
      'harvestTrussRepBambelloPlant9',
      this.state.harvestTrussRepBambelloPlant9,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepBambelloPlant9,
    );
            ...
            if (this.state.setFruits5RepBambelloPlant9 === '') {
              if (this.state.setFruits4RepBambelloPlant9 === '') {
                if (this.state.setFruits3RepBambelloPlant9 === '') {
                  if (this.state.setFruits2RepBambelloPlant9 === '') {
                    if (this.state.setFruits1RepBambelloPlant9 === '') {
                      if (this.state.setFruitsRepBambelloPlant9 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepBambelloPlant9,
                        );
                        ...
                        this.setState({
                          ...
                          prunSettingRepBambelloPlant9: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepBambelloPlant9,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepBambelloPlant9,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepBambelloPlant9,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepBambelloPlant9,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepBambelloPlant9,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepBambelloPlant9,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepBambelloPlant9,
                );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepBambelloPlant9,
    );
    ...
    if (this.state.setFlowers9RepBambelloPlant9 === '') {
      if (this.state.setFlowers8RepBambelloPlant9 === '') {
        if (this.state.setFlowers7RepBambelloPlant9 === '') {
          if (this.state.setFlowers6RepBambelloPlant9 === '') {
            if (this.state.setFlowers5RepBambelloPlant9 === '') {
              if (this.state.setFlowers4RepBambelloPlant9 === '') {
                  ...
                  if (this.state.setFlowers2RepBambelloPlant9 === '') {
                    if (this.state.setFlowers1RepBambelloPlant9 === '') {
                      if (this.state.setFlowersRepBambelloPlant9 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepBambelloPlant9,
                        );
                        ...
                        this.setState({
                          ...
                          pruneFloweringRepBambelloPlant9: flowerPruningNumner,
                        });
                        this.setItem(
                          'floweringTrussssRepBambelloPlant9',
                          floweringTruss,
                      ...
                      var number11 =
                        +this.state.trussNumberRepBambelloPlant9 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepBambelloPlant9,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepBambelloPlant9,
                      );
                    ...
                    flowering = parseInt(
                      this.state.setFlowers2RepBambelloPlant9,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepBambelloPlant9,
                    );
                ...
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepBambelloPlant9,
                );
                summ =
                  (flowering ? flowering : 0) +
                  (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepBambelloPlant9,
              );
              flowering = parseInt(this.state.setFlowers5RepBambelloPlant9);
              flowerSetFruits = parseInt(
                this.state.setFruits5RepBambelloPlant9,
              );
              summ =
                (flowering ? flowering : 0) +
                (flowerSetFruits ? flowerSetFruits : 0);
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepBambelloPlant9,
            );
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepBambelloPlant9,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepBambelloPlant9,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepBambelloPlant9,
      );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepBambelloPlant9 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepBambelloPlant9);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepBambelloPlant9: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 1 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepBambelloPlant9: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 2 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepBambelloPlant9: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 3 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepBambelloPlant9: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 4 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepBambelloPlant9: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 5 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepBambelloPlant9: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 6 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepBambelloPlant9: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 7 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepBambelloPlant9: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 8 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepBambelloPlant9: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant9) + 9 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepBambelloPlant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepBambelloPlant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepBambelloPlant9: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      bambelloPlant9Selected: !this.state.bambelloPlant9Selected,
    });
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepBambelloPlant9 !== null &&
      this.state.pruningNumberRepBambelloPlant9 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 1 !== null &&
            this.state.pruningNumber1RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 1 != null &&
      this.state.pruningNumber1RepBambelloPlant9 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 2 !== null &&
            this.state.pruningNumber2RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 2 != null &&
      this.state.pruningNumber2RepBambelloPlant9 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 3 !== null &&
            this.state.pruningNumber3RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 3 !== null &&
      this.state.pruningNumber3RepBambelloPlant9 !== null
    ) {
      let data3 = {
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 4 !== null &&
            this.state.pruningNumber4RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 4 != null &&
      this.state.pruningNumber4RepBambelloPlant9 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 5 !== null &&
            this.state.pruningNumber5RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 5 != null &&
      this.state.pruningNumber5RepBambelloPlant9 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 6 !== null &&
            this.state.pruningNumber6RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 6 != null &&
      this.state.pruningNumber6RepBambelloPlant9 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 7 !== null &&
            this.state.pruningNumber7RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 7 != null &&
      this.state.pruningNumber7RepBambelloPlant9 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 8 !== null &&
            this.state.pruningNumber8RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 8 != null &&
      this.state.pruningNumber8RepBambelloPlant9 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant9) + 9 !== null &&
            this.state.pruningNumber9RepBambelloPlant9 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant9) + 9 != null &&
      this.state.pruningNumber9RepBambelloPlant9 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 9</Text>/ Row No. 232/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.bambelloPlant9Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepBambelloPlant9')
                    }
                    value={this.state.setFlowersRepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumberRepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepBambelloPlant9')
                    }
                    value={this.state.setFlowers1RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber1RepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepBambelloPlant9')
                    }
                    value={this.state.setFlowers2RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber2RepBambelloPlant9}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepBambelloPlant9')
                    }
                    value={this.state.setFlowers3RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber3RepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepBambelloPlant9')
                    }
                    value={this.state.setFlowers4RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber4RepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepBambelloPlant9')
                    }
                    value={this.state.setFlowers5RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber5RepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepBambelloPlant9')
                    }
                    value={this.state.setFlowers6RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber6RepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepBambelloPlant9')
                    }
                    value={this.state.setFlowers7RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber7RepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepBambelloPlant9')
                    }
                    value={this.state.setFlowers8RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber8RepBambelloPlant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepBambelloPlant9')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepBambelloPlant9')
                    }
                    value={this.state.setFlowers9RepBambelloPlant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber9RepBambelloPlant9}
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepBambelloPlant9 <= 22 ||
                      this.state.fruitLoadRepBambelloPlant9 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepBambelloPlant9 <= 0 ||
                      this.state.floweringTrussssRepBambelloPlant9 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepBambelloPlant9}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepBambelloPlant9 <= 1 ||
                      this.state.settingTrussNumberRepBambelloPlant9 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepBambelloPlant9}
                      </Text>
                    </View>
                    <View
                      style={{

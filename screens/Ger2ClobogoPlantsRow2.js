...
export default class Ger2ClobogoPlantsRow2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      weekNumber: '',
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant1);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant2);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant3);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant4);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant5);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant6);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant7);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant8);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant9);
    EventRegister.removeEventListener(this.Ger2ClobogoRow2EventPlant10);
  }
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.Ger2ClobogoRow2EventPlant1 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.Ger2ClobogoRow2EventPlant2 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.Ger2ClobogoRow2EventPlant3 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.Ger2ClobogoRow2EventPlant4 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.Ger2ClobogoRow2EventPlant5 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant5',
      data5 => {
    ...
    //PLANT 6
    this.Ger2ClobogoRow2EventPlant6 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant6',
      data6 => {
    ...
    //PLANT 7
    this.Ger2ClobogoRow2EventPlant7 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant7',
      data7 => {
    ...
    //PLANT 8
    this.Ger2ClobogoRow2EventPlant8 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant8',
      data8 => {
    ...
    //PLANT 9
    this.Ger2ClobogoRow2EventPlant9 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant9',
      data9 => {
    ...
    //PLANT 10
    this.Ger2ClobogoRow2EventPlant10 = EventRegister.addEventListener(
      'Ger2ClobogoRow2EventPlant10',
      data10 => {

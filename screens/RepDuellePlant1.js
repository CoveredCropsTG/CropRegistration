...
export default class RepDuellePlant1 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepDuellePlant1 =
      this.onSubmitleavesPerPlantRepDuellePlant1.bind(this);
    ...
    this.leavesPerPlantRepDuellePlant1Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepDuellePlant1')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepDuellePlant1: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepDuellePlant1')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepDuellePlant1: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepDuellePlant1')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepDuellePlant1: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepDuellePlant1')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepDuellePlant1: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepDuellePlant1')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepDuellePlant1: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepDuellePlant1')
        .then(text6Value => {
    ...
    try {
      AsyncStorage.getItem('leafWidthRepDuellePlant1')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepDuellePlant1')
        .then(text8Value => {
    ...
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepDuellePlant1')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepDuellePlant1: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('DuellePlant1Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepDuellePlant1')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepDuellePlant1: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 1,
            });
            this.setState({
              trussNumber2RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 2,
            });
            this.setState({
              trussNumber3RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 3,
            });
            this.setState({
              trussNumber4RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 4,
            });
            this.setState({
              trussNumber5RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 5,
            });
            this.setState({
              trussNumber6RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 6,
            });
            this.setState({
              trussNumber7RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 7,
            });
            this.setState({
              trussNumber8RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 8,
            });
            this.setState({
              trussNumber9RepDuellePlant1:
                parseInt(this.state.trussNumberRepDuellePlant1) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepDuellePlant1')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepDuellePlant1: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepDuellePlant1')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepDuellePlant1: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepDuellePlant1')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepDuellePlant1: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepDuellePlant1')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepDuellePlant1: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepDuellePlant1')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepDuellePlant1: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepDuellePlant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepDuellePlant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepDuellePlant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepDuellePlant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepDuellePlant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepDuellePlant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepDuellePlant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepDuellePlant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepDuellePlant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepDuellePlant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepDuellePlant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepDuellePlant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepDuellePlant1')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepDuellePlant1: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepDuellePlant1')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepDuellePlant1: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepDuellePlant1')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepDuellePlant1: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepDuellePlant1')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepDuellePlant1: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepDuellePlant1')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepDuellePlant1: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepDuellePlant1')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepDuellePlant1: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepDuellePlant1')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepDuellePlant1: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepDuellePlant1')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepDuellePlant1: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepDuellePlant1')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepDuellePlant1: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepDuellePlant1')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepDuellePlant1: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepDuellePlant1')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepDuellePlant1: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepDuellePlant1')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepDuellePlant1: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepDuellePlant1')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepDuellePlant1: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepDuellePlant1')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepDuellePlant1: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepDuellePlant1')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepDuellePlant1: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepDuellePlant1')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepDuellePlant1: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepDuellePlant1')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepDuellePlant1: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepDuellePlant1')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepDuellePlant1: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepDuellePlant1')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepDuellePlant1: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepDuellePlant1')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepDuellePlant1: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepDuellePlant1')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepDuellePlant1: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepDuellePlant1')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepDuellePlant1: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepDuellePlant1')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepDuellePlant1: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepDuellePlant1')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepDuellePlant1: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepDuellePlant1')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepDuellePlant1: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepDuellePlant1')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepDuellePlant1: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepDuellePlant1')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepDuellePlant1: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepDuellePlant1')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepDuellePlant1: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepDuellePlant1')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepDuellePlant1: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepDuellePlant1')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepDuellePlant1: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepDuellePlant1')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepDuellePlant1: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepDuellePlant1')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepDuellePlant1: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepDuellePlant1')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepDuellePlant1: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepDuellePlant1)
        ? parseInt(this.state.setFruitsRepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits1RepDuellePlant1)
        ? parseInt(this.state.setFruits1RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits2RepDuellePlant1)
        ? parseInt(this.state.setFruits2RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits3RepDuellePlant1)
        ? parseInt(this.state.setFruits3RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits4RepDuellePlant1)
        ? parseInt(this.state.setFruits4RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits5RepDuellePlant1)
        ? parseInt(this.state.setFruits5RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits6RepDuellePlant1)
        ? parseInt(this.state.setFruits6RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits7RepDuellePlant1)
        ? parseInt(this.state.setFruits7RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits8RepDuellePlant1)
        ? parseInt(this.state.setFruits8RepDuellePlant1)
        : 0) +
      (parseInt(this.state.setFruits9RepDuellePlant1)
        ? parseInt(this.state.setFruits9RepDuellePlant1)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepDuellePlant1',
      this.state.fruitLoadRepDuellePlant1,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepDuellePlant1 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepDuellePlant1
            ? this.state.setFruitsRepDuellePlant1
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepDuellePlant1
            ? this.state.pruningNumberRepDuellePlant1
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepDuellePlant1)
          ? parseInt(this.state.trussNumberRepDuellePlant1)
          : 0) + sub
      ).toFixed(2);
      this.setState({
    ...
    this.setItem(
      'harvestTrussRepDuellePlant1',
      this.state.harvestTrussRepDuellePlant1,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepDuellePlant1,
    );
            ...
            if (this.state.setFruits5RepDuellePlant1 === '') {
              if (this.state.setFruits4RepDuellePlant1 === '') {
                if (this.state.setFruits3RepDuellePlant1 === '') {
                  if (this.state.setFruits2RepDuellePlant1 === '') {
                    if (this.state.setFruits1RepDuellePlant1 === '') {
                      if (this.state.setFruitsRepDuellePlant1 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepDuellePlant1,
                        );
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepDuellePlant1,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepDuellePlant1,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepDuellePlant1,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepDuellePlant1,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepDuellePlant1,
                  );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepDuellePlant1,
    );
      ...
      if (this.state.setFlowers8RepDuellePlant1 === '') {
        if (this.state.setFlowers7RepDuellePlant1 === '') {
          if (this.state.setFlowers6RepDuellePlant1 === '') {
            if (this.state.setFlowers5RepDuellePlant1 === '') {
              if (this.state.setFlowers4RepDuellePlant1 === '') {
                if (this.state.setFlowers3RepDuellePlant1 === '') {
                  if (this.state.setFlowers2RepDuellePlant1 === '') {
                    if (this.state.setFlowers1RepDuellePlant1 === '') {
                      if (this.state.setFlowersRepDuellePlant1 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepDuellePlant1,
                        );
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepDuellePlant1,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepDuellePlant1,
                      );
                  ...
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepDuellePlant1,
                  );
                  summ =
                    (flowering ? flowering : 0) +
                    (flowerSetFruits ? flowerSetFruits : 0);
                ...
                flowerPruningNumner = parseInt(
                  this.state.pruningNumber4RepDuellePlant1,
                );
                flowering = parseInt(this.state.setFlowers4RepDuellePlant1);
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepDuellePlant1,
                );
                summ =
                  (flowering ? flowering : 0) +
                  (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepDuellePlant1,
              );
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepDuellePlant1,
            );
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepDuellePlant1,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepDuellePlant1,
        );
    ...
    if (this.state.allTrussData.length != 0) {
      ...
      if (this.state.trussNumberRepDuellePlant1 != null) {
        ...
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 1 != null) {
        ...
        const weekRowTruss2 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 1;
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 2 != null) {
        ...
        const weekRowTruss3 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 2;
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 3 != null) {
        ...
        const weekRowTruss4 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 3;
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 4 != null) {
        ...
        const weekRowTruss5 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 4;
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 5 != null) {
        ...
        const weekRowTruss6 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 5;
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 6 != null) {
        ...
        const weekRowTruss7 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 6;
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 7 != null) {
        ...
        const weekRowTruss8 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 7;
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 8 != null) {
        ...
        const weekRowTruss9 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 8;
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepDuellePlant1: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepDuellePlant1) + 9 != null) {
        ...
        const weekRowTruss10 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant1) + 9;
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepDuellePlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepDuellePlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepDuellePlant1: JSON.stringify(
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepDuellePlant1 !== null &&
      this.state.pruningNumberRepDuellePlant1 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 1 !== null &&
            this.state.pruningNumber1RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 1 != null &&
      this.state.pruningNumber1RepDuellePlant1 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 2 !== null &&
            this.state.pruningNumber2RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 2 != null &&
      this.state.pruningNumber2RepDuellePlant1 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 3 !== null &&
            this.state.pruningNumber3RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 3 !== null &&
      this.state.pruningNumber3RepDuellePlant1 !== null
    ) {
      let data3 = {
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 4 !== null &&
            this.state.pruningNumber4RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 4 != null &&
      this.state.pruningNumber4RepDuellePlant1 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 5 !== null &&
            this.state.pruningNumber5RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 5 != null &&
      this.state.pruningNumber5RepDuellePlant1 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 6 !== null &&
            this.state.pruningNumber6RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 6 != null &&
      this.state.pruningNumber6RepDuellePlant1 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 7 !== null &&
            this.state.pruningNumber7RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 7 != null &&
      this.state.pruningNumber7RepDuellePlant1 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 8 !== null &&
            this.state.pruningNumber8RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 8 != null &&
      this.state.pruningNumber8RepDuellePlant1 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant1) + 9 !== null &&
            this.state.pruningNumber9RepDuellePlant1 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
          }
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant1) + 9 != null &&
      this.state.pruningNumber9RepDuellePlant1 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 1</Text>/ Row No. 432/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={this.state.DuellePlant1Selected ? 'none' : 'auto'}
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumberRepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepDuellePlant1')
                    }
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumberRepDuellePlant1')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameterRepDuellePlant1')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepDuellePlant1')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'trussNumber9RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepDuellePlant1')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepDuellePlant1')
                    }
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepDuellePlant1 <= 22 ||
                      this.state.fruitLoadRepDuellePlant1 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepDuellePlant1 <= 0 ||
                      this.state.floweringTrussssRepDuellePlant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepDuellePlant1}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepDuellePlant1 <= 1 ||
                      this.state.settingTrussNumberRepDuellePlant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepDuellePlant1}
                      </Text>
                    </View>
                    <View
                      style={{

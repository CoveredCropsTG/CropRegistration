...
export default class RepMerliceRow1PlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.merliceRow1EventPlant1 = EventRegister.addEventListener(
      'merliceRow1EventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.merliceRow1EventPlant2 = EventRegister.addEventListener(
      'merliceRow1EventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.merliceRow1EventPlant3 = EventRegister.addEventListener(
      'merliceRow1EventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.merliceRow1EventPlant4 = EventRegister.addEventListener(
      'merliceRow1EventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.merliceRow1EventPlant5 = EventRegister.addEventListener(
      'merliceRow1EventPlant5',
      data5 => {
    ...
    //PLANT 6
    this.merliceRow1EventPlant6 = EventRegister.addEventListener(
      'merliceRow1EventPlant6',
      data6 => {
    ...
    //PLANT 7
    this.merliceRow1EventPlant7 = EventRegister.addEventListener(
      'merliceRow1EventPlant7',
      data7 => {
    ...
    //PLANT 8
    this.merliceRow1EventPlant8 = EventRegister.addEventListener(
      'merliceRow1EventPlant8',
      data8 => {
    ...
    //PLANT 9
    this.merliceRow1EventPlant9 = EventRegister.addEventListener(
      'merliceRow1EventPlant9',
      data9 => {
    ...
    //PLANT 10
    this.merliceRow1EventPlant10 = EventRegister.addEventListener(
      'merliceRow1EventPlant10',
      data10 => {
    ...
    if (plant10Selected == null || plant10Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepMerliceRow1Plant10')
          }
        >
          <Text style={styles.buttonText}>

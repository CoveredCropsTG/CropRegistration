...
export default class RepBambelloPlant5 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepBambelloPlant5 =
      this.onSubmitleavesPerPlantRepBambelloPlant5.bind(this);
    ...
    this.leavesPerPlantRepBambelloPlant5Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepBambelloPlant5')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepBambelloPlant5: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepBambelloPlant5')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepBambelloPlant5: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepBambelloPlant5')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepBambelloPlant5: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepBambelloPlant5')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepBambelloPlant5: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepBambelloPlant5')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepBambelloPlant5: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepBambelloPlant5')
        .then(text6Value => {
          this.setState({
            leafLengthRepBambelloPlant5: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepBambelloPlant5')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepBambelloPlant5')
        .then(text8Value => {
          this.setState({
            stmDiameterRepBambelloPlant5: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepBambelloPlant5')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepBambelloPlant5: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('bambelloPlant5Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepBambelloPlant5')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepBambelloPlant5: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 1,
            });
            this.setState({
              trussNumber2RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 2,
            });
            this.setState({
              trussNumber3RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 3,
            });
            this.setState({
              trussNumber4RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 4,
            });
            this.setState({
              trussNumber5RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 5,
            });
            this.setState({
              trussNumber6RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 6,
            });
            this.setState({
              trussNumber7RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 7,
            });
            this.setState({
              trussNumber8RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 8,
            });
            this.setState({
              trussNumber9RepBambelloPlant5:
                parseInt(this.state.trussNumberRepBambelloPlant5) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepBambelloPlant5')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepBambelloPlant5: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepBambelloPlant5')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepBambelloPlant5: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepBambelloPlant5')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepBambelloPlant5: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepBambelloPlant5')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepBambelloPlant5: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepBambelloPlant5')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepBambelloPlant5: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepBambelloPlant5')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepBambelloPlant5: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepBambelloPlant5')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepBambelloPlant5: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepBambelloPlant5')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepBambelloPlant5: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepBambelloPlant5')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepBambelloPlant5: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepBambelloPlant5')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepBambelloPlant5: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepBambelloPlant5')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepBambelloPlant5: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepBambelloPlant5')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepBambelloPlant5: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepBambelloPlant5')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepBambelloPlant5: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepBambelloPlant5')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepBambelloPlant5: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepBambelloPlant5')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepBambelloPlant5: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepBambelloPlant5')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepBambelloPlant5: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepBambelloPlant5')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepBambelloPlant5: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepBambelloPlant5')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepBambelloPlant5: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepBambelloPlant5')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepBambelloPlant5: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepBambelloPlant5')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepBambelloPlant5: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepBambelloPlant5')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepBambelloPlant5: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepBambelloPlant5')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepBambelloPlant5: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepBambelloPlant5')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepBambelloPlant5: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepBambelloPlant5')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepBambelloPlant5: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepBambelloPlant5')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepBambelloPlant5: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepBambelloPlant5')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepBambelloPlant5: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepBambelloPlant5')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepBambelloPlant5: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepBambelloPlant5')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepBambelloPlant5: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepBambelloPlant5')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepBambelloPlant5: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepBambelloPlant5')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepBambelloPlant5: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepBambelloPlant5')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepBambelloPlant5: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepBambelloPlant5')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepBambelloPlant5: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepBambelloPlant5')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepBambelloPlant5: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepBambelloPlant5')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepBambelloPlant5: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepBambelloPlant5')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepBambelloPlant5: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepBambelloPlant5')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepBambelloPlant5: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepBambelloPlant5')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepBambelloPlant5: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepBambelloPlant5')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepBambelloPlant5: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepBambelloPlant5')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepBambelloPlant5: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepBambelloPlant5')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepBambelloPlant5: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepBambelloPlant5')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepBambelloPlant5: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepBambelloPlant5')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepBambelloPlant5: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepBambelloPlant5')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepBambelloPlant5: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepBambelloPlant5')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepBambelloPlant5: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepBambelloPlant5)
        ? parseInt(this.state.setFruitsRepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits1RepBambelloPlant5)
        ? parseInt(this.state.setFruits1RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits2RepBambelloPlant5)
        ? parseInt(this.state.setFruits2RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits3RepBambelloPlant5)
        ? parseInt(this.state.setFruits3RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits4RepBambelloPlant5)
        ? parseInt(this.state.setFruits4RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits5RepBambelloPlant5)
        ? parseInt(this.state.setFruits5RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits6RepBambelloPlant5)
        ? parseInt(this.state.setFruits6RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits7RepBambelloPlant5)
        ? parseInt(this.state.setFruits7RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits8RepBambelloPlant5)
        ? parseInt(this.state.setFruits8RepBambelloPlant5)
        : 0) +
      (parseInt(this.state.setFruits9RepBambelloPlant5)
        ? parseInt(this.state.setFruits9RepBambelloPlant5)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepBambelloPlant5',
      this.state.fruitLoadRepBambelloPlant5,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepBambelloPlant5 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepBambelloPlant5
            ? this.state.setFruitsRepBambelloPlant5
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepBambelloPlant5
            ? this.state.pruningNumberRepBambelloPlant5
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepBambelloPlant5)
          ? parseInt(this.state.trussNumberRepBambelloPlant5)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepBambelloPlant5: add,
        pruningHarRepBambelloPlant5: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepBambelloPlant5);
    ...
    this.setItem(
      'harvestTrussRepBambelloPlant5',
      this.state.harvestTrussRepBambelloPlant5,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepBambelloPlant5,
    );
            ...
            if (this.state.setFruits5RepBambelloPlant5 === '') {
              if (this.state.setFruits4RepBambelloPlant5 === '') {
                if (this.state.setFruits3RepBambelloPlant5 === '') {
                  if (this.state.setFruits2RepBambelloPlant5 === '') {
                    if (this.state.setFruits1RepBambelloPlant5 === '') {
                      if (this.state.setFruitsRepBambelloPlant5 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepBambelloPlant5,
                        );
                        ...
                        this.setState({
                          ...
                          prunSettingRepBambelloPlant5: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepBambelloPlant5,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepBambelloPlant5,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepBambelloPlant5,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepBambelloPlant5,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepBambelloPlant5,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepBambelloPlant5,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepBambelloPlant5,
                );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepBambelloPlant5,
    );
    ...
    if (this.state.setFlowers9RepBambelloPlant5 === '') {
      if (this.state.setFlowers8RepBambelloPlant5 === '') {
        if (this.state.setFlowers7RepBambelloPlant5 === '') {
          if (this.state.setFlowers6RepBambelloPlant5 === '') {
            if (this.state.setFlowers5RepBambelloPlant5 === '') {
              if (this.state.setFlowers4RepBambelloPlant5 === '') {
                  ...
                  if (this.state.setFlowers2RepBambelloPlant5 === '') {
                    if (this.state.setFlowers1RepBambelloPlant5 === '') {
                      if (this.state.setFlowersRepBambelloPlant5 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepBambelloPlant5,
                        );
                        ...
                        this.setState({
                          ...
                          pruneFloweringRepBambelloPlant5: flowerPruningNumner,
                        });
                        this.setItem(
                          'floweringTrussssRepBambelloPlant5',
                          floweringTruss,
                      ...
                      var number11 =
                        +this.state.trussNumberRepBambelloPlant5 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepBambelloPlant5,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepBambelloPlant5,
                      );
                    ...
                    flowering = parseInt(
                      this.state.setFlowers2RepBambelloPlant5,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepBambelloPlant5,
                    );
                ...
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepBambelloPlant5,
                );
                summ =
                  (flowering ? flowering : 0) +
                  (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepBambelloPlant5,
              );
              flowering = parseInt(this.state.setFlowers5RepBambelloPlant5);
              flowerSetFruits = parseInt(
                this.state.setFruits5RepBambelloPlant5,
              );
              summ =
                (flowering ? flowering : 0) +
                (flowerSetFruits ? flowerSetFruits : 0);
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepBambelloPlant5,
            );
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepBambelloPlant5,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepBambelloPlant5,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepBambelloPlant5,
      );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepBambelloPlant5 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepBambelloPlant5);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepBambelloPlant5: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 1 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepBambelloPlant5: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 2 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepBambelloPlant5: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 3 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepBambelloPlant5: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 4 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepBambelloPlant5: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 5 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepBambelloPlant5: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 6 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepBambelloPlant5: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 7 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepBambelloPlant5: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 8 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepBambelloPlant5: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant5) + 9 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepBambelloPlant5: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepBambelloPlant5: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepBambelloPlant5: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      bambelloPlant5Selected: !this.state.bambelloPlant5Selected,
    });
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepBambelloPlant5 !== null &&
      this.state.pruningNumberRepBambelloPlant5 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 1 !== null &&
            this.state.pruningNumber1RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 1 != null &&
      this.state.pruningNumber1RepBambelloPlant5 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 2 !== null &&
            this.state.pruningNumber2RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 2 != null &&
      this.state.pruningNumber2RepBambelloPlant5 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 3 !== null &&
            this.state.pruningNumber3RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 3 !== null &&
      this.state.pruningNumber3RepBambelloPlant5 !== null
    ) {
      let data3 = {
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 4 !== null &&
            this.state.pruningNumber4RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 4 != null &&
      this.state.pruningNumber4RepBambelloPlant5 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 5 !== null &&
            this.state.pruningNumber5RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 5 != null &&
      this.state.pruningNumber5RepBambelloPlant5 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 6 !== null &&
            this.state.pruningNumber6RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 6 != null &&
      this.state.pruningNumber6RepBambelloPlant5 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 7 !== null &&
            this.state.pruningNumber7RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 7 != null &&
      this.state.pruningNumber7RepBambelloPlant5 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 8 !== null &&
            this.state.pruningNumber8RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 8 != null &&
      this.state.pruningNumber8RepBambelloPlant5 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant5) + 9 !== null &&
            this.state.pruningNumber9RepBambelloPlant5 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant5) + 9 != null &&
      this.state.pruningNumber9RepBambelloPlant5 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 5</Text>/ Row No. 232/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.bambelloPlant5Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepBambelloPlant5')
                    }
                    value={this.state.setFlowersRepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumberRepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepBambelloPlant5')
                    }
                    value={this.state.setFlowers1RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber1RepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepBambelloPlant5')
                    }
                    value={this.state.setFlowers2RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber2RepBambelloPlant5}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepBambelloPlant5')
                    }
                    value={this.state.setFlowers3RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber3RepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepBambelloPlant5')
                    }
                    value={this.state.setFlowers4RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber4RepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepBambelloPlant5')
                    }
                    value={this.state.setFlowers5RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber5RepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepBambelloPlant5')
                    }
                    value={this.state.setFlowers6RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber6RepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepBambelloPlant5')
                    }
                    value={this.state.setFlowers7RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber7RepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepBambelloPlant5')
                    }
                    value={this.state.setFlowers8RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber8RepBambelloPlant5}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepBambelloPlant5')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepBambelloPlant5')
                    }
                    value={this.state.setFlowers9RepBambelloPlant5}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber9RepBambelloPlant5}
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepBambelloPlant5 <= 22 ||
                      this.state.fruitLoadRepBambelloPlant5 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepBambelloPlant5 <= 0 ||
                      this.state.floweringTrussssRepBambelloPlant5 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepBambelloPlant5}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepBambelloPlant5 <= 1 ||
                      this.state.settingTrussNumberRepBambelloPlant5 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepBambelloPlant5}
                      </Text>
                    </View>
                    <View
                      style={{

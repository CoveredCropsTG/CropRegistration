...
export default class Ger5ProdellePlantsRow1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      weekNumber: '',
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.ger5ProdelleRow1EventPlant1);
    EventRegister.removeEventListener(this.ger5ProdelleRow1EventPlant2);
    EventRegister.removeEventListener(this.ger5ProdelleRow1EventPlant3);
    EventRegister.removeEventListener(this.ger5ProdelleRow1EventPlant4);
    EventRegister.removeEventListener(this.ger5ProdelleRow1EventPlant5);
  }
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.ger5ProdelleRow1EventPlant1 = EventRegister.addEventListener(
      'ger5ProdelleRow1EventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.ger5ProdelleRow1EventPlant2 = EventRegister.addEventListener(
      'ger5ProdelleRow1EventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.ger5ProdelleRow1EventPlant3 = EventRegister.addEventListener(
      'ger5ProdelleRow1EventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.ger5ProdelleRow1EventPlant4 = EventRegister.addEventListener(
      'ger5ProdelleRow1EventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.ger5ProdelleRow1EventPlant5 = EventRegister.addEventListener(
      'ger5ProdelleRow1EventPlant5',
      data5 => {

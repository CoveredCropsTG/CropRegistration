...
export default class RepAngelleRow1Plant2 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepAngelleRow1Plant2 =
      this.onSubmitleavesPerPlantRepAngelleRow1Plant2.bind(this);
    ...
    this.leavesPerPlantRepAngelleRow1Plant2Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepAngelleRow1Plant2')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepAngelleRow1Plant2: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepAngelleRow1Plant2')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepAngelleRow1Plant2: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepAngelleRow1Plant2')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepAngelleRow1Plant2: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepAngelleRow1Plant2')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepAngelleRow1Plant2: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepAngelleRow1Plant2')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepAngelleRow1Plant2: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepAngelleRow1Plant2')
        .then(text6Value => {
          this.setState({
            leafLengthRepAngelleRow1Plant2: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepAngelleRow1Plant2')
        .then(text7Value => {
          this.setState({
            leafWidthRepAngelleRow1Plant2: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterRepAngelleRow1Plant2')
        .then(text8Value => {
          this.setState({
            stmDiameterRepAngelleRow1Plant2: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepAngelleRow1Plant2')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepAngelleRow1Plant2: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('AngelleRow1Plant2Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepAngelleRow1Plant2')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepAngelleRow1Plant2: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 1,
            });
            this.setState({
              trussNumber2RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 2,
            });
            this.setState({
              trussNumber3RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 3,
            });
            this.setState({
              trussNumber4RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 4,
            });
            this.setState({
              trussNumber5RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 5,
            });
            this.setState({
              trussNumber6RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 6,
            });
            this.setState({
              trussNumber7RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 7,
            });
            this.setState({
              trussNumber8RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 8,
            });
            this.setState({
              trussNumber9RepAngelleRow1Plant2:
                parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepAngelleRow1Plant2')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepAngelleRow1Plant2: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepAngelleRow1Plant2')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepAngelleRow1Plant2: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepAngelleRow1Plant2')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepAngelleRow1Plant2: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepAngelleRow1Plant2')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepAngelleRow1Plant2: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepAngelleRow1Plant2')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepAngelleRow1Plant2: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepAngelleRow1Plant2')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepAngelleRow1Plant2: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepAngelleRow1Plant2')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepAngelleRow1Plant2: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepAngelleRow1Plant2')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepAngelleRow1Plant2: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepAngelleRow1Plant2')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepAngelleRow1Plant2: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepAngelleRow1Plant2')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepAngelleRow1Plant2: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepAngelleRow1Plant2')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepAngelleRow1Plant2: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepAngelleRow1Plant2')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepAngelleRow1Plant2: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepAngelleRow1Plant2')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepAngelleRow1Plant2: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepAngelleRow1Plant2')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepAngelleRow1Plant2: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepAngelleRow1Plant2')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepAngelleRow1Plant2: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepAngelleRow1Plant2')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepAngelleRow1Plant2: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepAngelleRow1Plant2')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepAngelleRow1Plant2: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepAngelleRow1Plant2')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepAngelleRow1Plant2: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepAngelleRow1Plant2')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepAngelleRow1Plant2: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepAngelleRow1Plant2')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepAngelleRow1Plant2: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepAngelleRow1Plant2')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepAngelleRow1Plant2: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepAngelleRow1Plant2')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepAngelleRow1Plant2: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepAngelleRow1Plant2')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepAngelleRow1Plant2: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepAngelleRow1Plant2')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepAngelleRow1Plant2: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepAngelleRow1Plant2')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepAngelleRow1Plant2: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepAngelleRow1Plant2')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepAngelleRow1Plant2: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepAngelleRow1Plant2')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepAngelleRow1Plant2: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepAngelleRow1Plant2')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepAngelleRow1Plant2: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepAngelleRow1Plant2')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepAngelleRow1Plant2: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepAngelleRow1Plant2')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepAngelleRow1Plant2: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepAngelleRow1Plant2')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepAngelleRow1Plant2: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepAngelleRow1Plant2')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepAngelleRow1Plant2: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepAngelleRow1Plant2')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepAngelleRow1Plant2: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepAngelleRow1Plant2')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepAngelleRow1Plant2: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepAngelleRow1Plant2')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepAngelleRow1Plant2: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepAngelleRow1Plant2')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepAngelleRow1Plant2: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepAngelleRow1Plant2')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepAngelleRow1Plant2: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepAngelleRow1Plant2')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepAngelleRow1Plant2: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepAngelleRow1Plant2')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepAngelleRow1Plant2: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepAngelleRow1Plant2')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepAngelleRow1Plant2: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepAngelleRow1Plant2')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepAngelleRow1Plant2: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepAngelleRow1Plant2')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepAngelleRow1Plant2: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepAngelleRow1Plant2')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepAngelleRow1Plant2: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepAngelleRow1Plant2')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepAngelleRow1Plant2: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      ...
      (parseInt(this.state.setFruits1RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits1RepAngelleRow1Plant2)
        : 0) +
      (parseInt(this.state.setFruits2RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits2RepAngelleRow1Plant2)
        : 0) +
      (parseInt(this.state.setFruits3RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits3RepAngelleRow1Plant2)
        : 0) +
      (parseInt(this.state.setFruits4RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits4RepAngelleRow1Plant2)
        : 0) +
      (parseInt(this.state.setFruits5RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits5RepAngelleRow1Plant2)
        : 0) +
      (parseInt(this.state.setFruits6RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits6RepAngelleRow1Plant2)
        : 0) +
      (parseInt(this.state.setFruits7RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits7RepAngelleRow1Plant2)
        : 0) +
      (parseInt(this.state.setFruits8RepAngelleRow1Plant2)
        ? parseInt(this.state.setFruits8RepAngelleRow1Plant2)
        : 0) +
    ...
    this.setItem(
      'fruitLoadRepAngelleRow1Plant2',
      this.state.fruitLoadRepAngelleRow1Plant2,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepAngelleRow1Plant2 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepAngelleRow1Plant2
            ? this.state.setFruitsRepAngelleRow1Plant2
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepAngelleRow1Plant2
            ? this.state.pruningNumberRepAngelleRow1Plant2
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepAngelleRow1Plant2)
          ? parseInt(this.state.trussNumberRepAngelleRow1Plant2)
          : 0) + sub
      ).toFixed(2);
      this.setState({
    ...
    this.setItem(
      'harvestTrussRepAngelleRow1Plant2',
      this.state.harvestTrussRepAngelleRow1Plant2,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepAngelleRow1Plant2,
    );
      ...
      if (this.state.setFruits8RepAngelleRow1Plant2 === '') {
        if (this.state.setFruits7RepAngelleRow1Plant2 === '') {
          if (this.state.setFruits6RepAngelleRow1Plant2 === '') {
            if (this.state.setFruits5RepAngelleRow1Plant2 === '') {
              if (this.state.setFruits4RepAngelleRow1Plant2 === '') {
                if (this.state.setFruits3RepAngelleRow1Plant2 === '') {
                  if (this.state.setFruits2RepAngelleRow1Plant2 === '') {
                    if (this.state.setFruits1RepAngelleRow1Plant2 === '') {
                      if (this.state.setFruitsRepAngelleRow1Plant2 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepAngelleRow1Plant2,
                        );
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepAngelleRow1Plant2,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepAngelleRow1Plant2,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepAngelleRow1Plant2,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepAngelleRow1Plant2,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepAngelleRow1Plant2,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepAngelleRow1Plant2,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepAngelleRow1Plant2,
                );
                trussNum = parseInt(number4);
                settingFruit = parseInt(
                  this.state.setFruits4RepAngelleRow1Plant2,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = parseInt(
                this.state.pruningNumber5RepAngelleRow1Plant2,
              );
              trussNum = parseInt(number5);
              settingFruit = parseInt(
                this.state.setFruits5RepAngelleRow1Plant2,
              );
            ...
            pruningSet = parseInt(
              this.state.pruningNumber6RepAngelleRow1Plant2,
            );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepAngelleRow1Plant2,
    );
    ...
    if (this.state.setFlowers9RepAngelleRow1Plant2 === '') {
      if (this.state.setFlowers8RepAngelleRow1Plant2 === '') {
        if (this.state.setFlowers7RepAngelleRow1Plant2 === '') {
          if (this.state.setFlowers6RepAngelleRow1Plant2 === '') {
            if (this.state.setFlowers5RepAngelleRow1Plant2 === '') {
              if (this.state.setFlowers4RepAngelleRow1Plant2 === '') {
                if (this.state.setFlowers3RepAngelleRow1Plant2 === '') {
                  if (this.state.setFlowers2RepAngelleRow1Plant2 === '') {
                    if (this.state.setFlowers1RepAngelleRow1Plant2 === '') {
                      if (this.state.setFlowersRepAngelleRow1Plant2 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepAngelleRow1Plant2,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberRepAngelleRow1Plant2 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepAngelleRow1Plant2,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepAngelleRow1Plant2,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberRepAngelleRow1Plant2 + 2;

                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepAngelleRow1Plant2,
                    );
                    flowering = parseInt(
                      this.state.setFlowers2RepAngelleRow1Plant2,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepAngelleRow1Plant2,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberRepAngelleRow1Plant2 + 3;

                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepAngelleRow1Plant2,
                  );
                  flowering = parseInt(
                    this.state.setFlowers3RepAngelleRow1Plant2,
                  );
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepAngelleRow1Plant2,
                  );
                ...
                flowering = parseInt(
                  this.state.setFlowers4RepAngelleRow1Plant2,
                );
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepAngelleRow1Plant2,
                );
            ...
            flowerSetFruits = parseInt(
              this.state.setFruits6RepAngelleRow1Plant2,
            );
            summ =
              (flowering ? flowering : 0) +
              (flowerSetFruits ? flowerSetFruits : 0);
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepAngelleRow1Plant2,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepAngelleRow1Plant2,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepAngelleRow1Plant2,
      );
      ...
      if (this.state.trussNumberRepAngelleRow1Plant2 != null) {
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 1 != null) {
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 2 != null) {
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 3 != null) {
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 4 != null) {
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 5 != null) {
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 6 != null) {
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 7 != null) {
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 8 != null) {
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepAngelleRow1Plant2: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 9 != null) {
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepAngelleRow1Plant2: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepAngelleRow1Plant2: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      AngelleRow1Plant2Selected: !this.state.AngelleRow1Plant2Selected,
    });
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        floweringTrussHeight:
          this.state.floweringTrussHeightRepAngelleRow1Plant2,
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepAngelleRow1Plant2 !== null &&
      this.state.pruningNumberRepAngelleRow1Plant2 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 1 !== null &&
            this.state.pruningNumber1RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 1 != null &&
      this.state.pruningNumber1RepAngelleRow1Plant2 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 2 !== null &&
            this.state.pruningNumber2RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 2 != null &&
      this.state.pruningNumber2RepAngelleRow1Plant2 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 3 !== null &&
            this.state.pruningNumber3RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 3 !== null &&
      this.state.pruningNumber3RepAngelleRow1Plant2 !== null
    ) {
      let data3 = {
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 4 !== null &&
            this.state.pruningNumber4RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 4 != null &&
      this.state.pruningNumber4RepAngelleRow1Plant2 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 5 !== null &&
            this.state.pruningNumber5RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 5 != null &&
      this.state.pruningNumber5RepAngelleRow1Plant2 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 6 !== null &&
            this.state.pruningNumber6RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 6 != null &&
      this.state.pruningNumber6RepAngelleRow1Plant2 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 7 !== null &&
            this.state.pruningNumber7RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 7 != null &&
      this.state.pruningNumber7RepAngelleRow1Plant2 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 8 !== null &&
            this.state.pruningNumber8RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 8 != null &&
      this.state.pruningNumber8RepAngelleRow1Plant2 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 9 !== null &&
            this.state.pruningNumber9RepAngelleRow1Plant2 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow1Plant2) + 9 != null &&
      this.state.pruningNumber9RepAngelleRow1Plant2 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 2</Text>/ Row No. 212/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.AngelleRow1Plant2Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterRepAngelleRow1Plant2
                        }
                        ref={input => {
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepAngelleRow1Plant2 <= 22 ||
                      this.state.fruitLoadRepAngelleRow1Plant2 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepAngelleRow1Plant2 <= 0 ||
                      this.state.floweringTrussssRepAngelleRow1Plant2 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepAngelleRow1Plant2}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepAngelleRow1Plant2 <= 1 ||
                      this.state.settingTrussNumberRepAngelleRow1Plant2 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepAngelleRow1Plant2}
                      </Text>
                    </View>
                    <View
                      style={{

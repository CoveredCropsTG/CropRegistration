...
export default class Har4AvalantinoRow1Plant1 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantHar4AvalantinoRow1Plant1 =
      this.onSubmitleavesPerPlantHar4AvalantinoRow1Plant1.bind(this);
  ...
  changeCheckbox = () => {
    this.setState({
      Har4AvalantinoRow1Plant1Selected:
        !this.state.Har4AvalantinoRow1Plant1Selected,
    });
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        floweringTrussHeight:
          this.state.floweringTrussHeightHar4AvalantinoRow1Plant1,

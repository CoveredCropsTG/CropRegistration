...
export default class RepBambelloPlant100 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepBambelloPlant10 =
      this.onSubmitleavesPerPlantRepBambelloPlant10.bind(this);
    ...
    this.leavesPerPlantRepBambelloPlant10Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepBambelloPlant10')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepBambelloPlant10: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepBambelloPlant10')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepBambelloPlant10: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepBambelloPlant10')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepBambelloPlant10: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepBambelloPlant10')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepBambelloPlant10: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepBambelloPlant10')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepBambelloPlant10: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepBambelloPlant10')
        .then(text6Value => {
          this.setState({
            leafLengthRepBambelloPlant10: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepBambelloPlant10')
        .then(text7Value => {
          this.setState({
            leafWidthRepBambelloPlant10: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterRepBambelloPlant10')
        .then(text8Value => {
          this.setState({
            stmDiameterRepBambelloPlant10: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepBambelloPlant10')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepBambelloPlant10: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('bambelloPlant10Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepBambelloPlant10')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepBambelloPlant10: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 1,
            });
            this.setState({
              trussNumber2RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 2,
            });
            this.setState({
              trussNumber3RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 3,
            });
            this.setState({
              trussNumber4RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 4,
            });
            this.setState({
              trussNumber5RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 5,
            });
            this.setState({
              trussNumber6RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 6,
            });
            this.setState({
              trussNumber7RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 7,
            });
            this.setState({
              trussNumber8RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 8,
            });
            this.setState({
              trussNumber9RepBambelloPlant10:
                parseInt(this.state.trussNumberRepBambelloPlant10) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepBambelloPlant10')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepBambelloPlant10: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepBambelloPlant10')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepBambelloPlant10: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepBambelloPlant10')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepBambelloPlant10: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepBambelloPlant10')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepBambelloPlant10: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepBambelloPlant10')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepBambelloPlant10: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepBambelloPlant10')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepBambelloPlant10: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepBambelloPlant10')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepBambelloPlant10: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepBambelloPlant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepBambelloPlant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepBambelloPlant10')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepBambelloPlant10: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepBambelloPlant10')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepBambelloPlant10: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepBambelloPlant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepBambelloPlant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepBambelloPlant10')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepBambelloPlant10: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepBambelloPlant10')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepBambelloPlant10: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepBambelloPlant10')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepBambelloPlant10: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepBambelloPlant10')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepBambelloPlant10: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepBambelloPlant10')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepBambelloPlant10: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepBambelloPlant10')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepBambelloPlant10: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepBambelloPlant10')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepBambelloPlant10: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepBambelloPlant10')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepBambelloPlant10: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepBambelloPlant10')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepBambelloPlant10: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepBambelloPlant10')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepBambelloPlant10: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepBambelloPlant10')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepBambelloPlant10: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepBambelloPlant10')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepBambelloPlant10: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepBambelloPlant10')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepBambelloPlant10: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepBambelloPlant10')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepBambelloPlant10: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepBambelloPlant10')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepBambelloPlant10: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepBambelloPlant10')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepBambelloPlant10: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepBambelloPlant10')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepBambelloPlant10: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepBambelloPlant10')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepBambelloPlant10: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepBambelloPlant10')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepBambelloPlant10: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepBambelloPlant10')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepBambelloPlant10: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepBambelloPlant10')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepBambelloPlant10: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepBambelloPlant10')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepBambelloPlant10: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepBambelloPlant10')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepBambelloPlant10: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepBambelloPlant10')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepBambelloPlant10: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepBambelloPlant10')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepBambelloPlant10: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepBambelloPlant10')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepBambelloPlant10: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepBambelloPlant10')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepBambelloPlant10: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepBambelloPlant10')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepBambelloPlant10: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepBambelloPlant10')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepBambelloPlant10: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepBambelloPlant10')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepBambelloPlant10: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepBambelloPlant10')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepBambelloPlant10: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepBambelloPlant10')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepBambelloPlant10: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepBambelloPlant10')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepBambelloPlant10: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepBambelloPlant10)
        ? parseInt(this.state.setFruitsRepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits1RepBambelloPlant10)
        ? parseInt(this.state.setFruits1RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits2RepBambelloPlant10)
        ? parseInt(this.state.setFruits2RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits3RepBambelloPlant10)
        ? parseInt(this.state.setFruits3RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits4RepBambelloPlant10)
        ? parseInt(this.state.setFruits4RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits5RepBambelloPlant10)
        ? parseInt(this.state.setFruits5RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits6RepBambelloPlant10)
        ? parseInt(this.state.setFruits6RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits7RepBambelloPlant10)
        ? parseInt(this.state.setFruits7RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits8RepBambelloPlant10)
        ? parseInt(this.state.setFruits8RepBambelloPlant10)
        : 0) +
      (parseInt(this.state.setFruits9RepBambelloPlant10)
        ? parseInt(this.state.setFruits9RepBambelloPlant10)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepBambelloPlant10',
      this.state.fruitLoadRepBambelloPlant10,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepBambelloPlant10 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepBambelloPlant10
            ? this.state.setFruitsRepBambelloPlant10
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepBambelloPlant10
            ? this.state.pruningNumberRepBambelloPlant10
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepBambelloPlant10)
          ? parseInt(this.state.trussNumberRepBambelloPlant10)
          : 0) + sub
      ).toFixed(2);
      this.setState({
    ...
    this.setItem(
      'harvestTrussRepBambelloPlant10',
      this.state.harvestTrussRepBambelloPlant10,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepBambelloPlant10,
    );
            ...
            if (this.state.setFruits5RepBambelloPlant10 === '') {
              if (this.state.setFruits4RepBambelloPlant10 === '') {
                if (this.state.setFruits3RepBambelloPlant10 === '') {
                  if (this.state.setFruits2RepBambelloPlant10 === '') {
                    if (this.state.setFruits1RepBambelloPlant10 === '') {
                      if (this.state.setFruitsRepBambelloPlant10 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepBambelloPlant10,
                        );
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepBambelloPlant10,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepBambelloPlant10,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepBambelloPlant10,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepBambelloPlant10,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepBambelloPlant10,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepBambelloPlant10,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepBambelloPlant10,
                );
                trussNum = parseInt(number4);
                settingFruit = parseInt(
                  this.state.setFruits4RepBambelloPlant10,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = parseInt(
                this.state.pruningNumber5RepBambelloPlant10,
              );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepBambelloPlant10,
    );
    ...
    if (this.state.setFlowers9RepBambelloPlant10 === '') {
      if (this.state.setFlowers8RepBambelloPlant10 === '') {
        if (this.state.setFlowers7RepBambelloPlant10 === '') {
          if (this.state.setFlowers6RepBambelloPlant10 === '') {
            if (this.state.setFlowers5RepBambelloPlant10 === '') {
              if (this.state.setFlowers4RepBambelloPlant10 === '') {
                if (this.state.setFlowers3RepBambelloPlant10 === '') {
                  if (this.state.setFlowers2RepBambelloPlant10 === '') {
                    if (this.state.setFlowers1RepBambelloPlant10 === '') {
                      if (this.state.setFlowersRepBambelloPlant10 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepBambelloPlant10,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberRepBambelloPlant10 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepBambelloPlant10,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepBambelloPlant10,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberRepBambelloPlant10 + 2;

                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepBambelloPlant10,
                    );
                    flowering = parseInt(
                      this.state.setFlowers2RepBambelloPlant10,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepBambelloPlant10,
                    );
                  ...
                  flowering = parseInt(
                    this.state.setFlowers3RepBambelloPlant10,
                  );
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepBambelloPlant10,
                  );
              ...
              flowerSetFruits = parseInt(
                this.state.setFruits5RepBambelloPlant10,
              );
              summ =
                (flowering ? flowering : 0) +
                (flowerSetFruits ? flowerSetFruits : 0);
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepBambelloPlant10,
            );
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepBambelloPlant10,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepBambelloPlant10,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepBambelloPlant10,
      );
    ...
    if (this.state.allTrussData.length != 0) {
      ...
      if (this.state.trussNumberRepBambelloPlant10 != null) {
        ...
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepBambelloPlant10);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 1 != null) {
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 2 != null) {
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 3 != null) {
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 4 != null) {
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 5 != null) {
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 6 != null) {
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 7 != null) {
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 8 != null) {
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepBambelloPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepBambelloPlant10) + 9 != null) {
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepBambelloPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepBambelloPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepBambelloPlant10: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      bambelloPlant10Selected: !this.state.bambelloPlant10Selected,
    });
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepBambelloPlant10 !== null &&
      this.state.pruningNumberRepBambelloPlant10 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 1 !== null &&
            this.state.pruningNumber1RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 1 != null &&
      this.state.pruningNumber1RepBambelloPlant10 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 2 !== null &&
            this.state.pruningNumber2RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 2 != null &&
      this.state.pruningNumber2RepBambelloPlant10 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 3 !== null &&
            this.state.pruningNumber3RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 3 !== null &&
      this.state.pruningNumber3RepBambelloPlant10 !== null
    ) {
      let data3 = {
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 4 !== null &&
            this.state.pruningNumber4RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 4 != null &&
      this.state.pruningNumber4RepBambelloPlant10 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 5 !== null &&
            this.state.pruningNumber5RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 5 != null &&
      this.state.pruningNumber5RepBambelloPlant10 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 6 !== null &&
            this.state.pruningNumber6RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 6 != null &&
      this.state.pruningNumber6RepBambelloPlant10 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 7 !== null &&
            this.state.pruningNumber7RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 7 != null &&
      this.state.pruningNumber7RepBambelloPlant10 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 8 !== null &&
            this.state.pruningNumber8RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 8 != null &&
      this.state.pruningNumber8RepBambelloPlant10 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant10) + 9 !== null &&
            this.state.pruningNumber9RepBambelloPlant10 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant10) + 9 != null &&
      this.state.pruningNumber9RepBambelloPlant10 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 10</Text>/ Row No. 232/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.bambelloPlant10Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.floweringTrussHeightRepBambelloPlant10
                        }
                        ref={input => {
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepBambelloPlant10')
                    }
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepBambelloPlant10')
                    }
                    blurOnSubmit={false}
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepBambelloPlant10 <= 22 ||
                      this.state.fruitLoadRepBambelloPlant10 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepBambelloPlant10 <= 0 ||
                      this.state.floweringTrussssRepBambelloPlant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepBambelloPlant10}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepBambelloPlant10 <= 1 ||
                      this.state.settingTrussNumberRepBambelloPlant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepBambelloPlant10}
                      </Text>
                    </View>
                    <View
                      style={{

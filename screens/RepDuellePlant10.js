...
export default class RepDuellePlant100 extends Component {
  constructor(props) {
    super(props);
    ...
    this.onSubmitleavesPerPlantRepDuellePlant10 =
      this.onSubmitleavesPerPlantRepDuellePlant10.bind(this);
    ...
    this.leavesPerPlantRepDuellePlant10Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepDuellePlant10')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepDuellePlant10: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepDuellePlant10')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepDuellePlant10: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepDuellePlant10')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepDuellePlant10: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepDuellePlant10')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepDuellePlant10: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepDuellePlant10')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepDuellePlant10: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepDuellePlant10')
        .then(text6Value => {
    ...
    try {
      AsyncStorage.getItem('leafWidthRepDuellePlant10')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepDuellePlant10')
        .then(text8Value => {
          this.setState({
            stmDiameterRepDuellePlant10: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepDuellePlant10')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepDuellePlant10: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('DuellePlant10Selected')
        .then(text99Value => {
          this.setState({ DuellePlant10Selected: JSON.parse(text99Value) });

          console.log(this.state.DuellePlant10Selected);
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('trussNumberRepDuellePlant10')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepDuellePlant10: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 1,
            });
            this.setState({
              trussNumber2RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 2,
            });
            this.setState({
              trussNumber3RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 3,
            });
            this.setState({
              trussNumber4RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 4,
            });
            this.setState({
              trussNumber5RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 5,
            });
            this.setState({
              trussNumber6RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 6,
            });
            this.setState({
              trussNumber7RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 7,
            });
            this.setState({
              trussNumber8RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 8,
            });
            this.setState({
              trussNumber9RepDuellePlant10:
                parseInt(this.state.trussNumberRepDuellePlant10) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepDuellePlant10')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepDuellePlant10: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepDuellePlant10')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepDuellePlant10: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepDuellePlant10')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepDuellePlant10: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepDuellePlant10')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepDuellePlant10: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepDuellePlant10')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepDuellePlant10: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepDuellePlant10')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepDuellePlant10: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepDuellePlant10')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepDuellePlant10: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepDuellePlant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepDuellePlant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepDuellePlant10')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepDuellePlant10: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepDuellePlant10')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepDuellePlant10: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepDuellePlant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepDuellePlant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepDuellePlant10')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepDuellePlant10: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepDuellePlant10')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepDuellePlant10: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepDuellePlant10')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepDuellePlant10: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepDuellePlant10')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepDuellePlant10: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepDuellePlant10')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepDuellePlant10: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepDuellePlant10')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepDuellePlant10: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepDuellePlant10')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepDuellePlant10: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepDuellePlant10')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepDuellePlant10: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepDuellePlant10')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepDuellePlant10: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepDuellePlant10')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepDuellePlant10: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepDuellePlant10')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepDuellePlant10: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepDuellePlant10')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepDuellePlant10: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepDuellePlant10')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepDuellePlant10: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepDuellePlant10')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepDuellePlant10: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepDuellePlant10')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepDuellePlant10: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepDuellePlant10')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepDuellePlant10: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepDuellePlant10')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepDuellePlant10: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepDuellePlant10')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepDuellePlant10: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepDuellePlant10')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepDuellePlant10: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepDuellePlant10')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepDuellePlant10: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepDuellePlant10')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepDuellePlant10: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepDuellePlant10')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepDuellePlant10: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepDuellePlant10')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepDuellePlant10: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepDuellePlant10')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepDuellePlant10: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepDuellePlant10')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepDuellePlant10: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepDuellePlant10')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepDuellePlant10: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepDuellePlant10')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepDuellePlant10: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepDuellePlant10')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepDuellePlant10: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepDuellePlant10')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepDuellePlant10: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepDuellePlant10')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepDuellePlant10: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepDuellePlant10')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepDuellePlant10: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepDuellePlant10')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepDuellePlant10: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepDuellePlant10')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepDuellePlant10: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepDuellePlant10)
        ? parseInt(this.state.setFruitsRepDuellePlant10)
        : 0) +
      (parseInt(this.state.setFruits1RepDuellePlant10)
        ? parseInt(this.state.setFruits1RepDuellePlant10)
        : 0) +
      (parseInt(this.state.setFruits2RepDuellePlant10)
        ? parseInt(this.state.setFruits2RepDuellePlant10)
        : 0) +
      (parseInt(this.state.setFruits3RepDuellePlant10)
        ? parseInt(this.state.setFruits3RepDuellePlant10)
        : 0) +
      (parseInt(this.state.setFruits4RepDuellePlant10)
        ? parseInt(this.state.setFruits4RepDuellePlant10)
        : 0) +
      (parseInt(this.state.setFruits5RepDuellePlant10)
        ? parseInt(this.state.setFruits5RepDuellePlant10)
        : 0) +
      (parseInt(this.state.setFruits6RepDuellePlant10)
        ? parseInt(this.state.setFruits6RepDuellePlant10)
        : 0) +
      ...
      (parseInt(this.state.setFruits8RepDuellePlant10)
        ? parseInt(this.state.setFruits8RepDuellePlant10)
        : 0) +
      (parseInt(this.state.setFruits9RepDuellePlant10)
        ? parseInt(this.state.setFruits9RepDuellePlant10)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepDuellePlant10',
      this.state.fruitLoadRepDuellePlant10,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepDuellePlant10 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepDuellePlant10
            ? this.state.setFruitsRepDuellePlant10
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepDuellePlant10
            ? this.state.pruningNumberRepDuellePlant10
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepDuellePlant10)
          ? parseInt(this.state.trussNumberRepDuellePlant10)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepDuellePlant10: add,
        pruningHarRepDuellePlant10: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepDuellePlant10);
    ...
    this.setItem(
      'harvestTrussRepDuellePlant10',
      this.state.harvestTrussRepDuellePlant10,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepDuellePlant10,
    );
            ...
            if (this.state.setFruits5RepDuellePlant10 === '') {
              if (this.state.setFruits4RepDuellePlant10 === '') {
                if (this.state.setFruits3RepDuellePlant10 === '') {
                  if (this.state.setFruits2RepDuellePlant10 === '') {
                    if (this.state.setFruits1RepDuellePlant10 === '') {
                      if (this.state.setFruitsRepDuellePlant10 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepDuellePlant10,
                        );
                        ...
                        this.setState({
                          ...
                          prunSettingRepDuellePlant10: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepDuellePlant10,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepDuellePlant10,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepDuellePlant10,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepDuellePlant10,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepDuellePlant10,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepDuellePlant10,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepDuellePlant10,
                );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepDuellePlant10,
    );
    ...
    if (this.state.setFlowers9RepDuellePlant10 === '') {
      if (this.state.setFlowers8RepDuellePlant10 === '') {
        if (this.state.setFlowers7RepDuellePlant10 === '') {
          if (this.state.setFlowers6RepDuellePlant10 === '') {
            if (this.state.setFlowers5RepDuellePlant10 === '') {
              if (this.state.setFlowers4RepDuellePlant10 === '') {
                  ...
                  if (this.state.setFlowers2RepDuellePlant10 === '') {
                    if (this.state.setFlowers1RepDuellePlant10 === '') {
                      if (this.state.setFlowersRepDuellePlant10 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepDuellePlant10,
                        );
                        ...
                        this.setState({
                          ...
                          pruneFloweringRepDuellePlant10: flowerPruningNumner,
                        });
                        this.setItem(
                          'floweringTrussssRepDuellePlant10',
                          floweringTruss,
                      ...
                      var number11 =
                        +this.state.trussNumberRepDuellePlant10 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepDuellePlant10,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepDuellePlant10,
                      );
                    ...
                    flowering = parseInt(
                      this.state.setFlowers2RepDuellePlant10,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepDuellePlant10,
                    );
                ...
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepDuellePlant10,
                );
                summ =
                  (flowering ? flowering : 0) +
                  (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepDuellePlant10,
              );
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepDuellePlant10,
            );
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepDuellePlant10,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepDuellePlant10,
        );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepDuellePlant10 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant10);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepDuellePlant10: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 1 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepDuellePlant10: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 2 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepDuellePlant10: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 3 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepDuellePlant10: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 4 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepDuellePlant10: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 5 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepDuellePlant10: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 6 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepDuellePlant10: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 7 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepDuellePlant10: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 8 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepDuellePlant10: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant10) + 9 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepDuellePlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepDuellePlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepDuellePlant10: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({ DuellePlant10Selected: !this.state.DuellePlant10Selected });

    const vart = this.state.DuellePlant10Selected;

    const vart2 = false;

    if (vart == null) {
      this.setItem('DuellePlant10Selected', vart2);

      EventRegister.emit('duelleEventPlant10', vart2);
    } else {
      this.setItem('DuellePlant10Selected', vart);

      EventRegister.emit('duelleEventPlant10', vart);
    }
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 10,
        leavesPerPlant: this.state.leavesPerPlantRepDuellePlant10,
        fullySetTruss: this.state.fullySetTrussRepDuellePlant10,
        setTrussLength: this.state.setTrussLengthRepDuellePlant10,
        weeklyGrowth: this.state.weeklyGrowthRepDuellePlant10,
        floweringTrussHeight: this.state.floweringTrussHeightRepDuellePlant10,
        leafLength: this.state.leafLengthRepDuellePlant10,
        leafWidth: this.state.leafWidthRepDuellePlant10,
        stmDiameter: this.state.stmDiameterRepDuellePlant10,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterRepDuellePlant10,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepDuellePlant10 !== null &&
      this.state.pruningNumberRepDuellePlant10 !== null
    ) {
      let data = {
        trussNumber: this.state.trussNumberRepDuellePlant10,
        fruitDiameter: this.state.fruitDiameterRepDuellePlant10,
        setFruits: this.state.setFruitsRepDuellePlant10,
        setFlowers: this.state.setFlowersRepDuellePlant10,
        pruningNumber: this.state.pruningNumberRepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
        fruitLoad: this.state.fruitLoadRepDuellePlant10,
        pruningFlower: this.state.pruneFloweringRepDuellePlant10,
        floweringTruss: this.state.floweringTrussssRepDuellePlant10,
        pruningSet: this.state.prunSettingRepDuellePlant10,
        settingTruss: this.state.settingTrussNumberRepDuellePlant10,
        pruningHarvest: this.state.pruningHarRepDuellePlant10,
        harvestTruss: this.state.harvestTrussRepDuellePlant10,
      };
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 1 !== null &&
            this.state.pruningNumber1RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 1 != null &&
      this.state.pruningNumber1RepDuellePlant10 !== null
    ) {
      let data1 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 1,
        fruitDiameter: this.state.fruitDiameter1RepDuellePlant10,
        setFruits: this.state.setFruits1RepDuellePlant10,
        setFlowers: this.state.setFlowers1RepDuellePlant10,
        pruningNumber: this.state.pruningNumber1RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 2 !== null &&
            this.state.pruningNumber2RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 2 != null &&
      this.state.pruningNumber2RepDuellePlant10 !== null
    ) {
      let data2 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 2,
        fruitDiameter: this.state.fruitDiameter2RepDuellePlant10,
        setFruits: this.state.setFruits2RepDuellePlant10,
        setFlowers: this.state.setFlowers2RepDuellePlant10,
        pruningNumber: this.state.pruningNumber2RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 3 !== null &&
            this.state.pruningNumber3RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 3 !== null &&
      this.state.pruningNumber3RepDuellePlant10 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 3,
        fruitDiameter: this.state.fruitDiameter3RepDuellePlant10,
        setFruits: this.state.setFruits3RepDuellePlant10,
        setFlowers: this.state.setFlowers3RepDuellePlant10,
        pruningNumber: this.state.pruningNumber3RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 4 !== null &&
            this.state.pruningNumber4RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 4 != null &&
      this.state.pruningNumber4RepDuellePlant10 !== null
    ) {
      let data4 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 4,
        fruitDiameter: this.state.fruitDiameter4RepDuellePlant10,
        setFruits: this.state.setFruits4RepDuellePlant10,
        setFlowers: this.state.setFlowers4RepDuellePlant10,
        pruningNumber: this.state.pruningNumber4RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 5 !== null &&
            this.state.pruningNumber5RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 5 != null &&
      this.state.pruningNumber5RepDuellePlant10 !== null
    ) {
      let data5 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 5,
        fruitDiameter: this.state.fruitDiameter5RepDuellePlant10,
        setFruits: this.state.setFruits5RepDuellePlant10,
        setFlowers: this.state.setFlowers5RepDuellePlant10,
        pruningNumber: this.state.pruningNumber5RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 6 !== null &&
            this.state.pruningNumber6RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 6 != null &&
      this.state.pruningNumber6RepDuellePlant10 !== null
    ) {
      let data6 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 6,
        fruitDiameter: this.state.fruitDiameter6RepDuellePlant10,
        setFruits: this.state.setFruits6RepDuellePlant10,
        setFlowers: this.state.setFlowers6RepDuellePlant10,
        pruningNumber: this.state.pruningNumber6RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 7 !== null &&
            this.state.pruningNumber7RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 7 != null &&
      this.state.pruningNumber7RepDuellePlant10 !== null
    ) {
      let data7 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 7,
        fruitDiameter: this.state.fruitDiameter7RepDuellePlant10,
        setFruits: this.state.setFruits7RepDuellePlant10,
        setFlowers: this.state.setFlowers7RepDuellePlant10,
        pruningNumber: this.state.pruningNumber7RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 8 !== null &&
            this.state.pruningNumber8RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 8 != null &&
      this.state.pruningNumber8RepDuellePlant10 !== null
    ) {
      let data8 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 8,
        fruitDiameter: this.state.fruitDiameter8RepDuellePlant10,
        setFruits: this.state.setFruits8RepDuellePlant10,
        setFlowers: this.state.setFlowers8RepDuellePlant10,
        pruningNumber: this.state.pruningNumber8RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant10) + 9 !== null &&
            this.state.pruningNumber9RepDuellePlant10 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
          }
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant10) + 9 != null &&
      this.state.pruningNumber9RepDuellePlant10 !== null
    ) {
      let data9 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant10) + 9,
        fruitDiameter: this.state.fruitDiameter9RepDuellePlant10,
        setFruits: this.state.setFruits9RepDuellePlant10,
        setFlowers: this.state.setFlowers9RepDuellePlant10,
        pruningNumber: this.state.pruningNumber9RepDuellePlant10,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 10,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 10</Text>/ Row No. 432/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={this.state.DuellePlant10Selected ? 'none' : 'auto'}
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepDuellePlant10')
                    }
                    value={this.state.setFlowersRepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumberRepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepDuellePlant10')
                    }
                    value={this.state.setFlowers1RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber1RepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepDuellePlant10')
                    }
                    value={this.state.setFlowers2RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber2RepDuellePlant10}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepDuellePlant10')
                    }
                    value={this.state.setFlowers3RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber3RepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepDuellePlant10')
                    }
                    value={this.state.setFlowers4RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber4RepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepDuellePlant10')
                    }
                    value={this.state.setFlowers5RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber5RepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepDuellePlant10')
                    }
                    value={this.state.setFlowers6RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber6RepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepDuellePlant10')
                    }
                    value={this.state.setFlowers7RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber7RepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepDuellePlant10')
                    }
                    value={this.state.setFlowers8RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber8RepDuellePlant10}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'trussNumber9RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepDuellePlant10')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepDuellePlant10')
                    }
                    value={this.state.setFlowers9RepDuellePlant10}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber9RepDuellePlant10}
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepDuellePlant10 <= 22 ||
                      this.state.fruitLoadRepDuellePlant10 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepDuellePlant10 <= 0 ||
                      this.state.floweringTrussssRepDuellePlant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepDuellePlant10}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepDuellePlant10 <= 1 ||
                      this.state.settingTrussNumberRepDuellePlant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepDuellePlant10}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <CheckBox
                  ...
                  uncheckedColor="red"
                  checkedColor="green"
                  title="Duelle Plant 10 completed"
                  checked={this.state.DuellePlant10Selected}

...
export default class RepKmPlantsRow1 extends Component {
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.kmEventPlant1);
    EventRegister.removeEventListener(this.kmEventPlant2);
    EventRegister.removeEventListener(this.kmEventPlant3);
    EventRegister.removeEventListener(this.kmEventPlant4);
    EventRegister.removeEventListener(this.kmEventPlant5);
    EventRegister.removeEventListener(this.kmEventPlant6);
    EventRegister.removeEventListener(this.kmEventPlant7);
    EventRegister.removeEventListener(this.kmEventPlant8);
    EventRegister.removeEventListener(this.kmEventPlant9);
    EventRegister.removeEventListener(this.kmEventPlant10);
  }
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.kmEventPlant1 = EventRegister.addEventListener(
      'kmEventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.kmEventPlant2 = EventRegister.addEventListener(
      'kmEventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.kmEventPlant3 = EventRegister.addEventListener(
      'kmEventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.kmEventPlant4 = EventRegister.addEventListener(
      'kmEventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.kmEventPlant5 = EventRegister.addEventListener(
      'kmEventPlant5',
      data5 => {
    ...
    //PLANT 6
    this.kmEventPlant6 = EventRegister.addEventListener(
      'kmEventPlant6',
      data6 => {
    ...
    //PLANT 7
    this.kmEventPlant7 = EventRegister.addEventListener(
      'kmEventPlant7',
      data7 => {
    ...
    //PLANT 8
    this.kmEventPlant8 = EventRegister.addEventListener(
      'kmEventPlant8',
      data8 => {
    ...
    //PLANT 9
    this.kmEventPlant9 = EventRegister.addEventListener(
      'kmEventPlant9',
      data9 => {
    ...
    //PLANT 10
    this.kmEventPlant10 = EventRegister.addEventListener(
      'kmEventPlant10',
      data10 => {
    ...
    if (plant1Selected == null || plant1Selected == true) {
      return (
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('RepKMPlant1')}
        >
  ...
  renderElement2() {
    if (plant2Selected == null || plant2Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant2')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement3() {
    if (plant3Selected == null || plant3Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant3')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement4() {
    if (plant4Selected == null || plant4Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant4')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement5() {
    if (plant5Selected == null || plant5Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant5')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement6() {
    if (plant6Selected == null || plant6Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant6')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement7() {
    if (plant7Selected == null || plant7Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant7')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement8() {
    if (plant8Selected == null || plant8Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant8')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement9() {
    if (plant9Selected == null || plant9Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant9')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement10() {
    if (plant10Selected == null || plant10Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('RepKMPlant10')}
        >
          <Text style={styles.buttonText}>

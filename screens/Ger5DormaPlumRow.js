...
export default class Ger5DormaPlumRow extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.headerImage2}>
            <Text style={styles.text}>GER 5 - Dorma Plum</Text>
          </View>
        ...
        <ScrollView keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.containerView}>
            <TouchableOpacity
              ...
              onPress={() =>
                this.props.navigation.navigate('Ger5DormaPlumPlantsRow1')
              }
            >

...
export default class RepBambelloPlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.bambelloEventPlant1 = EventRegister.addEventListener(
      'bambelloEventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.bambelloEventPlant2 = EventRegister.addEventListener(
      'bambelloEventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.bambelloEventPlant3 = EventRegister.addEventListener(
      'bambelloEventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.bambelloEventPlant4 = EventRegister.addEventListener(
      'bambelloEventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.bambelloEventPlant5 = EventRegister.addEventListener(
      'bambelloEventPlant5',
      data5 => {
    ...
    //PLANT 6
    this.bambelloEventPlant6 = EventRegister.addEventListener(
      'bambelloEventPlant6',
      data6 => {
    ...
    //PLANT 7
    this.bambelloEventPlant7 = EventRegister.addEventListener(
      'bambelloEventPlant7',
      data7 => {
    ...
    //PLANT 8
    this.bambelloEventPlant8 = EventRegister.addEventListener(
      'bambelloEventPlant8',
      data8 => {
    ...
    //PLANT 9
    this.bambelloEventPlant9 = EventRegister.addEventListener(
      'bambelloEventPlant9',
      data9 => {
    ...
    //PLANT 10
    this.bambelloEventPlant10 = EventRegister.addEventListener(
      'bambelloEventPlant10',
      data10 => {

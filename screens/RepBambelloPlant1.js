...
export default class RepBambelloPlant1 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepBambelloPlant1 =
      this.onSubmitleavesPerPlantRepBambelloPlant1.bind(this);
    ...
    this.leavesPerPlantRepBambelloPlant1Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepBambelloPlant1')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepBambelloPlant1: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepBambelloPlant1')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepBambelloPlant1: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepBambelloPlant1')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepBambelloPlant1: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepBambelloPlant1')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepBambelloPlant1: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepBambelloPlant1')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepBambelloPlant1: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepBambelloPlant1')
        .then(text6Value => {
          this.setState({
            leafLengthRepBambelloPlant1: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepBambelloPlant1')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepBambelloPlant1')
        .then(text8Value => {
          this.setState({
            stmDiameterRepBambelloPlant1: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepBambelloPlant1')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepBambelloPlant1: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('bambelloPlant1Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepBambelloPlant1')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepBambelloPlant1: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 1,
            });
            this.setState({
              trussNumber2RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 2,
            });
            this.setState({
              trussNumber3RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 3,
            });
            this.setState({
              trussNumber4RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 4,
            });
            this.setState({
              trussNumber5RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 5,
            });
            this.setState({
              trussNumber6RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 6,
            });
            this.setState({
              trussNumber7RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 7,
            });
            this.setState({
              trussNumber8RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 8,
            });
            this.setState({
              trussNumber9RepBambelloPlant1:
                parseInt(this.state.trussNumberRepBambelloPlant1) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepBambelloPlant1')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepBambelloPlant1: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepBambelloPlant1')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepBambelloPlant1: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepBambelloPlant1')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepBambelloPlant1: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepBambelloPlant1')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepBambelloPlant1: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepBambelloPlant1')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepBambelloPlant1: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepBambelloPlant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepBambelloPlant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepBambelloPlant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepBambelloPlant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepBambelloPlant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepBambelloPlant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepBambelloPlant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepBambelloPlant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepBambelloPlant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepBambelloPlant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepBambelloPlant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepBambelloPlant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepBambelloPlant1')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepBambelloPlant1: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepBambelloPlant1')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepBambelloPlant1: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepBambelloPlant1')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepBambelloPlant1: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepBambelloPlant1')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepBambelloPlant1: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepBambelloPlant1')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepBambelloPlant1: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepBambelloPlant1')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepBambelloPlant1: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepBambelloPlant1')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepBambelloPlant1: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepBambelloPlant1')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepBambelloPlant1: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepBambelloPlant1')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepBambelloPlant1: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepBambelloPlant1')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepBambelloPlant1: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepBambelloPlant1')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepBambelloPlant1: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepBambelloPlant1')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepBambelloPlant1: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepBambelloPlant1')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepBambelloPlant1: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepBambelloPlant1')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepBambelloPlant1: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepBambelloPlant1')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepBambelloPlant1: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepBambelloPlant1')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepBambelloPlant1: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepBambelloPlant1')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepBambelloPlant1: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepBambelloPlant1')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepBambelloPlant1: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepBambelloPlant1')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepBambelloPlant1: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepBambelloPlant1')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepBambelloPlant1: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepBambelloPlant1')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepBambelloPlant1: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepBambelloPlant1')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepBambelloPlant1: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepBambelloPlant1')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepBambelloPlant1: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepBambelloPlant1')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepBambelloPlant1: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepBambelloPlant1')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepBambelloPlant1: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepBambelloPlant1')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepBambelloPlant1: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepBambelloPlant1')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepBambelloPlant1: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepBambelloPlant1')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepBambelloPlant1: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepBambelloPlant1')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepBambelloPlant1: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepBambelloPlant1')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepBambelloPlant1: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepBambelloPlant1')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepBambelloPlant1: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepBambelloPlant1')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepBambelloPlant1: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepBambelloPlant1')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepBambelloPlant1: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepBambelloPlant1)
        ? parseInt(this.state.setFruitsRepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits1RepBambelloPlant1)
        ? parseInt(this.state.setFruits1RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits2RepBambelloPlant1)
        ? parseInt(this.state.setFruits2RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits3RepBambelloPlant1)
        ? parseInt(this.state.setFruits3RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits4RepBambelloPlant1)
        ? parseInt(this.state.setFruits4RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits5RepBambelloPlant1)
        ? parseInt(this.state.setFruits5RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits6RepBambelloPlant1)
        ? parseInt(this.state.setFruits6RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits7RepBambelloPlant1)
        ? parseInt(this.state.setFruits7RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits8RepBambelloPlant1)
        ? parseInt(this.state.setFruits8RepBambelloPlant1)
        : 0) +
      (parseInt(this.state.setFruits9RepBambelloPlant1)
        ? parseInt(this.state.setFruits9RepBambelloPlant1)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepBambelloPlant1',
      this.state.fruitLoadRepBambelloPlant1,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepBambelloPlant1 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepBambelloPlant1
            ? this.state.setFruitsRepBambelloPlant1
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepBambelloPlant1
            ? this.state.pruningNumberRepBambelloPlant1
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepBambelloPlant1)
          ? parseInt(this.state.trussNumberRepBambelloPlant1)
          : 0) + sub
      ).toFixed(2);
      this.setState({
    ...
    this.setItem(
      'harvestTrussRepBambelloPlant1',
      this.state.harvestTrussRepBambelloPlant1,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepBambelloPlant1,
    );
            ...
            if (this.state.setFruits5RepBambelloPlant1 === '') {
              if (this.state.setFruits4RepBambelloPlant1 === '') {
                if (this.state.setFruits3RepBambelloPlant1 === '') {
                  if (this.state.setFruits2RepBambelloPlant1 === '') {
                    if (this.state.setFruits1RepBambelloPlant1 === '') {
                      if (this.state.setFruitsRepBambelloPlant1 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepBambelloPlant1,
                        );
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepBambelloPlant1,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepBambelloPlant1,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepBambelloPlant1,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepBambelloPlant1,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepBambelloPlant1,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepBambelloPlant1,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepBambelloPlant1,
                );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepBambelloPlant1,
    );
    ...
    if (this.state.setFlowers9RepBambelloPlant1 === '') {
      if (this.state.setFlowers8RepBambelloPlant1 === '') {
        if (this.state.setFlowers7RepBambelloPlant1 === '') {
          if (this.state.setFlowers6RepBambelloPlant1 === '') {
            if (this.state.setFlowers5RepBambelloPlant1 === '') {
              if (this.state.setFlowers4RepBambelloPlant1 === '') {
                  ...
                  if (this.state.setFlowers2RepBambelloPlant1 === '') {
                    if (this.state.setFlowers1RepBambelloPlant1 === '') {
                      if (this.state.setFlowersRepBambelloPlant1 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepBambelloPlant1,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberRepBambelloPlant1 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepBambelloPlant1,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepBambelloPlant1,
                      );
                    ...
                    flowering = parseInt(
                      this.state.setFlowers2RepBambelloPlant1,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepBambelloPlant1,
                    );
                ...
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepBambelloPlant1,
                );
                summ =
                  (flowering ? flowering : 0) +
                  (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepBambelloPlant1,
              );
              flowering = parseInt(this.state.setFlowers5RepBambelloPlant1);
              flowerSetFruits = parseInt(
                this.state.setFruits5RepBambelloPlant1,
              );
              summ =
                (flowering ? flowering : 0) +
                (flowerSetFruits ? flowerSetFruits : 0);
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepBambelloPlant1,
            );
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepBambelloPlant1,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepBambelloPlant1,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepBambelloPlant1,
      );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepBambelloPlant1 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepBambelloPlant1);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepBambelloPlant1: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 1 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepBambelloPlant1: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 2 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepBambelloPlant1: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 3 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepBambelloPlant1: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 4 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepBambelloPlant1: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 5 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepBambelloPlant1: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 6 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepBambelloPlant1: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 7 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepBambelloPlant1: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 8 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepBambelloPlant1: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepBambelloPlant1) + 9 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepBambelloPlant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepBambelloPlant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepBambelloPlant1: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      bambelloPlant1Selected: !this.state.bambelloPlant1Selected,
    });
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepBambelloPlant1 !== null &&
      this.state.pruningNumberRepBambelloPlant1 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 1 !== null &&
            this.state.pruningNumber1RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 1 != null &&
      this.state.pruningNumber1RepBambelloPlant1 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 2 !== null &&
            this.state.pruningNumber2RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 2 != null &&
      this.state.pruningNumber2RepBambelloPlant1 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 3 !== null &&
            this.state.pruningNumber3RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 3 !== null &&
      this.state.pruningNumber3RepBambelloPlant1 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepBambelloPlant1) + 3,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 4 !== null &&
            this.state.pruningNumber4RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 4 != null &&
      this.state.pruningNumber4RepBambelloPlant1 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 5 !== null &&
            this.state.pruningNumber5RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 5 != null &&
      this.state.pruningNumber5RepBambelloPlant1 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 6 !== null &&
            this.state.pruningNumber6RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 6 != null &&
      this.state.pruningNumber6RepBambelloPlant1 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 7 !== null &&
            this.state.pruningNumber7RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 7 != null &&
      this.state.pruningNumber7RepBambelloPlant1 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 8 !== null &&
            this.state.pruningNumber8RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 8 != null &&
      this.state.pruningNumber8RepBambelloPlant1 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepBambelloPlant1) + 9 !== null &&
            this.state.pruningNumber9RepBambelloPlant1 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepBambelloPlant1) + 9 != null &&
      this.state.pruningNumber9RepBambelloPlant1 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 1</Text>/ Row No. 232/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.bambelloPlant1Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepBambelloPlant1')
                    }
                    value={this.state.setFlowersRepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumberRepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepBambelloPlant1')
                    }
                    value={this.state.setFlowers1RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber1RepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepBambelloPlant1')
                    }
                    value={this.state.setFlowers2RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber2RepBambelloPlant1}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepBambelloPlant1')
                    }
                    value={this.state.setFlowers3RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber3RepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepBambelloPlant1')
                    }
                    value={this.state.setFlowers4RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber4RepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepBambelloPlant1')
                    }
                    value={this.state.setFlowers5RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber5RepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepBambelloPlant1')
                    }
                    value={this.state.setFlowers6RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber6RepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepBambelloPlant1')
                    }
                    value={this.state.setFlowers7RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber7RepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepBambelloPlant1')
                    }
                    value={this.state.setFlowers8RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber8RepBambelloPlant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepBambelloPlant1')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepBambelloPlant1')
                    }
                    value={this.state.setFlowers9RepBambelloPlant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber9RepBambelloPlant1}
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepBambelloPlant1 <= 22 ||
                      this.state.fruitLoadRepBambelloPlant1 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepBambelloPlant1 <= 0 ||
                      this.state.floweringTrussssRepBambelloPlant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepBambelloPlant1}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepBambelloPlant1 <= 1 ||
                      this.state.settingTrussNumberRepBambelloPlant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepBambelloPlant1}
                      </Text>
                    </View>
                    <View
                      style={{

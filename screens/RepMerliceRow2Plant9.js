...
export default class RepMerliceRow2Plant9 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepMerliceRow2Plant9 =
      this.onSubmitleavesPerPlantRepMerliceRow2Plant9.bind(this);
    ...
    this.leavesPerPlantRepMerliceRow2Plant9Ref = this.updateRef.bind(
      this,
    ...
    this.state = {
      ...
      MerliceRow2Plant9Selected: false,
      checkboxStatus: '',
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepMerliceRow2Plant9')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepMerliceRow2Plant9: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepMerliceRow2Plant9')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepMerliceRow2Plant9: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepMerliceRow2Plant9')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepMerliceRow2Plant9: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepMerliceRow2Plant9')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepMerliceRow2Plant9: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepMerliceRow2Plant9')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepMerliceRow2Plant9: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepMerliceRow2Plant9')
        .then(text6Value => {
          this.setState({
            leafLengthRepMerliceRow2Plant9: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepMerliceRow2Plant9')
        .then(text7Value => {
          this.setState({
            leafWidthRepMerliceRow2Plant9: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterRepMerliceRow2Plant9')
        .then(text8Value => {
          this.setState({
            stmDiameterRepMerliceRow2Plant9: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepMerliceRow2Plant9')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepMerliceRow2Plant9: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('MerliceRow2Plant9Selected')
        .then(text99Value => {
          this.setState({ MerliceRow2Plant9Selected: JSON.parse(text99Value) });

          console.log(this.state.MerliceRow2Plant9Selected);
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('trussNumberRepMerliceRow2Plant9')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepMerliceRow2Plant9: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 1,
            });
            this.setState({
              trussNumber2RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 2,
            });
            this.setState({
              trussNumber3RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 3,
            });
            this.setState({
              trussNumber4RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 4,
            });
            this.setState({
              trussNumber5RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 5,
            });
            this.setState({
              trussNumber6RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 6,
            });
            this.setState({
              trussNumber7RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 7,
            });
            this.setState({
              trussNumber8RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 8,
            });
            this.setState({
              trussNumber9RepMerliceRow2Plant9:
                parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepMerliceRow2Plant9')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepMerliceRow2Plant9: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepMerliceRow2Plant9')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepMerliceRow2Plant9: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepMerliceRow2Plant9')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepMerliceRow2Plant9: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepMerliceRow2Plant9')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepMerliceRow2Plant9: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepMerliceRow2Plant9')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepMerliceRow2Plant9: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepMerliceRow2Plant9')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepMerliceRow2Plant9: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepMerliceRow2Plant9')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepMerliceRow2Plant9: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepMerliceRow2Plant9')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepMerliceRow2Plant9: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepMerliceRow2Plant9')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepMerliceRow2Plant9: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepMerliceRow2Plant9')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepMerliceRow2Plant9: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepMerliceRow2Plant9')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepMerliceRow2Plant9: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepMerliceRow2Plant9')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepMerliceRow2Plant9: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepMerliceRow2Plant9')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepMerliceRow2Plant9: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepMerliceRow2Plant9')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepMerliceRow2Plant9: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepMerliceRow2Plant9')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepMerliceRow2Plant9: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepMerliceRow2Plant9')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepMerliceRow2Plant9: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepMerliceRow2Plant9')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepMerliceRow2Plant9: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepMerliceRow2Plant9')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepMerliceRow2Plant9: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepMerliceRow2Plant9')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepMerliceRow2Plant9: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepMerliceRow2Plant9')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepMerliceRow2Plant9: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepMerliceRow2Plant9')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepMerliceRow2Plant9: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepMerliceRow2Plant9')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepMerliceRow2Plant9: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepMerliceRow2Plant9')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepMerliceRow2Plant9: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepMerliceRow2Plant9')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepMerliceRow2Plant9: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepMerliceRow2Plant9')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepMerliceRow2Plant9: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepMerliceRow2Plant9')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepMerliceRow2Plant9: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepMerliceRow2Plant9')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepMerliceRow2Plant9: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepMerliceRow2Plant9')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepMerliceRow2Plant9: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepMerliceRow2Plant9')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepMerliceRow2Plant9: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepMerliceRow2Plant9')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepMerliceRow2Plant9: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepMerliceRow2Plant9')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepMerliceRow2Plant9: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepMerliceRow2Plant9')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepMerliceRow2Plant9: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepMerliceRow2Plant9')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepMerliceRow2Plant9: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepMerliceRow2Plant9')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepMerliceRow2Plant9: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepMerliceRow2Plant9')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepMerliceRow2Plant9: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepMerliceRow2Plant9')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepMerliceRow2Plant9: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepMerliceRow2Plant9')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepMerliceRow2Plant9: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepMerliceRow2Plant9')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepMerliceRow2Plant9: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepMerliceRow2Plant9')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepMerliceRow2Plant9: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepMerliceRow2Plant9')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepMerliceRow2Plant9: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepMerliceRow2Plant9')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepMerliceRow2Plant9: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepMerliceRow2Plant9')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepMerliceRow2Plant9: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepMerliceRow2Plant9')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepMerliceRow2Plant9: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepMerliceRow2Plant9')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepMerliceRow2Plant9: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepMerliceRow2Plant9)
        ? parseInt(this.state.setFruitsRepMerliceRow2Plant9)
        : 0) +
      (parseInt(this.state.setFruits1RepMerliceRow2Plant9)
        ? parseInt(this.state.setFruits1RepMerliceRow2Plant9)
        : 0) +
      (parseInt(this.state.setFruits2RepMerliceRow2Plant9)
        ? parseInt(this.state.setFruits2RepMerliceRow2Plant9)
        : 0) +
      (parseInt(this.state.setFruits3RepMerliceRow2Plant9)
        ? parseInt(this.state.setFruits3RepMerliceRow2Plant9)
        : 0) +
      ...
      (parseInt(this.state.setFruits5RepMerliceRow2Plant9)
        ? parseInt(this.state.setFruits5RepMerliceRow2Plant9)
        : 0) +
      (parseInt(this.state.setFruits6RepMerliceRow2Plant9)
        ? parseInt(this.state.setFruits6RepMerliceRow2Plant9)
        : 0) +
      (parseInt(this.state.setFruits7RepMerliceRow2Plant9)
        ? parseInt(this.state.setFruits7RepMerliceRow2Plant9)
        : 0) +
      (parseInt(this.state.setFruits8RepMerliceRow2Plant9)
        ? parseInt(this.state.setFruits8RepMerliceRow2Plant9)
        : 0) +
    ...
    this.setItem(
      'fruitLoadRepMerliceRow2Plant9',
      this.state.fruitLoadRepMerliceRow2Plant9,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepMerliceRow2Plant9 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepMerliceRow2Plant9
            ? this.state.setFruitsRepMerliceRow2Plant9
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepMerliceRow2Plant9
            ? this.state.pruningNumberRepMerliceRow2Plant9
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepMerliceRow2Plant9)
          ? parseInt(this.state.trussNumberRepMerliceRow2Plant9)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepMerliceRow2Plant9: add,
        pruningHarRepMerliceRow2Plant9: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepMerliceRow2Plant9);
    ...
    this.setItem(
      'harvestTrussRepMerliceRow2Plant9',
      this.state.harvestTrussRepMerliceRow2Plant9,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepMerliceRow2Plant9,
    );
      ...
      if (this.state.setFruits8RepMerliceRow2Plant9 === '') {
        if (this.state.setFruits7RepMerliceRow2Plant9 === '') {
          if (this.state.setFruits6RepMerliceRow2Plant9 === '') {
            if (this.state.setFruits5RepMerliceRow2Plant9 === '') {
              if (this.state.setFruits4RepMerliceRow2Plant9 === '') {
                if (this.state.setFruits3RepMerliceRow2Plant9 === '') {
                  if (this.state.setFruits2RepMerliceRow2Plant9 === '') {
                    if (this.state.setFruits1RepMerliceRow2Plant9 === '') {
                      if (this.state.setFruitsRepMerliceRow2Plant9 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepMerliceRow2Plant9,
                        );
                        ...
                        this.setState({
                          ...
                          prunSettingRepMerliceRow2Plant9: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepMerliceRow2Plant9,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepMerliceRow2Plant9,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepMerliceRow2Plant9,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepMerliceRow2Plant9,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepMerliceRow2Plant9,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepMerliceRow2Plant9,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepMerliceRow2Plant9,
                );
                trussNum = parseInt(number4);
                settingFruit = parseInt(
                  this.state.setFruits4RepMerliceRow2Plant9,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = parseInt(
                this.state.pruningNumber5RepMerliceRow2Plant9,
              );
              trussNum = parseInt(number5);
              settingFruit = parseInt(
                this.state.setFruits5RepMerliceRow2Plant9,
              );
            ...
            pruningSet = parseInt(
              this.state.pruningNumber6RepMerliceRow2Plant9,
            );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepMerliceRow2Plant9,
    );
    ...
    if (this.state.setFlowers9RepMerliceRow2Plant9 === '') {
      if (this.state.setFlowers8RepMerliceRow2Plant9 === '') {
        if (this.state.setFlowers7RepMerliceRow2Plant9 === '') {
          if (this.state.setFlowers6RepMerliceRow2Plant9 === '') {
            if (this.state.setFlowers5RepMerliceRow2Plant9 === '') {
              if (this.state.setFlowers4RepMerliceRow2Plant9 === '') {
                if (this.state.setFlowers3RepMerliceRow2Plant9 === '') {
                  if (this.state.setFlowers2RepMerliceRow2Plant9 === '') {
                    if (this.state.setFlowers1RepMerliceRow2Plant9 === '') {
                      if (this.state.setFlowersRepMerliceRow2Plant9 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepMerliceRow2Plant9,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberRepMerliceRow2Plant9 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepMerliceRow2Plant9,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepMerliceRow2Plant9,
                      );
                      ...
                      this.setState({
                        floweringTrussssRepMerliceRow2Plant9: floweringTruss,
                        pruneFloweringRepMerliceRow2Plant9: flowerPruningNumner,
                      });
                      this.setItem(
                        'floweringTrussssRepMerliceRow2Plant9',
                        floweringTruss,
                    ...
                    var number21 =
                      +this.state.trussNumberRepMerliceRow2Plant9 + 2;

                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepMerliceRow2Plant9,
                    );
                    flowering = parseInt(
                      this.state.setFlowers2RepMerliceRow2Plant9,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepMerliceRow2Plant9,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberRepMerliceRow2Plant9 + 3;

                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepMerliceRow2Plant9,
                  );
                  flowering = parseInt(
                    this.state.setFlowers3RepMerliceRow2Plant9,
                  );
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepMerliceRow2Plant9,
                  );
                ...
                flowering = parseInt(
                  this.state.setFlowers4RepMerliceRow2Plant9,
                );
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepMerliceRow2Plant9,
                );
            ...
            flowerSetFruits = parseInt(
              this.state.setFruits6RepMerliceRow2Plant9,
            );
            summ =
              (flowering ? flowering : 0) +
              (flowerSetFruits ? flowerSetFruits : 0);
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepMerliceRow2Plant9,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepMerliceRow2Plant9,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepMerliceRow2Plant9,
      );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepMerliceRow2Plant9 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepMerliceRow2Plant9: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 1 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepMerliceRow2Plant9: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 2 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepMerliceRow2Plant9: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 3 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepMerliceRow2Plant9: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 4 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepMerliceRow2Plant9: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 5 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepMerliceRow2Plant9: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 6 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepMerliceRow2Plant9: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 7 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepMerliceRow2Plant9: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 8 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepMerliceRow2Plant9: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 9 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepMerliceRow2Plant9: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepMerliceRow2Plant9: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      MerliceRow2Plant9Selected: !this.state.MerliceRow2Plant9Selected,
    });

    const vart = this.state.MerliceRow2Plant9Selected;

    const vart2 = false;

    if (vart == null) {
      this.setItem('MerliceRow2Plant9Selected', vart2);

      EventRegister.emit('merliceRow2EventPlant9', vart2);
    } else {
      this.setItem('MerliceRow2Plant9Selected', vart);

      EventRegister.emit('merliceRow2EventPlant9', vart);
    }
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 9,
        leavesPerPlant: this.state.leavesPerPlantRepMerliceRow2Plant9,
        fullySetTruss: this.state.fullySetTrussRepMerliceRow2Plant9,
        setTrussLength: this.state.setTrussLengthRepMerliceRow2Plant9,
        weeklyGrowth: this.state.weeklyGrowthRepMerliceRow2Plant9,
        floweringTrussHeight:
          this.state.floweringTrussHeightRepMerliceRow2Plant9,
        leafLength: this.state.leafLengthRepMerliceRow2Plant9,
        leafWidth: this.state.leafWidthRepMerliceRow2Plant9,
        stmDiameter: this.state.stmDiameterRepMerliceRow2Plant9,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterRepMerliceRow2Plant9,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepMerliceRow2Plant9 !== null &&
      this.state.pruningNumberRepMerliceRow2Plant9 !== null
    ) {
      let data = {
        trussNumber: this.state.trussNumberRepMerliceRow2Plant9,
        fruitDiameter: this.state.fruitDiameterRepMerliceRow2Plant9,
        setFruits: this.state.setFruitsRepMerliceRow2Plant9,
        setFlowers: this.state.setFlowersRepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumberRepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
        fruitLoad: this.state.fruitLoadRepMerliceRow2Plant9,
        pruningFlower: this.state.pruneFloweringRepMerliceRow2Plant9,
        floweringTruss: this.state.floweringTrussssRepMerliceRow2Plant9,
        pruningSet: this.state.prunSettingRepMerliceRow2Plant9,
        settingTruss: this.state.settingTrussNumberRepMerliceRow2Plant9,
        pruningHarvest: this.state.pruningHarRepMerliceRow2Plant9,
        harvestTruss: this.state.harvestTrussRepMerliceRow2Plant9,
      };
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 1 !== null &&
            this.state.pruningNumber1RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 1 != null &&
      this.state.pruningNumber1RepMerliceRow2Plant9 !== null
    ) {
      let data1 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 1,
        fruitDiameter: this.state.fruitDiameter1RepMerliceRow2Plant9,
        setFruits: this.state.setFruits1RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers1RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber1RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 2 !== null &&
            this.state.pruningNumber2RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 2 != null &&
      this.state.pruningNumber2RepMerliceRow2Plant9 !== null
    ) {
      let data2 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 2,
        fruitDiameter: this.state.fruitDiameter2RepMerliceRow2Plant9,
        setFruits: this.state.setFruits2RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers2RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber2RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 3 !== null &&
            this.state.pruningNumber3RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 3 !== null &&
      this.state.pruningNumber3RepMerliceRow2Plant9 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 3,
        fruitDiameter: this.state.fruitDiameter3RepMerliceRow2Plant9,
        setFruits: this.state.setFruits3RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers3RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber3RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 4 !== null &&
            this.state.pruningNumber4RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 4 != null &&
      this.state.pruningNumber4RepMerliceRow2Plant9 !== null
    ) {
      let data4 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 4,
        fruitDiameter: this.state.fruitDiameter4RepMerliceRow2Plant9,
        setFruits: this.state.setFruits4RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers4RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber4RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 5 !== null &&
            this.state.pruningNumber5RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 5 != null &&
      this.state.pruningNumber5RepMerliceRow2Plant9 !== null
    ) {
      let data5 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 5,
        fruitDiameter: this.state.fruitDiameter5RepMerliceRow2Plant9,
        setFruits: this.state.setFruits5RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers5RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber5RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 6 !== null &&
            this.state.pruningNumber6RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 6 != null &&
      this.state.pruningNumber6RepMerliceRow2Plant9 !== null
    ) {
      let data6 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 6,
        fruitDiameter: this.state.fruitDiameter6RepMerliceRow2Plant9,
        setFruits: this.state.setFruits6RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers6RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber6RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 7 !== null &&
            this.state.pruningNumber7RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 7 != null &&
      this.state.pruningNumber7RepMerliceRow2Plant9 !== null
    ) {
      let data7 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 7,
        fruitDiameter: this.state.fruitDiameter7RepMerliceRow2Plant9,
        setFruits: this.state.setFruits7RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers7RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber7RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 8 !== null &&
            this.state.pruningNumber8RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 8 != null &&
      this.state.pruningNumber8RepMerliceRow2Plant9 !== null
    ) {
      let data8 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 8,
        fruitDiameter: this.state.fruitDiameter8RepMerliceRow2Plant9,
        setFruits: this.state.setFruits8RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers8RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber8RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 9 !== null &&
            this.state.pruningNumber9RepMerliceRow2Plant9 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 9 != null &&
      this.state.pruningNumber9RepMerliceRow2Plant9 !== null
    ) {
      let data9 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow2Plant9) + 9,
        fruitDiameter: this.state.fruitDiameter9RepMerliceRow2Plant9,
        setFruits: this.state.setFruits9RepMerliceRow2Plant9,
        setFlowers: this.state.setFlowers9RepMerliceRow2Plant9,
        pruningNumber: this.state.pruningNumber9RepMerliceRow2Plant9,
        plantRow: '707',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 9,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 9</Text>/ Row No. 707/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.MerliceRow2Plant9Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterRepMerliceRow2Plant9
                        }
                        ref={input => {
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowersRepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumberRepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers1RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber1RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers2RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber2RepMerliceRow2Plant9}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers3RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber3RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers4RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber4RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers5RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber5RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers6RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber6RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers7RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber7RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers8RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber8RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers9RepMerliceRow2Plant9}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber9RepMerliceRow2Plant9}
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepMerliceRow2Plant9 <= 22 ||
                      this.state.fruitLoadRepMerliceRow2Plant9 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepMerliceRow2Plant9 <= 0 ||
                      this.state.floweringTrussssRepMerliceRow2Plant9 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepMerliceRow2Plant9}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepMerliceRow2Plant9 <= 1 ||
                      this.state.settingTrussNumberRepMerliceRow2Plant9 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepMerliceRow2Plant9}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <CheckBox
                  ...
                  checked={this.state.MerliceRow2Plant9Selected}

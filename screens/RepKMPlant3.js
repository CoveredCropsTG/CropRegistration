...
export default class RepKMPlant3 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepKMPlant3 =
      this.onSubmitleavesPerPlantRepKMPlant3.bind(this);
    ...
    this.leavesPerPlantRepKMPlant3Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepKMPlant3')
        .then(text1Value => {
    ...
    try {
      AsyncStorage.getItem('fullySetTrussRepKMPlant3')
        .then(text2Value => {
    ...
    try {
      AsyncStorage.getItem('setTrussLengthRepKMPlant3')
        .then(text3Value => {
    ...
    try {
      AsyncStorage.getItem('weeklyGrowthRepKMPlant3')
        .then(text4Value => {
    ...
    try {
      AsyncStorage.getItem('floweringTrussHeightRepKMPlant3')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepKMPlant3: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepKMPlant3')
        .then(text6Value => {
    ...
    try {
      AsyncStorage.getItem('leafWidthRepKMPlant3')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepKMPlant3')
        .then(text8Value => {
    ...
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepKMPlant3')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepKMPlant3: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('KMPlant3Selected')
        .then(text99Value => {
          this.setState({ KMPlant3Selected: JSON.parse(text99Value) });

          console.log(this.state.KMPlant3Selected);
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('trussNumberRepKMPlant3')
        .then(text10Value => {
          if (text10Value !== null) {
            ...
            this.setState({
              trussNumber1RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 1,
            });
            this.setState({
              trussNumber2RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 2,
            });
            this.setState({
              trussNumber3RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 3,
            });
            this.setState({
              trussNumber4RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 4,
            });
            this.setState({
              trussNumber5RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 5,
            });
            this.setState({
              trussNumber6RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 6,
            });
            this.setState({
              trussNumber7RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 7,
            });
            this.setState({
              trussNumber8RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 8,
            });
            this.setState({
              trussNumber9RepKMPlant3:
                parseInt(this.state.trussNumberRepKMPlant3) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepKMPlant3')
        .then(text11Value => {
          if (text11Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowersRepKMPlant3')
        .then(text12Value => {
          if (text12Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepKMPlant3')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepKMPlant3: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepKMPlant3')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepKMPlant3: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepKMPlant3')
        .then(text16Value => {
          if (text16Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepKMPlant3')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepKMPlant3')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepKMPlant3: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepKMPlant3')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepKMPlant3: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepKMPlant3')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepKMPlant3')
        .then(text18Value => {
          if (text18Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepKMPlant3')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepKMPlant3: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepKMPlant3')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepKMPlant3: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepKMPlant3')
        .then(text21Value => {
          if (text21Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepKMPlant3')
        .then(text22Value => {
          if (text22Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepKMPlant3')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepKMPlant3: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepKMPlant3')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepKMPlant3: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepKMPlant3')
        .then(text25Value => {
          if (text25Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepKMPlant3')
        .then(text26Value => {
          if (text26Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepKMPlant3')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepKMPlant3: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepKMPlant3')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepKMPlant3: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepKMPlant3')
        .then(text29Value => {
          if (text29Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepKMPlant3')
        .then(text30Value => {
          if (text30Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepKMPlant3')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepKMPlant3: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepKMPlant3')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepKMPlant3: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepKMPlant3')
        .then(text33Value => {
          if (text33Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepKMPlant3')
        .then(text34Value => {
          if (text34Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepKMPlant3')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepKMPlant3: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepKMPlant3')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepKMPlant3: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepKMPlant3')
        .then(text37Value => {
          if (text37Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepKMPlant3')
        .then(text38Value => {
          if (text38Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepKMPlant3')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepKMPlant3: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepKMPlant3')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepKMPlant3: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepKMPlant3')
        .then(text41Value => {
          if (text41Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepKMPlant3')
        .then(text42Value => {
          if (text42Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepKMPlant3')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepKMPlant3: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepKMPlant3')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepKMPlant3: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepKMPlant3')
        .then(text45Value => {
          if (text45Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepKMPlant3')
        .then(text46Value => {
          if (text46Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepKMPlant3')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepKMPlant3: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepKMPlant3')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepKMPlant3: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepKMPlant3')
        .then(text49Value => {
          if (text49Value !== null) {
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepKMPlant3')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepKMPlant3: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepKMPlant3')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepKMPlant3: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepKMPlant3')
        .then(text52Value => {
          if (text52Value !== null) {
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({
      trussNumber1RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 1,
    });
    this.setState({
      trussNumber2RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 2,
    });
    this.setState({
      trussNumber3RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 3,
    });
    this.setState({
      trussNumber4RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 4,
    });
    this.setState({
      trussNumber5RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 5,
    });
    this.setState({
      trussNumber6RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 6,
    });
    this.setState({
      trussNumber7RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 7,
    });
    this.setState({
      trussNumber8RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 8,
    });
    this.setState({
      trussNumber9RepKMPlant3: parseInt(this.state.trussNumberRepKMPlant3) + 9,
    });
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepKMPlant3)
        ? parseInt(this.state.setFruitsRepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits1RepKMPlant3)
        ? parseInt(this.state.setFruits1RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits2RepKMPlant3)
        ? parseInt(this.state.setFruits2RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits3RepKMPlant3)
        ? parseInt(this.state.setFruits3RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits4RepKMPlant3)
        ? parseInt(this.state.setFruits4RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits5RepKMPlant3)
        ? parseInt(this.state.setFruits5RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits6RepKMPlant3)
        ? parseInt(this.state.setFruits6RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits7RepKMPlant3)
        ? parseInt(this.state.setFruits7RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits8RepKMPlant3)
        ? parseInt(this.state.setFruits8RepKMPlant3)
        : 0) +
      (parseInt(this.state.setFruits9RepKMPlant3)
        ? parseInt(this.state.setFruits9RepKMPlant3)
        : 0);
    this.setState({
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepKMPlant3 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepKMPlant3 ? this.state.setFruitsRepKMPlant3 : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepKMPlant3
            ? this.state.pruningNumberRepKMPlant3
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepKMPlant3)
          ? parseInt(this.state.trussNumberRepKMPlant3)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepKMPlant3: add,
        pruningHarRepKMPlant3: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepKMPlant3);
                    ...
                    if (this.state.setFruits1RepKMPlant3 === '') {
                      if (this.state.setFruitsRepKMPlant3 === '') {
                        ...
                        settingFruit = parseInt(
                          this.state.setFruitsRepKMPlant3,
                        );
                        settingTruss = (
                          trussNum +
                        ...
                        this.setState({
                          ...
                          prunSettingRepKMPlant3: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepKMPlant3,
                      );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepKMPlant3,
    );
        ...
        if (this.state.setFlowers7RepKMPlant3 === '') {
          if (this.state.setFlowers6RepKMPlant3 === '') {
            if (this.state.setFlowers5RepKMPlant3 === '') {
              if (this.state.setFlowers4RepKMPlant3 === '') {
                if (this.state.setFlowers3RepKMPlant3 === '') {
                  if (this.state.setFlowers2RepKMPlant3 === '') {
                    if (this.state.setFlowers1RepKMPlant3 === '') {
                      if (this.state.setFlowersRepKMPlant3 === '') {
                        ...
                        this.setState({
                          ...
                          pruneFloweringRepKMPlant3: flowerPruningNumner,
                        });
                        this.setItem(
                          'floweringTrussssRepKMPlant3',
                          floweringTruss,
                      ...
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepKMPlant3,
                      );
                      trussNum = number11;
                      summ =
                        (flowering ? flowering : 0) +
                    ...
                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepKMPlant3,
                    );
                    flowering = parseInt(this.state.setFlowers2RepKMPlant3);
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepKMPlant3,
                    );
                    summ =
                      (flowering ? flowering : 0) +
                      (flowerSetFruits ? flowerSetFruits : 0);
                  ...
                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepKMPlant3,
                  );
                ...
                flowerPruningNumner = parseInt(
                  this.state.pruningNumber4RepKMPlant3,
                );
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepKMPlant3,
              );
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepKMPlant3,
            );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepKMPlant3 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepKMPlant3: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 1 != null) {
        //Change week number
        const weekRowTruss2 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 1;
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepKMPlant3: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 2 != null) {
        //Change week number
        const weekRowTruss3 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 2;
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepKMPlant3: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 3 != null) {
        //Change week number
        const weekRowTruss4 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 3;
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepKMPlant3: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 4 != null) {
        //Change week number
        const weekRowTruss5 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 4;
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepKMPlant3: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 5 != null) {
        //Change week number
        const weekRowTruss6 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 5;
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepKMPlant3: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 6 != null) {
        //Change week number
        const weekRowTruss7 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 6;
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepKMPlant3: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 7 != null) {
        //Change week number
        const weekRowTruss8 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 7;
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepKMPlant3: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 8 != null) {
        //Change week number
        const weekRowTruss9 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 8;
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepKMPlant3: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepKMPlant3) + 9 != null) {
        //Change week number
        const weekRowTruss10 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant3) + 9;
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepKMPlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepKMPlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepKMPlant3: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({ KMPlant3Selected: !this.state.KMPlant3Selected });

    const vart = this.state.KMPlant3Selected;

    const vart2 = false;

    if (vart == null) {
      this.setItem('KMPlant3Selected', vart2);

      EventRegister.emit('kmEventPlant3', vart2);
    } else {
      this.setItem('KMPlant3Selected', vart);

      EventRegister.emit('kmEventPlant3', vart);
    }
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 3,
        leavesPerPlant: this.state.leavesPerPlantRepKMPlant3,
        fullySetTruss: this.state.fullySetTrussRepKMPlant3,
        setTrussLength: this.state.setTrussLengthRepKMPlant3,
        weeklyGrowth: this.state.weeklyGrowthRepKMPlant3,
        floweringTrussHeight: this.state.floweringTrussHeightRepKMPlant3,
        leafLength: this.state.leafLengthRepKMPlant3,
        leafWidth: this.state.leafWidthRepKMPlant3,
        stmDiameter: this.state.stmDiameterRepKMPlant3,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterRepKMPlant3,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepKMPlant3 !== null &&
      this.state.pruningNumberRepKMPlant3 !== null
    ) {
      let data = {
        trussNumber: this.state.trussNumberRepKMPlant3,
        fruitDiameter: this.state.fruitDiameterRepKMPlant3,
        setFruits: this.state.setFruitsRepKMPlant3,
        setFlowers: this.state.setFlowersRepKMPlant3,
        pruningNumber: this.state.pruningNumberRepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
        fruitLoad: this.state.fruitLoadRepKMPlant3,
        pruningFlower: this.state.pruneFloweringRepKMPlant3,
        floweringTruss: this.state.floweringTrussssRepKMPlant3,
        pruningSet: this.state.prunSettingRepKMPlant3,
        settingTruss: this.state.settingTrussNumberRepKMPlant3,
        pruningHarvest: this.state.pruningHarRepKMPlant3,
        harvestTruss: this.state.harvestTrussRepKMPlant3,
      };
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 1 !== null &&
            this.state.pruningNumber1RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 1 != null &&
      this.state.pruningNumber1RepKMPlant3 !== null
    ) {
      let data1 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 1,
        fruitDiameter: this.state.fruitDiameter1RepKMPlant3,
        setFruits: this.state.setFruits1RepKMPlant3,
        setFlowers: this.state.setFlowers1RepKMPlant3,
        pruningNumber: this.state.pruningNumber1RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 2 !== null &&
            this.state.pruningNumber2RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 2 != null &&
      this.state.pruningNumber2RepKMPlant3 !== null
    ) {
      let data2 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 2,
        fruitDiameter: this.state.fruitDiameter2RepKMPlant3,
        setFruits: this.state.setFruits2RepKMPlant3,
        setFlowers: this.state.setFlowers2RepKMPlant3,
        pruningNumber: this.state.pruningNumber2RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 3 !== null &&
            this.state.pruningNumber3RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 3 !== null &&
      this.state.pruningNumber3RepKMPlant3 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 3,
        fruitDiameter: this.state.fruitDiameter3RepKMPlant3,
        setFruits: this.state.setFruits3RepKMPlant3,
        setFlowers: this.state.setFlowers3RepKMPlant3,
        pruningNumber: this.state.pruningNumber3RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 4 !== null &&
            this.state.pruningNumber4RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 4 != null &&
      this.state.pruningNumber4RepKMPlant3 !== null
    ) {
      let data4 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 4,
        fruitDiameter: this.state.fruitDiameter4RepKMPlant3,
        setFruits: this.state.setFruits4RepKMPlant3,
        setFlowers: this.state.setFlowers4RepKMPlant3,
        pruningNumber: this.state.pruningNumber4RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 5 !== null &&
            this.state.pruningNumber5RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 5 != null &&
      this.state.pruningNumber5RepKMPlant3 !== null
    ) {
      let data5 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 5,
        fruitDiameter: this.state.fruitDiameter5RepKMPlant3,
        setFruits: this.state.setFruits5RepKMPlant3,
        setFlowers: this.state.setFlowers5RepKMPlant3,
        pruningNumber: this.state.pruningNumber5RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 6 !== null &&
            this.state.pruningNumber6RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 6 != null &&
      this.state.pruningNumber6RepKMPlant3 !== null
    ) {
      let data6 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 6,
        fruitDiameter: this.state.fruitDiameter6RepKMPlant3,
        setFruits: this.state.setFruits6RepKMPlant3,
        setFlowers: this.state.setFlowers6RepKMPlant3,
        pruningNumber: this.state.pruningNumber6RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 7 !== null &&
            this.state.pruningNumber7RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
          }
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 7 != null &&
      this.state.pruningNumber7RepKMPlant3 !== null
    ) {
      let data7 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 7,
        fruitDiameter: this.state.fruitDiameter7RepKMPlant3,
        setFruits: this.state.setFruits7RepKMPlant3,
        setFlowers: this.state.setFlowers7RepKMPlant3,
        pruningNumber: this.state.pruningNumber7RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 8 !== null &&
            this.state.pruningNumber8RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
          }
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 8 != null &&
      this.state.pruningNumber8RepKMPlant3 !== null
    ) {
      let data8 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 8,
        fruitDiameter: this.state.fruitDiameter8RepKMPlant3,
        setFruits: this.state.setFruits8RepKMPlant3,
        setFlowers: this.state.setFlowers8RepKMPlant3,
        pruningNumber: this.state.pruningNumber8RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant3) + 9 !== null &&
            this.state.pruningNumber9RepKMPlant3 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
          }
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant3) + 9 != null &&
      this.state.pruningNumber9RepKMPlant3 !== null
    ) {
      let data9 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant3) + 9,
        fruitDiameter: this.state.fruitDiameter9RepKMPlant3,
        setFruits: this.state.setFruits9RepKMPlant3,
        setFlowers: this.state.setFlowers9RepKMPlant3,
        pruningNumber: this.state.pruningNumber9RepKMPlant3,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.headerImage1}>
            <TouchableOpacity
              onPress={() => this.props.navigation.push('RepKmPlantsRow1')}
            >
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 3</Text>/ Row No. 807/ Week No.{' '}
        ...
        >
          ...
          >
            <View pointerEvents={this.state.KMPlant3Selected ? 'none' : 'auto'}>
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumberRepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepKMPlant3')
                    }
                    value={this.state.setFlowersRepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumberRepKMPlant3')
                    }
                    value={this.state.pruningNumberRepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameterRepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber1RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepKMPlant3')
                    }
                    value={this.state.setFlowers1RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber1RepKMPlant3')
                    }
                    value={this.state.pruningNumber1RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter1RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber2RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepKMPlant3')
                    }
                    value={this.state.setFlowers2RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber2RepKMPlant3')
                    }
                    value={this.state.pruningNumber2RepKMPlant3}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter2RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber3RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepKMPlant3')
                    }
                    value={this.state.setFlowers3RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber3RepKMPlant3')
                    }
                    value={this.state.pruningNumber3RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter3RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber4RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepKMPlant3')
                    }
                    value={this.state.setFlowers4RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber4RepKMPlant3')
                    }
                    value={this.state.pruningNumber4RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter4RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber5RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepKMPlant3')
                    }
                    value={this.state.setFlowers5RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber5RepKMPlant3')
                    }
                    value={this.state.pruningNumber5RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter5RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber6RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepKMPlant3')
                    }
                    value={this.state.setFlowers6RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber6RepKMPlant3')
                    }
                    value={this.state.pruningNumber6RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter6RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber7RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepKMPlant3')
                    }
                    value={this.state.setFlowers7RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber7RepKMPlant3')
                    }
                    value={this.state.pruningNumber7RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter7RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber8RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepKMPlant3')
                    }
                    value={this.state.setFlowers8RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber8RepKMPlant3')
                    }
                    value={this.state.pruningNumber8RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter8RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'trussNumber9RepKMPlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepKMPlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepKMPlant3')
                    }
                    value={this.state.setFlowers9RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber9RepKMPlant3')
                    }
                    value={this.state.pruningNumber9RepKMPlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter9RepKMPlant3')
                    }
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepKMPlant3 <= 22 ||
                      this.state.fruitLoadRepKMPlant3 >= 40
                  ...
                  >
                    ...
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.fruitLoadRepKMPlant3}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepKMPlant3 <= 0 ||
                      this.state.floweringTrussssRepKMPlant3 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepKMPlant3}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepKMPlant3 <= 1 ||
                      this.state.settingTrussNumberRepKMPlant3 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepKMPlant3}
                      </Text>
                    </View>
                    <View
                      style={{
                  ...
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.harvestTrussRepKMPlant3}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <CheckBox
                  ...
                  uncheckedColor="red"
                  checkedColor="green"
                  title="KM Plant 3 completed"
                  checked={this.state.KMPlant3Selected}

...
export default class Har3AngellePlantsRow1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      weekNumber: '',
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.har3AngelleRow1EventPlant1);
    EventRegister.removeEventListener(this.har3AngelleRow1EventPlant2);
    EventRegister.removeEventListener(this.har3AngelleRow1EventPlant3);
  }
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.har3AngelleRow1EventPlant1 = EventRegister.addEventListener(
      'har3AngelleRow1EventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.har3AngelleRow1EventPlant2 = EventRegister.addEventListener(
      'har3AngelleRow1EventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.har3AngelleRow1EventPlant3 = EventRegister.addEventListener(
      'har3AngelleRow1EventPlant3',
      data3 => {

...
export default class RepAngelleRow2Plant3 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepAngelleRow2Plant3 =
      this.onSubmitleavesPerPlantRepAngelleRow2Plant3.bind(this);
    ...
    this.leavesPerPlantRepAngelleRow2Plant3Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepAngelleRow2Plant3')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepAngelleRow2Plant3: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepAngelleRow2Plant3')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepAngelleRow2Plant3: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepAngelleRow2Plant3')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepAngelleRow2Plant3: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepAngelleRow2Plant3')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepAngelleRow2Plant3: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepAngelleRow2Plant3')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepAngelleRow2Plant3: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepAngelleRow2Plant3')
        .then(text6Value => {
          this.setState({
            leafLengthRepAngelleRow2Plant3: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepAngelleRow2Plant3')
        .then(text7Value => {
          this.setState({
            leafWidthRepAngelleRow2Plant3: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterRepAngelleRow2Plant3')
        .then(text8Value => {
          this.setState({
            stmDiameterRepAngelleRow2Plant3: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepAngelleRow2Plant3')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepAngelleRow2Plant3: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('AngelleRow2Plant3Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepAngelleRow2Plant3')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepAngelleRow2Plant3: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 1,
            });
            this.setState({
              trussNumber2RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 2,
            });
            this.setState({
              trussNumber3RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 3,
            });
            this.setState({
              trussNumber4RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 4,
            });
            this.setState({
              trussNumber5RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 5,
            });
            this.setState({
              trussNumber6RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 6,
            });
            this.setState({
              trussNumber7RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 7,
            });
            this.setState({
              trussNumber8RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 8,
            });
            this.setState({
              trussNumber9RepAngelleRow2Plant3:
                parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepAngelleRow2Plant3')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepAngelleRow2Plant3: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepAngelleRow2Plant3')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepAngelleRow2Plant3: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepAngelleRow2Plant3')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepAngelleRow2Plant3: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepAngelleRow2Plant3')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepAngelleRow2Plant3: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepAngelleRow2Plant3')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepAngelleRow2Plant3: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepAngelleRow2Plant3')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepAngelleRow2Plant3: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepAngelleRow2Plant3')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepAngelleRow2Plant3: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepAngelleRow2Plant3')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepAngelleRow2Plant3: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepAngelleRow2Plant3')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepAngelleRow2Plant3: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepAngelleRow2Plant3')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepAngelleRow2Plant3: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepAngelleRow2Plant3')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepAngelleRow2Plant3: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepAngelleRow2Plant3')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepAngelleRow2Plant3: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepAngelleRow2Plant3')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepAngelleRow2Plant3: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepAngelleRow2Plant3')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepAngelleRow2Plant3: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepAngelleRow2Plant3')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepAngelleRow2Plant3: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepAngelleRow2Plant3')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepAngelleRow2Plant3: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepAngelleRow2Plant3')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepAngelleRow2Plant3: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepAngelleRow2Plant3')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepAngelleRow2Plant3: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepAngelleRow2Plant3')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepAngelleRow2Plant3: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepAngelleRow2Plant3')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepAngelleRow2Plant3: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepAngelleRow2Plant3')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepAngelleRow2Plant3: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepAngelleRow2Plant3')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepAngelleRow2Plant3: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepAngelleRow2Plant3')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepAngelleRow2Plant3: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepAngelleRow2Plant3')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepAngelleRow2Plant3: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepAngelleRow2Plant3')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepAngelleRow2Plant3: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepAngelleRow2Plant3')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepAngelleRow2Plant3: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepAngelleRow2Plant3')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepAngelleRow2Plant3: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepAngelleRow2Plant3')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepAngelleRow2Plant3: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepAngelleRow2Plant3')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepAngelleRow2Plant3: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepAngelleRow2Plant3')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepAngelleRow2Plant3: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepAngelleRow2Plant3')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepAngelleRow2Plant3: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepAngelleRow2Plant3')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepAngelleRow2Plant3: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepAngelleRow2Plant3')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepAngelleRow2Plant3: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepAngelleRow2Plant3')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepAngelleRow2Plant3: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepAngelleRow2Plant3')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepAngelleRow2Plant3: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepAngelleRow2Plant3')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepAngelleRow2Plant3: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepAngelleRow2Plant3')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepAngelleRow2Plant3: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepAngelleRow2Plant3')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepAngelleRow2Plant3: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepAngelleRow2Plant3')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepAngelleRow2Plant3: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepAngelleRow2Plant3')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepAngelleRow2Plant3: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepAngelleRow2Plant3')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepAngelleRow2Plant3: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepAngelleRow2Plant3')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepAngelleRow2Plant3: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepAngelleRow2Plant3')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepAngelleRow2Plant3: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepAngelleRow2Plant3')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepAngelleRow2Plant3: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepAngelleRow2Plant3)
        ? parseInt(this.state.setFruitsRepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits1RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits1RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits2RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits2RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits3RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits3RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits4RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits4RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits5RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits5RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits6RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits6RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits7RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits7RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits8RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits8RepAngelleRow2Plant3)
        : 0) +
      (parseInt(this.state.setFruits9RepAngelleRow2Plant3)
        ? parseInt(this.state.setFruits9RepAngelleRow2Plant3)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepAngelleRow2Plant3',
      this.state.fruitLoadRepAngelleRow2Plant3,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepAngelleRow2Plant3 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepAngelleRow2Plant3
            ? this.state.setFruitsRepAngelleRow2Plant3
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepAngelleRow2Plant3
            ? this.state.pruningNumberRepAngelleRow2Plant3
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepAngelleRow2Plant3)
          ? parseInt(this.state.trussNumberRepAngelleRow2Plant3)
          : 0) + sub
      ).toFixed(2);
      this.setState({
    ...
    this.setItem(
      'harvestTrussRepAngelleRow2Plant3',
      this.state.harvestTrussRepAngelleRow2Plant3,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepAngelleRow2Plant3,
    );
      ...
      if (this.state.setFruits8RepAngelleRow2Plant3 === '') {
        if (this.state.setFruits7RepAngelleRow2Plant3 === '') {
          if (this.state.setFruits6RepAngelleRow2Plant3 === '') {
            if (this.state.setFruits5RepAngelleRow2Plant3 === '') {
              if (this.state.setFruits4RepAngelleRow2Plant3 === '') {
                if (this.state.setFruits3RepAngelleRow2Plant3 === '') {
                  if (this.state.setFruits2RepAngelleRow2Plant3 === '') {
                    if (this.state.setFruits1RepAngelleRow2Plant3 === '') {
                      if (this.state.setFruitsRepAngelleRow2Plant3 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepAngelleRow2Plant3,
                        );
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepAngelleRow2Plant3,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepAngelleRow2Plant3,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepAngelleRow2Plant3,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepAngelleRow2Plant3,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepAngelleRow2Plant3,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepAngelleRow2Plant3,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepAngelleRow2Plant3,
                );
                trussNum = parseInt(number4);
                settingFruit = parseInt(
                  this.state.setFruits4RepAngelleRow2Plant3,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = parseInt(
                this.state.pruningNumber5RepAngelleRow2Plant3,
              );
              trussNum = parseInt(number5);
              settingFruit = parseInt(
                this.state.setFruits5RepAngelleRow2Plant3,
              );
            ...
            pruningSet = parseInt(
              this.state.pruningNumber6RepAngelleRow2Plant3,
            );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepAngelleRow2Plant3,
    );
    ...
    if (this.state.setFlowers9RepAngelleRow2Plant3 === '') {
      if (this.state.setFlowers8RepAngelleRow2Plant3 === '') {
        if (this.state.setFlowers7RepAngelleRow2Plant3 === '') {
          if (this.state.setFlowers6RepAngelleRow2Plant3 === '') {
            if (this.state.setFlowers5RepAngelleRow2Plant3 === '') {
              if (this.state.setFlowers4RepAngelleRow2Plant3 === '') {
                if (this.state.setFlowers3RepAngelleRow2Plant3 === '') {
                  if (this.state.setFlowers2RepAngelleRow2Plant3 === '') {
                    if (this.state.setFlowers1RepAngelleRow2Plant3 === '') {
                      if (this.state.setFlowersRepAngelleRow2Plant3 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepAngelleRow2Plant3,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberRepAngelleRow2Plant3 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepAngelleRow2Plant3,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepAngelleRow2Plant3,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberRepAngelleRow2Plant3 + 2;

                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepAngelleRow2Plant3,
                    );
                    flowering = parseInt(
                      this.state.setFlowers2RepAngelleRow2Plant3,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepAngelleRow2Plant3,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberRepAngelleRow2Plant3 + 3;

                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepAngelleRow2Plant3,
                  );
                  flowering = parseInt(
                    this.state.setFlowers3RepAngelleRow2Plant3,
                  );
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepAngelleRow2Plant3,
                  );
                ...
                flowering = parseInt(
                  this.state.setFlowers4RepAngelleRow2Plant3,
                );
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepAngelleRow2Plant3,
                );
            ...
            flowerSetFruits = parseInt(
              this.state.setFruits6RepAngelleRow2Plant3,
            );
            summ =
              (flowering ? flowering : 0) +
              (flowerSetFruits ? flowerSetFruits : 0);
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepAngelleRow2Plant3,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepAngelleRow2Plant3,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepAngelleRow2Plant3,
      );
      ...
      if (this.state.trussNumberRepAngelleRow2Plant3 != null) {
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 1 != null) {
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 2 != null) {
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 3 != null) {
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 4 != null) {
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 5 != null) {
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 6 != null) {
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 7 != null) {
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 8 != null) {
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepAngelleRow2Plant3: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 9 != null) {
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepAngelleRow2Plant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepAngelleRow2Plant3: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      AngelleRow2Plant3Selected: !this.state.AngelleRow2Plant3Selected,
    });
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        floweringTrussHeight:
          this.state.floweringTrussHeightRepAngelleRow2Plant3,
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepAngelleRow2Plant3 !== null &&
      this.state.pruningNumberRepAngelleRow2Plant3 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 1 !== null &&
            this.state.pruningNumber1RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 1 != null &&
      this.state.pruningNumber1RepAngelleRow2Plant3 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 2 !== null &&
            this.state.pruningNumber2RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 2 != null &&
      this.state.pruningNumber2RepAngelleRow2Plant3 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 3 !== null &&
            this.state.pruningNumber3RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 3 !== null &&
      this.state.pruningNumber3RepAngelleRow2Plant3 !== null
    ) {
      let data3 = {
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 4 !== null &&
            this.state.pruningNumber4RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 4 != null &&
      this.state.pruningNumber4RepAngelleRow2Plant3 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 5 !== null &&
            this.state.pruningNumber5RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 5 != null &&
      this.state.pruningNumber5RepAngelleRow2Plant3 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 6 !== null &&
            this.state.pruningNumber6RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 6 != null &&
      this.state.pruningNumber6RepAngelleRow2Plant3 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 7 !== null &&
            this.state.pruningNumber7RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 7 != null &&
      this.state.pruningNumber7RepAngelleRow2Plant3 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 8 !== null &&
            this.state.pruningNumber8RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 8 != null &&
      this.state.pruningNumber8RepAngelleRow2Plant3 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 9 !== null &&
            this.state.pruningNumber9RepAngelleRow2Plant3 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepAngelleRow2Plant3) + 9 != null &&
      this.state.pruningNumber9RepAngelleRow2Plant3 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 3</Text>/ Row No. 823/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.AngelleRow2Plant3Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterRepAngelleRow2Plant3
                        }
                        ref={input => {
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepAngelleRow2Plant3 <= 22 ||
                      this.state.fruitLoadRepAngelleRow2Plant3 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepAngelleRow2Plant3 <= 0 ||
                      this.state.floweringTrussssRepAngelleRow2Plant3 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepAngelleRow2Plant3}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepAngelleRow2Plant3 <= 1 ||
                      this.state.settingTrussNumberRepAngelleRow2Plant3 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepAngelleRow2Plant3}
                      </Text>
                    </View>
                    <View
                      style={{

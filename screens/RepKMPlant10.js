...
export default class RepKMPlant10 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepKMPlant10 =
      this.onSubmitleavesPerPlantRepKMPlant10.bind(this);
    ...
    this.leavesPerPlantRepKMPlant10Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepKMPlant10')
        .then(text1Value => {
    ...
    try {
      AsyncStorage.getItem('fullySetTrussRepKMPlant10')
        .then(text2Value => {
    ...
    try {
      AsyncStorage.getItem('setTrussLengthRepKMPlant10')
        .then(text3Value => {
    ...
    try {
      AsyncStorage.getItem('weeklyGrowthRepKMPlant10')
        .then(text4Value => {
    ...
    try {
      AsyncStorage.getItem('floweringTrussHeightRepKMPlant10')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepKMPlant10: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepKMPlant10')
        .then(text6Value => {
    ...
    try {
      AsyncStorage.getItem('leafWidthRepKMPlant10')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepKMPlant10')
        .then(text8Value => {
    ...
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepKMPlant10')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepKMPlant10: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('KMPlant10Selected')
        .then(text99Value => {
    ...
    try {
      AsyncStorage.getItem('trussNumberRepKMPlant10')
        .then(text10Value => {
          if (text10Value !== null) {
            ...
            this.setState({
              trussNumber1RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 1,
            });
            this.setState({
              trussNumber2RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 2,
            });
            this.setState({
              trussNumber3RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 3,
            });
            this.setState({
              trussNumber4RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 4,
            });
            this.setState({
              trussNumber5RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 5,
            });
            this.setState({
              trussNumber6RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 6,
            });
            this.setState({
              trussNumber7RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 7,
            });
            this.setState({
              trussNumber8RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 8,
            });
            this.setState({
              trussNumber9RepKMPlant10:
                parseInt(this.state.trussNumberRepKMPlant10) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepKMPlant10')
        .then(text11Value => {
          if (text11Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowersRepKMPlant10')
        .then(text12Value => {
          if (text12Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepKMPlant10')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepKMPlant10: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepKMPlant10')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepKMPlant10: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepKMPlant10')
        .then(text16Value => {
          if (text16Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepKMPlant10')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepKMPlant10')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepKMPlant10: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepKMPlant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepKMPlant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepKMPlant10')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepKMPlant10')
        .then(text18Value => {
          if (text18Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepKMPlant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepKMPlant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepKMPlant10')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepKMPlant10: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepKMPlant10')
        .then(text21Value => {
          if (text21Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepKMPlant10')
        .then(text22Value => {
          if (text22Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepKMPlant10')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepKMPlant10: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepKMPlant10')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepKMPlant10: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepKMPlant10')
        .then(text25Value => {
          if (text25Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepKMPlant10')
        .then(text26Value => {
          if (text26Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepKMPlant10')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepKMPlant10: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepKMPlant10')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepKMPlant10: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepKMPlant10')
        .then(text29Value => {
          if (text29Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepKMPlant10')
        .then(text30Value => {
          if (text30Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepKMPlant10')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepKMPlant10: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepKMPlant10')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepKMPlant10: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepKMPlant10')
        .then(text33Value => {
          if (text33Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepKMPlant10')
        .then(text34Value => {
          if (text34Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepKMPlant10')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepKMPlant10: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepKMPlant10')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepKMPlant10: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepKMPlant10')
        .then(text37Value => {
          if (text37Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepKMPlant10')
        .then(text38Value => {
          if (text38Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepKMPlant10')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepKMPlant10: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepKMPlant10')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepKMPlant10: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepKMPlant10')
        .then(text41Value => {
          if (text41Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepKMPlant10')
        .then(text42Value => {
          if (text42Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepKMPlant10')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepKMPlant10: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepKMPlant10')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepKMPlant10: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepKMPlant10')
        .then(text45Value => {
          if (text45Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepKMPlant10')
        .then(text46Value => {
          if (text46Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepKMPlant10')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepKMPlant10: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepKMPlant10')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepKMPlant10: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepKMPlant10')
        .then(text49Value => {
          if (text49Value !== null) {
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepKMPlant10')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepKMPlant10: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepKMPlant10')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepKMPlant10: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepKMPlant10')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepKMPlant10: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepKMPlant10)
        ? parseInt(this.state.setFruitsRepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits1RepKMPlant10)
        ? parseInt(this.state.setFruits1RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits2RepKMPlant10)
        ? parseInt(this.state.setFruits2RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits3RepKMPlant10)
        ? parseInt(this.state.setFruits3RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits4RepKMPlant10)
        ? parseInt(this.state.setFruits4RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits5RepKMPlant10)
        ? parseInt(this.state.setFruits5RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits6RepKMPlant10)
        ? parseInt(this.state.setFruits6RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits7RepKMPlant10)
        ? parseInt(this.state.setFruits7RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits8RepKMPlant10)
        ? parseInt(this.state.setFruits8RepKMPlant10)
        : 0) +
      (parseInt(this.state.setFruits9RepKMPlant10)
        ? parseInt(this.state.setFruits9RepKMPlant10)
        : 0);
    this.setState({
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepKMPlant10 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepKMPlant10
            ? this.state.setFruitsRepKMPlant10
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepKMPlant10
            ? this.state.pruningNumberRepKMPlant10
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepKMPlant10)
          ? parseInt(this.state.trussNumberRepKMPlant10)
          : 0) + sub
      ).toFixed(2);
      this.setState({
    ...
    this.setItem(
      'harvestTrussRepKMPlant10',
      this.state.harvestTrussRepKMPlant10,
    );
  };
                ...
                if (this.state.setFruits3RepKMPlant10 === '') {
                  if (this.state.setFruits2RepKMPlant10 === '') {
                    if (this.state.setFruits1RepKMPlant10 === '') {
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepKMPlant10,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepKMPlant10,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepKMPlant10,
                    );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepKMPlant10,
    );
      ...
      if (this.state.setFlowers8RepKMPlant10 === '') {
        if (this.state.setFlowers7RepKMPlant10 === '') {
          if (this.state.setFlowers6RepKMPlant10 === '') {
            if (this.state.setFlowers5RepKMPlant10 === '') {
              if (this.state.setFlowers4RepKMPlant10 === '') {
                if (this.state.setFlowers3RepKMPlant10 === '') {
                  ...
                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepKMPlant10,
                  );
                ...
                flowerPruningNumner = parseInt(
                  this.state.pruningNumber4RepKMPlant10,
                );
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepKMPlant10,
              );
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepKMPlant10,
            );
    ...
    if (this.state.allTrussData.length != 0) {
      ...
      if (this.state.trussNumberRepKMPlant10 != null) {
        ...
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 1 != null) {
        ...
        const weekRowTruss2 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 1;
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 2 != null) {
        ...
        const weekRowTruss3 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 2;
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 3 != null) {
        ...
        const weekRowTruss4 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 3;
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 4 != null) {
        ...
        const weekRowTruss5 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 4;
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 5 != null) {
        ...
        const weekRowTruss6 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 5;
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 6 != null) {
        ...
        const weekRowTruss7 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 6;
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 7 != null) {
        ...
        const weekRowTruss8 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 7;
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 8 != null) {
        ...
        const weekRowTruss9 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 8;
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepKMPlant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepKMPlant10) + 9 != null) {
        ...
        const weekRowTruss10 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant10) + 9;
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepKMPlant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepKMPlant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepKMPlant10: JSON.stringify(
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepKMPlant10 !== null &&
      this.state.pruningNumberRepKMPlant10 !== null
    ) {
      let data = {
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 1 !== null &&
            this.state.pruningNumber1RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 1 != null &&
      this.state.pruningNumber1RepKMPlant10 !== null
    ) {
      let data1 = {
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 2 !== null &&
            this.state.pruningNumber2RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 2 != null &&
      this.state.pruningNumber2RepKMPlant10 !== null
    ) {
      let data2 = {
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 3 !== null &&
            this.state.pruningNumber3RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 3 !== null &&
      this.state.pruningNumber3RepKMPlant10 !== null
    ) {
      let data3 = {
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 4 !== null &&
            this.state.pruningNumber4RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 4 != null &&
      this.state.pruningNumber4RepKMPlant10 !== null
    ) {
      let data4 = {
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 5 !== null &&
            this.state.pruningNumber5RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 5 != null &&
      this.state.pruningNumber5RepKMPlant10 !== null
    ) {
      let data5 = {
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 6 !== null &&
            this.state.pruningNumber6RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 6 != null &&
      this.state.pruningNumber6RepKMPlant10 !== null
    ) {
      let data6 = {
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 7 !== null &&
            this.state.pruningNumber7RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
          }
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 7 != null &&
      this.state.pruningNumber7RepKMPlant10 !== null
    ) {
      let data7 = {
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 8 !== null &&
            this.state.pruningNumber8RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
          }
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 8 != null &&
      this.state.pruningNumber8RepKMPlant10 !== null
    ) {
      let data8 = {
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant10) + 9 !== null &&
            this.state.pruningNumber9RepKMPlant10 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
          }
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant10) + 9 != null &&
      this.state.pruningNumber9RepKMPlant10 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 10</Text>/ Row No. 807/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={this.state.KMPlant10Selected ? 'none' : 'auto'}
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumberRepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumberRepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameterRepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber1RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber1RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter1RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber2RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber2RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter2RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber3RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber3RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter3RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber4RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber4RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter4RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber5RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber5RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter5RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber6RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber6RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter6RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber7RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber7RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter7RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber8RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber8RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter8RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'trussNumber9RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepKMPlant10')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber9RepKMPlant10')
                    }
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter9RepKMPlant10')
                    }
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepKMPlant10 <= 22 ||
                      this.state.fruitLoadRepKMPlant10 >= 40
                  ...
                  >
                    ...
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.fruitLoadRepKMPlant10}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepKMPlant10 <= 0 ||
                      this.state.floweringTrussssRepKMPlant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepKMPlant10}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepKMPlant10 <= 1 ||
                      this.state.settingTrussNumberRepKMPlant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepKMPlant10}
                      </Text>
                    </View>
                    <View
                      style={{

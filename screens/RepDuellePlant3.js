...
export default class RepDuellePlant3 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepDuellePlant3 =
      this.onSubmitleavesPerPlantRepDuellePlant3.bind(this);
    ...
    this.leavesPerPlantRepDuellePlant3Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepDuellePlant3')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepDuellePlant3: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepDuellePlant3')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepDuellePlant3: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepDuellePlant3')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepDuellePlant3: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepDuellePlant3')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepDuellePlant3: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepDuellePlant3')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepDuellePlant3: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepDuellePlant3')
        .then(text6Value => {
    ...
    try {
      AsyncStorage.getItem('leafWidthRepDuellePlant3')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepDuellePlant3')
        .then(text8Value => {
    ...
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepDuellePlant3')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepDuellePlant3: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('DuellePlant3Selected')
        .then(text99Value => {
          this.setState({ DuellePlant3Selected: JSON.parse(text99Value) });

          console.log(this.state.DuellePlant3Selected);
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('trussNumberRepDuellePlant3')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepDuellePlant3: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 1,
            });
            this.setState({
              trussNumber2RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 2,
            });
            this.setState({
              trussNumber3RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 3,
            });
            this.setState({
              trussNumber4RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 4,
            });
            this.setState({
              trussNumber5RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 5,
            });
            this.setState({
              trussNumber6RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 6,
            });
            this.setState({
              trussNumber7RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 7,
            });
            this.setState({
              trussNumber8RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 8,
            });
            this.setState({
              trussNumber9RepDuellePlant3:
                parseInt(this.state.trussNumberRepDuellePlant3) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepDuellePlant3')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepDuellePlant3: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepDuellePlant3')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepDuellePlant3: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepDuellePlant3')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepDuellePlant3: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepDuellePlant3')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepDuellePlant3: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepDuellePlant3')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepDuellePlant3: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepDuellePlant3')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepDuellePlant3: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepDuellePlant3')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepDuellePlant3: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepDuellePlant3')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepDuellePlant3: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepDuellePlant3')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepDuellePlant3: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepDuellePlant3')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepDuellePlant3: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepDuellePlant3')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepDuellePlant3: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepDuellePlant3')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepDuellePlant3: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepDuellePlant3')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepDuellePlant3: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepDuellePlant3')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepDuellePlant3: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepDuellePlant3')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepDuellePlant3: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepDuellePlant3')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepDuellePlant3: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepDuellePlant3')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepDuellePlant3: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepDuellePlant3')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepDuellePlant3: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepDuellePlant3')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepDuellePlant3: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepDuellePlant3')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepDuellePlant3: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepDuellePlant3')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepDuellePlant3: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepDuellePlant3')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepDuellePlant3: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepDuellePlant3')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepDuellePlant3: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepDuellePlant3')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepDuellePlant3: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepDuellePlant3')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepDuellePlant3: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepDuellePlant3')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepDuellePlant3: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepDuellePlant3')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepDuellePlant3: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepDuellePlant3')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepDuellePlant3: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepDuellePlant3')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepDuellePlant3: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepDuellePlant3')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepDuellePlant3: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepDuellePlant3')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepDuellePlant3: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepDuellePlant3')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepDuellePlant3: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepDuellePlant3')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepDuellePlant3: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepDuellePlant3')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepDuellePlant3: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepDuellePlant3')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepDuellePlant3: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepDuellePlant3')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepDuellePlant3: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepDuellePlant3')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepDuellePlant3: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepDuellePlant3')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepDuellePlant3: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepDuellePlant3')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepDuellePlant3: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepDuellePlant3')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepDuellePlant3: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepDuellePlant3')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepDuellePlant3: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepDuellePlant3')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepDuellePlant3: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepDuellePlant3')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepDuellePlant3: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepDuellePlant3')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepDuellePlant3: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepDuellePlant3)
        ? parseInt(this.state.setFruitsRepDuellePlant3)
        : 0) +
      ...
      (parseInt(this.state.setFruits2RepDuellePlant3)
        ? parseInt(this.state.setFruits2RepDuellePlant3)
        : 0) +
      (parseInt(this.state.setFruits3RepDuellePlant3)
        ? parseInt(this.state.setFruits3RepDuellePlant3)
        : 0) +
      (parseInt(this.state.setFruits4RepDuellePlant3)
        ? parseInt(this.state.setFruits4RepDuellePlant3)
        : 0) +
      ...
      (parseInt(this.state.setFruits6RepDuellePlant3)
        ? parseInt(this.state.setFruits6RepDuellePlant3)
        : 0) +
      (parseInt(this.state.setFruits7RepDuellePlant3)
        ? parseInt(this.state.setFruits7RepDuellePlant3)
        : 0) +
      (parseInt(this.state.setFruits8RepDuellePlant3)
        ? parseInt(this.state.setFruits8RepDuellePlant3)
        : 0) +
      (parseInt(this.state.setFruits9RepDuellePlant3)
        ? parseInt(this.state.setFruits9RepDuellePlant3)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepDuellePlant3',
      this.state.fruitLoadRepDuellePlant3,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepDuellePlant3 === '') {
      ...
      div =
        ...
        parseFloat(
          this.state.pruningNumberRepDuellePlant3
            ? this.state.pruningNumberRepDuellePlant3
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepDuellePlant3)
          ? parseInt(this.state.trussNumberRepDuellePlant3)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepDuellePlant3: add,
        pruningHarRepDuellePlant3: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepDuellePlant3);
    ...
    this.setItem(
      'harvestTrussRepDuellePlant3',
      this.state.harvestTrussRepDuellePlant3,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepDuellePlant3,
    );
            ...
            if (this.state.setFruits5RepDuellePlant3 === '') {
              if (this.state.setFruits4RepDuellePlant3 === '') {
                if (this.state.setFruits3RepDuellePlant3 === '') {
                  if (this.state.setFruits2RepDuellePlant3 === '') {
                    if (this.state.setFruits1RepDuellePlant3 === '') {
                      if (this.state.setFruitsRepDuellePlant3 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepDuellePlant3,
                        );
                        ...
                        this.setState({
                          ...
                          prunSettingRepDuellePlant3: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepDuellePlant3,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepDuellePlant3,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepDuellePlant3,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepDuellePlant3,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepDuellePlant3,
                  );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepDuellePlant3,
    );
      ...
      if (this.state.setFlowers8RepDuellePlant3 === '') {
        if (this.state.setFlowers7RepDuellePlant3 === '') {
          if (this.state.setFlowers6RepDuellePlant3 === '') {
            if (this.state.setFlowers5RepDuellePlant3 === '') {
              if (this.state.setFlowers4RepDuellePlant3 === '') {
                if (this.state.setFlowers3RepDuellePlant3 === '') {
                  if (this.state.setFlowers2RepDuellePlant3 === '') {
                    if (this.state.setFlowers1RepDuellePlant3 === '') {
                      if (this.state.setFlowersRepDuellePlant3 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepDuellePlant3,
                        );
                        ...
                        this.setState({
                          ...
                          pruneFloweringRepDuellePlant3: flowerPruningNumner,
                        });
                        this.setItem(
                          'floweringTrussssRepDuellePlant3',
                          floweringTruss,
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepDuellePlant3,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepDuellePlant3,
                      );
                  ...
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepDuellePlant3,
                  );
                  summ =
                    (flowering ? flowering : 0) +
                    (flowerSetFruits ? flowerSetFruits : 0);
                ...
                flowerPruningNumner = parseInt(
                  this.state.pruningNumber4RepDuellePlant3,
                );
                flowering = parseInt(this.state.setFlowers4RepDuellePlant3);
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepDuellePlant3,
                );
                summ =
                  (flowering ? flowering : 0) +
                  (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepDuellePlant3,
              );
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepDuellePlant3,
            );
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepDuellePlant3,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepDuellePlant3,
        );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepDuellePlant3 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepDuellePlant3: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 1 != null) {
        //Change week number
        const weekRowTruss2 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 1;
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepDuellePlant3: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 2 != null) {
        //Change week number
        const weekRowTruss3 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 2;
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepDuellePlant3: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 3 != null) {
        //Change week number
        const weekRowTruss4 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 3;
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepDuellePlant3: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 4 != null) {
        //Change week number
        const weekRowTruss5 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 4;
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepDuellePlant3: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 5 != null) {
        //Change week number
        const weekRowTruss6 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 5;
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepDuellePlant3: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 6 != null) {
        //Change week number
        const weekRowTruss7 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 6;
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepDuellePlant3: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 7 != null) {
        //Change week number
        const weekRowTruss8 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 7;
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepDuellePlant3: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 8 != null) {
        //Change week number
        const weekRowTruss9 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 8;
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepDuellePlant3: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepDuellePlant3) + 9 != null) {
        //Change week number
        const weekRowTruss10 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepDuellePlant3) + 9;
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepDuellePlant3: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepDuellePlant3: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepDuellePlant3: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({ DuellePlant3Selected: !this.state.DuellePlant3Selected });

    const vart = this.state.DuellePlant3Selected;

    const vart2 = false;

    if (vart == null) {
      this.setItem('DuellePlant3Selected', vart2);

      EventRegister.emit('duelleEventPlant3', vart2);
    } else {
      this.setItem('DuellePlant3Selected', vart);

      EventRegister.emit('duelleEventPlant3', vart);
    }
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 3,
        leavesPerPlant: this.state.leavesPerPlantRepDuellePlant3,
        fullySetTruss: this.state.fullySetTrussRepDuellePlant3,
        setTrussLength: this.state.setTrussLengthRepDuellePlant3,
        weeklyGrowth: this.state.weeklyGrowthRepDuellePlant3,
        floweringTrussHeight: this.state.floweringTrussHeightRepDuellePlant3,
        leafLength: this.state.leafLengthRepDuellePlant3,
        leafWidth: this.state.leafWidthRepDuellePlant3,
        stmDiameter: this.state.stmDiameterRepDuellePlant3,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterRepDuellePlant3,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepDuellePlant3 !== null &&
      this.state.pruningNumberRepDuellePlant3 !== null
    ) {
      let data = {
        trussNumber: this.state.trussNumberRepDuellePlant3,
        fruitDiameter: this.state.fruitDiameterRepDuellePlant3,
        setFruits: this.state.setFruitsRepDuellePlant3,
        setFlowers: this.state.setFlowersRepDuellePlant3,
        pruningNumber: this.state.pruningNumberRepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
        fruitLoad: this.state.fruitLoadRepDuellePlant3,
        pruningFlower: this.state.pruneFloweringRepDuellePlant3,
        floweringTruss: this.state.floweringTrussssRepDuellePlant3,
        pruningSet: this.state.prunSettingRepDuellePlant3,
        settingTruss: this.state.settingTrussNumberRepDuellePlant3,
        pruningHarvest: this.state.pruningHarRepDuellePlant3,
        harvestTruss: this.state.harvestTrussRepDuellePlant3,
      };
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 1 !== null &&
            this.state.pruningNumber1RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 1 != null &&
      this.state.pruningNumber1RepDuellePlant3 !== null
    ) {
      let data1 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 1,
        fruitDiameter: this.state.fruitDiameter1RepDuellePlant3,
        setFruits: this.state.setFruits1RepDuellePlant3,
        setFlowers: this.state.setFlowers1RepDuellePlant3,
        pruningNumber: this.state.pruningNumber1RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 2 !== null &&
            this.state.pruningNumber2RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 2 != null &&
      this.state.pruningNumber2RepDuellePlant3 !== null
    ) {
      let data2 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 2,
        fruitDiameter: this.state.fruitDiameter2RepDuellePlant3,
        setFruits: this.state.setFruits2RepDuellePlant3,
        setFlowers: this.state.setFlowers2RepDuellePlant3,
        pruningNumber: this.state.pruningNumber2RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 3 !== null &&
            this.state.pruningNumber3RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 3 !== null &&
      this.state.pruningNumber3RepDuellePlant3 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 3,
        fruitDiameter: this.state.fruitDiameter3RepDuellePlant3,
        setFruits: this.state.setFruits3RepDuellePlant3,
        setFlowers: this.state.setFlowers3RepDuellePlant3,
        pruningNumber: this.state.pruningNumber3RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 4 !== null &&
            this.state.pruningNumber4RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 4 != null &&
      this.state.pruningNumber4RepDuellePlant3 !== null
    ) {
      let data4 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 4,
        fruitDiameter: this.state.fruitDiameter4RepDuellePlant3,
        setFruits: this.state.setFruits4RepDuellePlant3,
        setFlowers: this.state.setFlowers4RepDuellePlant3,
        pruningNumber: this.state.pruningNumber4RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 5 !== null &&
            this.state.pruningNumber5RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 5 != null &&
      this.state.pruningNumber5RepDuellePlant3 !== null
    ) {
      let data5 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 5,
        fruitDiameter: this.state.fruitDiameter5RepDuellePlant3,
        setFruits: this.state.setFruits5RepDuellePlant3,
        setFlowers: this.state.setFlowers5RepDuellePlant3,
        pruningNumber: this.state.pruningNumber5RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 6 !== null &&
            this.state.pruningNumber6RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 6 != null &&
      this.state.pruningNumber6RepDuellePlant3 !== null
    ) {
      let data6 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 6,
        fruitDiameter: this.state.fruitDiameter6RepDuellePlant3,
        setFruits: this.state.setFruits6RepDuellePlant3,
        setFlowers: this.state.setFlowers6RepDuellePlant3,
        pruningNumber: this.state.pruningNumber6RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 7 !== null &&
            this.state.pruningNumber7RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 7 != null &&
      this.state.pruningNumber7RepDuellePlant3 !== null
    ) {
      let data7 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 7,
        fruitDiameter: this.state.fruitDiameter7RepDuellePlant3,
        setFruits: this.state.setFruits7RepDuellePlant3,
        setFlowers: this.state.setFlowers7RepDuellePlant3,
        pruningNumber: this.state.pruningNumber7RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 8 !== null &&
            this.state.pruningNumber8RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 8 != null &&
      this.state.pruningNumber8RepDuellePlant3 !== null
    ) {
      let data8 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 8,
        fruitDiameter: this.state.fruitDiameter8RepDuellePlant3,
        setFruits: this.state.setFruits8RepDuellePlant3,
        setFlowers: this.state.setFlowers8RepDuellePlant3,
        pruningNumber: this.state.pruningNumber8RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepDuellePlant3) + 9 !== null &&
            this.state.pruningNumber9RepDuellePlant3 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
          }
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepDuellePlant3) + 9 != null &&
      this.state.pruningNumber9RepDuellePlant3 !== null
    ) {
      let data9 = {
        trussNumber: parseInt(this.state.trussNumberRepDuellePlant3) + 9,
        fruitDiameter: this.state.fruitDiameter9RepDuellePlant3,
        setFruits: this.state.setFruits9RepDuellePlant3,
        setFlowers: this.state.setFlowers9RepDuellePlant3,
        pruningNumber: this.state.pruningNumber9RepDuellePlant3,
        plantRow: '432',
        plantName: 'REP - Duelle',
        plantWeek: this.state.weekNumber,
        plantNumber: 3,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 3</Text>/ Row No. 432/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={this.state.DuellePlant3Selected ? 'none' : 'auto'}
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumberRepDuellePlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepDuellePlant3')
                    }
                    value={this.state.setFlowersRepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumberRepDuellePlant3')
                    }
                    value={this.state.pruningNumberRepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameterRepDuellePlant3')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepDuellePlant3')
                    }
                    value={this.state.setFlowers1RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber1RepDuellePlant3}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepDuellePlant3')
                    }
                    value={this.state.setFlowers2RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber2RepDuellePlant3}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepDuellePlant3')
                    }
                    value={this.state.setFlowers3RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber3RepDuellePlant3}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepDuellePlant3')
                    }
                    value={this.state.setFlowers4RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber4RepDuellePlant3}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepDuellePlant3')
                    }
                    value={this.state.setFlowers5RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber5RepDuellePlant3}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepDuellePlant3')
                    }
                    value={this.state.setFlowers6RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber6RepDuellePlant3}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepDuellePlant3')
                    }
                    value={this.state.setFlowers7RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber7RepDuellePlant3}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepDuellePlant3')
                    }
                    value={this.state.setFlowers8RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber8RepDuellePlant3}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'trussNumber9RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepDuellePlant3')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepDuellePlant3')
                    }
                    value={this.state.setFlowers9RepDuellePlant3}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber9RepDuellePlant3}
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepDuellePlant3 <= 22 ||
                      this.state.fruitLoadRepDuellePlant3 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepDuellePlant3 <= 0 ||
                      this.state.floweringTrussssRepDuellePlant3 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepDuellePlant3}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepDuellePlant3 <= 1 ||
                      this.state.settingTrussNumberRepDuellePlant3 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepDuellePlant3}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <CheckBox
                  ...
                  uncheckedColor="red"
                  checkedColor="green"
                  title="Duelle Plant 3 completed"
                  checked={this.state.DuellePlant3Selected}

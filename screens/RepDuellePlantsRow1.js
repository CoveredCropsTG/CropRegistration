...
export default class RepDuellePlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.duelleEventPlant1 = EventRegister.addEventListener(
      'duelleEventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.duelleEventPlant2 = EventRegister.addEventListener(
      'duelleEventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.duelleEventPlant3 = EventRegister.addEventListener(
      'duelleEventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.duelleEventPlant4 = EventRegister.addEventListener(
      'duelleEventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.duelleEventPlant5 = EventRegister.addEventListener(
      'duelleEventPlant5',
      data5 => {
    ...
    //PLANT 6
    this.duelleEventPlant6 = EventRegister.addEventListener(
      'duelleEventPlant6',
      data6 => {
    ...
    //PLANT 7
    this.duelleEventPlant7 = EventRegister.addEventListener(
      'duelleEventPlant7',
      data7 => {
    ...
    //PLANT 8
    this.duelleEventPlant8 = EventRegister.addEventListener(
      'duelleEventPlant8',
      data8 => {
    ...
    //PLANT 9
    this.duelleEventPlant9 = EventRegister.addEventListener(
      'duelleEventPlant9',
      data9 => {
    ...
    //PLANT 10
    this.duelleEventPlant10 = EventRegister.addEventListener(
      'duelleEventPlant10',
      data10 => {

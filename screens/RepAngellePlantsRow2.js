...
export default class RepAngellePlantsRow2 extends Component {
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.angelleRow2EventPlant1 = EventRegister.addEventListener(
      'angelleRow2EventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.angelleRow2EventPlant2 = EventRegister.addEventListener(
      'angelleRow2EventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.angelleRow2EventPlant3 = EventRegister.addEventListener(
      'angelleRow2EventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.angelleRow2EventPlant4 = EventRegister.addEventListener(
      'angelleRow2EventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.angelleRow2EventPlant5 = EventRegister.addEventListener(
      'angelleRow2EventPlant5',
      data5 => {
    ...
    //PLANT 6
    this.angelleRow2EventPlant6 = EventRegister.addEventListener(
      'angelleRow2EventPlant6',
      data6 => {
    ...
    //PLANT 7
    this.angelleRow2EventPlant7 = EventRegister.addEventListener(
      'angelleRow2EventPlant7',
      data7 => {
    ...
    //PLANT 8
    this.angelleRow2EventPlant8 = EventRegister.addEventListener(
      'angelleRow2EventPlant8',
      data8 => {
    ...
    //PLANT 9
    this.angelleRow2EventPlant9 = EventRegister.addEventListener(
      'angelleRow2EventPlant9',
      data9 => {
    ...
    //PLANT 10
    this.angelleRow2EventPlant10 = EventRegister.addEventListener(
      'angelleRow2EventPlant10',
      data10 => {
    ...
    if (plant10Selected == null || plant10Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant10')
          }
        >
          <Text style={styles.buttonText}>

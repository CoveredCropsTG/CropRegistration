...
export default class RepMerliceRow1Plant1 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepMerliceRow1Plant1 =
      this.onSubmitleavesPerPlantRepMerliceRow1Plant1.bind(this);
    ...
    this.leavesPerPlantRepMerliceRow1Plant1Ref = this.updateRef.bind(
      this,
    ...
    this.state = {
      ...
      MerliceRow1Plant1Selected: false,
      checkboxStatus: '',
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepMerliceRow1Plant1')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepMerliceRow1Plant1: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepMerliceRow1Plant1')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepMerliceRow1Plant1: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepMerliceRow1Plant1')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepMerliceRow1Plant1: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepMerliceRow1Plant1')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepMerliceRow1Plant1: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepMerliceRow1Plant1')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepMerliceRow1Plant1: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepMerliceRow1Plant1')
        .then(text6Value => {
          this.setState({
            leafLengthRepMerliceRow1Plant1: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepMerliceRow1Plant1')
        .then(text7Value => {
          this.setState({
            leafWidthRepMerliceRow1Plant1: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterRepMerliceRow1Plant1')
        .then(text8Value => {
          this.setState({
            stmDiameterRepMerliceRow1Plant1: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepMerliceRow1Plant1')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepMerliceRow1Plant1: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('MerliceRow1Plant1Selected')
        .then(text99Value => {
          this.setState({ MerliceRow1Plant1Selected: JSON.parse(text99Value) });

          console.log(this.state.MerliceRow1Plant1Selected);
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('trussNumberRepMerliceRow1Plant1')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepMerliceRow1Plant1: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 1,
            });
            this.setState({
              trussNumber2RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 2,
            });
            this.setState({
              trussNumber3RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 3,
            });
            this.setState({
              trussNumber4RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 4,
            });
            this.setState({
              trussNumber5RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 5,
            });
            this.setState({
              trussNumber6RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 6,
            });
            this.setState({
              trussNumber7RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 7,
            });
            this.setState({
              trussNumber8RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 8,
            });
            this.setState({
              trussNumber9RepMerliceRow1Plant1:
                parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepMerliceRow1Plant1')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepMerliceRow1Plant1: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepMerliceRow1Plant1')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepMerliceRow1Plant1: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepMerliceRow1Plant1')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepMerliceRow1Plant1: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepMerliceRow1Plant1')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepMerliceRow1Plant1: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepMerliceRow1Plant1')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepMerliceRow1Plant1: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepMerliceRow1Plant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepMerliceRow1Plant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepMerliceRow1Plant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepMerliceRow1Plant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepMerliceRow1Plant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepMerliceRow1Plant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepMerliceRow1Plant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepMerliceRow1Plant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepMerliceRow1Plant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepMerliceRow1Plant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepMerliceRow1Plant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepMerliceRow1Plant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepMerliceRow1Plant1')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepMerliceRow1Plant1: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepMerliceRow1Plant1')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepMerliceRow1Plant1: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepMerliceRow1Plant1')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepMerliceRow1Plant1: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepMerliceRow1Plant1')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepMerliceRow1Plant1: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepMerliceRow1Plant1')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepMerliceRow1Plant1: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepMerliceRow1Plant1')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepMerliceRow1Plant1: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepMerliceRow1Plant1')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepMerliceRow1Plant1: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepMerliceRow1Plant1')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepMerliceRow1Plant1: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepMerliceRow1Plant1')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepMerliceRow1Plant1: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepMerliceRow1Plant1')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepMerliceRow1Plant1: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepMerliceRow1Plant1')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepMerliceRow1Plant1: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepMerliceRow1Plant1')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepMerliceRow1Plant1: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepMerliceRow1Plant1')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepMerliceRow1Plant1: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepMerliceRow1Plant1')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepMerliceRow1Plant1: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepMerliceRow1Plant1')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepMerliceRow1Plant1: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepMerliceRow1Plant1')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepMerliceRow1Plant1: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepMerliceRow1Plant1')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepMerliceRow1Plant1: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepMerliceRow1Plant1')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepMerliceRow1Plant1: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepMerliceRow1Plant1')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepMerliceRow1Plant1: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepMerliceRow1Plant1')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepMerliceRow1Plant1: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepMerliceRow1Plant1')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepMerliceRow1Plant1: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepMerliceRow1Plant1')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepMerliceRow1Plant1: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepMerliceRow1Plant1')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepMerliceRow1Plant1: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepMerliceRow1Plant1')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepMerliceRow1Plant1: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepMerliceRow1Plant1')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepMerliceRow1Plant1: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepMerliceRow1Plant1')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepMerliceRow1Plant1: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepMerliceRow1Plant1')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepMerliceRow1Plant1: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepMerliceRow1Plant1')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepMerliceRow1Plant1: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepMerliceRow1Plant1')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepMerliceRow1Plant1: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepMerliceRow1Plant1')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepMerliceRow1Plant1: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepMerliceRow1Plant1')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepMerliceRow1Plant1: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepMerliceRow1Plant1')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepMerliceRow1Plant1: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepMerliceRow1Plant1')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepMerliceRow1Plant1: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepMerliceRow1Plant1)
        ? parseInt(this.state.setFruitsRepMerliceRow1Plant1)
        : 0) +
      (parseInt(this.state.setFruits1RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits1RepMerliceRow1Plant1)
        : 0) +
      ...
      (parseInt(this.state.setFruits3RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits3RepMerliceRow1Plant1)
        : 0) +
      (parseInt(this.state.setFruits4RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits4RepMerliceRow1Plant1)
        : 0) +
      (parseInt(this.state.setFruits5RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits5RepMerliceRow1Plant1)
        : 0) +
      (parseInt(this.state.setFruits6RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits6RepMerliceRow1Plant1)
        : 0) +
      (parseInt(this.state.setFruits7RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits7RepMerliceRow1Plant1)
        : 0) +
      (parseInt(this.state.setFruits8RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits8RepMerliceRow1Plant1)
        : 0) +
      (parseInt(this.state.setFruits9RepMerliceRow1Plant1)
        ? parseInt(this.state.setFruits9RepMerliceRow1Plant1)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepMerliceRow1Plant1',
      this.state.fruitLoadRepMerliceRow1Plant1,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepMerliceRow1Plant1 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepMerliceRow1Plant1
            ? this.state.setFruitsRepMerliceRow1Plant1
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepMerliceRow1Plant1
            ? this.state.pruningNumberRepMerliceRow1Plant1
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepMerliceRow1Plant1)
          ? parseInt(this.state.trussNumberRepMerliceRow1Plant1)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepMerliceRow1Plant1: add,
        pruningHarRepMerliceRow1Plant1: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepMerliceRow1Plant1);
    ...
    this.setItem(
      'harvestTrussRepMerliceRow1Plant1',
      this.state.harvestTrussRepMerliceRow1Plant1,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepMerliceRow1Plant1,
    );
      ...
      if (this.state.setFruits8RepMerliceRow1Plant1 === '') {
        if (this.state.setFruits7RepMerliceRow1Plant1 === '') {
          if (this.state.setFruits6RepMerliceRow1Plant1 === '') {
            if (this.state.setFruits5RepMerliceRow1Plant1 === '') {
              if (this.state.setFruits4RepMerliceRow1Plant1 === '') {
                if (this.state.setFruits3RepMerliceRow1Plant1 === '') {
                  if (this.state.setFruits2RepMerliceRow1Plant1 === '') {
                    if (this.state.setFruits1RepMerliceRow1Plant1 === '') {
                      if (this.state.setFruitsRepMerliceRow1Plant1 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepMerliceRow1Plant1,
                        );
                        ...
                        this.setState({
                          ...
                          prunSettingRepMerliceRow1Plant1: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepMerliceRow1Plant1,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepMerliceRow1Plant1,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepMerliceRow1Plant1,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepMerliceRow1Plant1,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepMerliceRow1Plant1,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepMerliceRow1Plant1,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepMerliceRow1Plant1,
                );
                trussNum = parseInt(number4);
                settingFruit = parseInt(
                  this.state.setFruits4RepMerliceRow1Plant1,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = parseInt(
                this.state.pruningNumber5RepMerliceRow1Plant1,
              );
              trussNum = parseInt(number5);
              settingFruit = parseInt(
                this.state.setFruits5RepMerliceRow1Plant1,
              );
            ...
            pruningSet = parseInt(
              this.state.pruningNumber6RepMerliceRow1Plant1,
            );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepMerliceRow1Plant1,
    );
    ...
    if (this.state.setFlowers9RepMerliceRow1Plant1 === '') {
      if (this.state.setFlowers8RepMerliceRow1Plant1 === '') {
        if (this.state.setFlowers7RepMerliceRow1Plant1 === '') {
          if (this.state.setFlowers6RepMerliceRow1Plant1 === '') {
            if (this.state.setFlowers5RepMerliceRow1Plant1 === '') {
              if (this.state.setFlowers4RepMerliceRow1Plant1 === '') {
                if (this.state.setFlowers3RepMerliceRow1Plant1 === '') {
                  if (this.state.setFlowers2RepMerliceRow1Plant1 === '') {
                    if (this.state.setFlowers1RepMerliceRow1Plant1 === '') {
                      if (this.state.setFlowersRepMerliceRow1Plant1 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepMerliceRow1Plant1,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberRepMerliceRow1Plant1 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepMerliceRow1Plant1,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepMerliceRow1Plant1,
                      );
                      ...
                      this.setState({
                        floweringTrussssRepMerliceRow1Plant1: floweringTruss,
                        pruneFloweringRepMerliceRow1Plant1: flowerPruningNumner,
                      });
                      this.setItem(
                        'floweringTrussssRepMerliceRow1Plant1',
                        floweringTruss,
                    ...
                    var number21 =
                      +this.state.trussNumberRepMerliceRow1Plant1 + 2;

                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepMerliceRow1Plant1,
                    );
                    flowering = parseInt(
                      this.state.setFlowers2RepMerliceRow1Plant1,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepMerliceRow1Plant1,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberRepMerliceRow1Plant1 + 3;

                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepMerliceRow1Plant1,
                  );
                  flowering = parseInt(
                    this.state.setFlowers3RepMerliceRow1Plant1,
                  );
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepMerliceRow1Plant1,
                  );
                ...
                flowering = parseInt(
                  this.state.setFlowers4RepMerliceRow1Plant1,
                );
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepMerliceRow1Plant1,
                );
            ...
            flowerSetFruits = parseInt(
              this.state.setFruits6RepMerliceRow1Plant1,
            );
            summ =
              (flowering ? flowering : 0) +
              (flowerSetFruits ? flowerSetFruits : 0);
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepMerliceRow1Plant1,
          );
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepMerliceRow1Plant1,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepMerliceRow1Plant1,
      );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepMerliceRow1Plant1 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepMerliceRow1Plant1: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 1 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepMerliceRow1Plant1: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 2 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepMerliceRow1Plant1: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 3 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepMerliceRow1Plant1: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 4 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepMerliceRow1Plant1: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 5 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepMerliceRow1Plant1: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 6 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepMerliceRow1Plant1: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 7 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepMerliceRow1Plant1: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 8 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepMerliceRow1Plant1: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 9 != null) {
        //Change week number
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepMerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepMerliceRow1Plant1: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      MerliceRow1Plant1Selected: !this.state.MerliceRow1Plant1Selected,
    });

    const vart = this.state.MerliceRow1Plant1Selected;

    const vart2 = false;

    if (vart == null) {
      this.setItem('MerliceRow1Plant1Selected', vart2);

      EventRegister.emit('merliceRow1EventPlant1', vart2);
    } else {
      this.setItem('MerliceRow1Plant1Selected', vart);

      EventRegister.emit('merliceRow1EventPlant1', vart);
    }
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 1,
        leavesPerPlant: this.state.leavesPerPlantRepMerliceRow1Plant1,
        fullySetTruss: this.state.fullySetTrussRepMerliceRow1Plant1,
        setTrussLength: this.state.setTrussLengthRepMerliceRow1Plant1,
        weeklyGrowth: this.state.weeklyGrowthRepMerliceRow1Plant1,
        floweringTrussHeight:
          this.state.floweringTrussHeightRepMerliceRow1Plant1,
        leafLength: this.state.leafLengthRepMerliceRow1Plant1,
        leafWidth: this.state.leafWidthRepMerliceRow1Plant1,
        stmDiameter: this.state.stmDiameterRepMerliceRow1Plant1,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterRepMerliceRow1Plant1,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepMerliceRow1Plant1 !== null &&
      this.state.pruningNumberRepMerliceRow1Plant1 !== null
    ) {
      let data = {
        trussNumber: this.state.trussNumberRepMerliceRow1Plant1,
        fruitDiameter: this.state.fruitDiameterRepMerliceRow1Plant1,
        setFruits: this.state.setFruitsRepMerliceRow1Plant1,
        setFlowers: this.state.setFlowersRepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumberRepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
        fruitLoad: this.state.fruitLoadRepMerliceRow1Plant1,
        pruningFlower: this.state.pruneFloweringRepMerliceRow1Plant1,
        floweringTruss: this.state.floweringTrussssRepMerliceRow1Plant1,
        pruningSet: this.state.prunSettingRepMerliceRow1Plant1,
        settingTruss: this.state.settingTrussNumberRepMerliceRow1Plant1,
        pruningHarvest: this.state.pruningHarRepMerliceRow1Plant1,
        harvestTruss: this.state.harvestTrussRepMerliceRow1Plant1,
      };
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 1 !== null &&
            this.state.pruningNumber1RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 1 != null &&
      this.state.pruningNumber1RepMerliceRow1Plant1 !== null
    ) {
      let data1 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 1,
        fruitDiameter: this.state.fruitDiameter1RepMerliceRow1Plant1,
        setFruits: this.state.setFruits1RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers1RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber1RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 2 !== null &&
            this.state.pruningNumber2RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 2 != null &&
      this.state.pruningNumber2RepMerliceRow1Plant1 !== null
    ) {
      let data2 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 2,
        fruitDiameter: this.state.fruitDiameter2RepMerliceRow1Plant1,
        setFruits: this.state.setFruits2RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers2RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber2RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 3 !== null &&
            this.state.pruningNumber3RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 3 !== null &&
      this.state.pruningNumber3RepMerliceRow1Plant1 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 3,
        fruitDiameter: this.state.fruitDiameter3RepMerliceRow1Plant1,
        setFruits: this.state.setFruits3RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers3RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber3RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 4 !== null &&
            this.state.pruningNumber4RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 4 != null &&
      this.state.pruningNumber4RepMerliceRow1Plant1 !== null
    ) {
      let data4 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 4,
        fruitDiameter: this.state.fruitDiameter4RepMerliceRow1Plant1,
        setFruits: this.state.setFruits4RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers4RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber4RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 5 !== null &&
            this.state.pruningNumber5RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 5 != null &&
      this.state.pruningNumber5RepMerliceRow1Plant1 !== null
    ) {
      let data5 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 5,
        fruitDiameter: this.state.fruitDiameter5RepMerliceRow1Plant1,
        setFruits: this.state.setFruits5RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers5RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber5RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 6 !== null &&
            this.state.pruningNumber6RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 6 != null &&
      this.state.pruningNumber6RepMerliceRow1Plant1 !== null
    ) {
      let data6 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 6,
        fruitDiameter: this.state.fruitDiameter6RepMerliceRow1Plant1,
        setFruits: this.state.setFruits6RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers6RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber6RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 7 !== null &&
            this.state.pruningNumber7RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 7 != null &&
      this.state.pruningNumber7RepMerliceRow1Plant1 !== null
    ) {
      let data7 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 7,
        fruitDiameter: this.state.fruitDiameter7RepMerliceRow1Plant1,
        setFruits: this.state.setFruits7RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers7RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber7RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 8 !== null &&
            this.state.pruningNumber8RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 8 != null &&
      this.state.pruningNumber8RepMerliceRow1Plant1 !== null
    ) {
      let data8 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 8,
        fruitDiameter: this.state.fruitDiameter8RepMerliceRow1Plant1,
        setFruits: this.state.setFruits8RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers8RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber8RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 9 !== null &&
            this.state.pruningNumber9RepMerliceRow1Plant1 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 9 != null &&
      this.state.pruningNumber9RepMerliceRow1Plant1 !== null
    ) {
      let data9 = {
        trussNumber: parseInt(this.state.trussNumberRepMerliceRow1Plant1) + 9,
        fruitDiameter: this.state.fruitDiameter9RepMerliceRow1Plant1,
        setFruits: this.state.setFruits9RepMerliceRow1Plant1,
        setFlowers: this.state.setFlowers9RepMerliceRow1Plant1,
        pruningNumber: this.state.pruningNumber9RepMerliceRow1Plant1,
        plantRow: '123',
        plantName: 'REP - Merlice',
        plantWeek: this.state.weekNumber,
        plantNumber: 1,
      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.MerliceRow1Plant1Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterRepMerliceRow1Plant1
                        }
                        ref={input => {
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowersRepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumberRepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers1RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber1RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers2RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber2RepMerliceRow1Plant1}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers3RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber3RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers4RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber4RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers5RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber5RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers6RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber6RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers7RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber7RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers8RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber8RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.setFlowers9RepMerliceRow1Plant1}
                  />
                  ...
                  <TextInput
                    ...
                    value={this.state.pruningNumber9RepMerliceRow1Plant1}
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepMerliceRow1Plant1 <= 22 ||
                      this.state.fruitLoadRepMerliceRow1Plant1 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepMerliceRow1Plant1 <= 0 ||
                      this.state.floweringTrussssRepMerliceRow1Plant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepMerliceRow1Plant1}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepMerliceRow1Plant1 <= 1 ||
                      this.state.settingTrussNumberRepMerliceRow1Plant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepMerliceRow1Plant1}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <CheckBox
                  ...
                  checked={this.state.MerliceRow1Plant1Selected}

...
export default class RepKMPlant6 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepKMPlant6 =
      this.onSubmitleavesPerPlantRepKMPlant6.bind(this);
    ...
    this.leavesPerPlantRepKMPlant6Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepKMPlant6')
        .then(text1Value => {
    ...
    try {
      AsyncStorage.getItem('fullySetTrussRepKMPlant6')
        .then(text2Value => {
    ...
    try {
      AsyncStorage.getItem('setTrussLengthRepKMPlant6')
        .then(text3Value => {
    ...
    try {
      AsyncStorage.getItem('weeklyGrowthRepKMPlant6')
        .then(text4Value => {
    ...
    try {
      AsyncStorage.getItem('floweringTrussHeightRepKMPlant6')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepKMPlant6: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepKMPlant6')
        .then(text6Value => {
    ...
    try {
      AsyncStorage.getItem('leafWidthRepKMPlant6')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepKMPlant6')
        .then(text8Value => {
    ...
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepKMPlant6')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepKMPlant6: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('KMPlant6Selected')
        .then(text99Value => {
          this.setState({ KMPlant6Selected: JSON.parse(text99Value) });

          console.log(this.state.KMPlant6Selected);
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('trussNumberRepKMPlant6')
        .then(text10Value => {
          if (text10Value !== null) {
            ...
            this.setState({
              trussNumber1RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 1,
            });
            this.setState({
              trussNumber2RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 2,
            });
            this.setState({
              trussNumber3RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 3,
            });
            this.setState({
              trussNumber4RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 4,
            });
            this.setState({
              trussNumber5RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 5,
            });
            this.setState({
              trussNumber6RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 6,
            });
            this.setState({
              trussNumber7RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 7,
            });
            this.setState({
              trussNumber8RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 8,
            });
            this.setState({
              trussNumber9RepKMPlant6:
                parseInt(this.state.trussNumberRepKMPlant6) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepKMPlant6')
        .then(text11Value => {
          if (text11Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowersRepKMPlant6')
        .then(text12Value => {
          if (text12Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepKMPlant6')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepKMPlant6: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepKMPlant6')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepKMPlant6: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepKMPlant6')
        .then(text16Value => {
          if (text16Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepKMPlant6')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepKMPlant6')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepKMPlant6: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepKMPlant6')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepKMPlant6: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepKMPlant6')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepKMPlant6')
        .then(text18Value => {
          if (text18Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepKMPlant6')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepKMPlant6: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepKMPlant6')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepKMPlant6: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepKMPlant6')
        .then(text21Value => {
          if (text21Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepKMPlant6')
        .then(text22Value => {
          if (text22Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepKMPlant6')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepKMPlant6: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepKMPlant6')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepKMPlant6: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepKMPlant6')
        .then(text25Value => {
          if (text25Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepKMPlant6')
        .then(text26Value => {
          if (text26Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepKMPlant6')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepKMPlant6: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepKMPlant6')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepKMPlant6: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepKMPlant6')
        .then(text29Value => {
          if (text29Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepKMPlant6')
        .then(text30Value => {
          if (text30Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepKMPlant6')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepKMPlant6: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepKMPlant6')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepKMPlant6: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepKMPlant6')
        .then(text33Value => {
          if (text33Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepKMPlant6')
        .then(text34Value => {
          if (text34Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepKMPlant6')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepKMPlant6: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepKMPlant6')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepKMPlant6: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepKMPlant6')
        .then(text37Value => {
          if (text37Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepKMPlant6')
        .then(text38Value => {
          if (text38Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepKMPlant6')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepKMPlant6: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepKMPlant6')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepKMPlant6: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepKMPlant6')
        .then(text41Value => {
          if (text41Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepKMPlant6')
        .then(text42Value => {
          if (text42Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepKMPlant6')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepKMPlant6: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepKMPlant6')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepKMPlant6: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepKMPlant6')
        .then(text45Value => {
          if (text45Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepKMPlant6')
        .then(text46Value => {
          if (text46Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepKMPlant6')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepKMPlant6: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepKMPlant6')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepKMPlant6: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepKMPlant6')
        .then(text49Value => {
          if (text49Value !== null) {
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepKMPlant6')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepKMPlant6: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepKMPlant6')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepKMPlant6: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepKMPlant6')
        .then(text52Value => {
          if (text52Value !== null) {
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({
      trussNumber1RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 1,
    });
    this.setState({
      trussNumber2RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 2,
    });
    this.setState({
      trussNumber3RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 3,
    });
    this.setState({
      trussNumber4RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 4,
    });
    this.setState({
      trussNumber5RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 5,
    });
    this.setState({
      trussNumber6RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 6,
    });
    this.setState({
      trussNumber7RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 7,
    });
    this.setState({
      trussNumber8RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 8,
    });
    this.setState({
      trussNumber9RepKMPlant6: parseInt(this.state.trussNumberRepKMPlant6) + 9,
    });
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepKMPlant6)
        ? parseInt(this.state.setFruitsRepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits1RepKMPlant6)
        ? parseInt(this.state.setFruits1RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits2RepKMPlant6)
        ? parseInt(this.state.setFruits2RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits3RepKMPlant6)
        ? parseInt(this.state.setFruits3RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits4RepKMPlant6)
        ? parseInt(this.state.setFruits4RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits5RepKMPlant6)
        ? parseInt(this.state.setFruits5RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits6RepKMPlant6)
        ? parseInt(this.state.setFruits6RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits7RepKMPlant6)
        ? parseInt(this.state.setFruits7RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits8RepKMPlant6)
        ? parseInt(this.state.setFruits8RepKMPlant6)
        : 0) +
      (parseInt(this.state.setFruits9RepKMPlant6)
        ? parseInt(this.state.setFruits9RepKMPlant6)
        : 0);
    this.setState({
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepKMPlant6 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepKMPlant6 ? this.state.setFruitsRepKMPlant6 : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepKMPlant6
            ? this.state.pruningNumberRepKMPlant6
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepKMPlant6)
          ? parseInt(this.state.trussNumberRepKMPlant6)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepKMPlant6: add,
        pruningHarRepKMPlant6: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepKMPlant6);
                    ...
                    if (this.state.setFruits1RepKMPlant6 === '') {
                      if (this.state.setFruitsRepKMPlant6 === '') {
                        ...
                        settingFruit = parseInt(
                          this.state.setFruitsRepKMPlant6,
                        );
                        settingTruss = (
                          trussNum +
                        ...
                        this.setState({
                          ...
                          prunSettingRepKMPlant6: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepKMPlant6,
                      );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepKMPlant6,
    );
        ...
        if (this.state.setFlowers7RepKMPlant6 === '') {
          if (this.state.setFlowers6RepKMPlant6 === '') {
            if (this.state.setFlowers5RepKMPlant6 === '') {
              if (this.state.setFlowers4RepKMPlant6 === '') {
                if (this.state.setFlowers3RepKMPlant6 === '') {
                  if (this.state.setFlowers2RepKMPlant6 === '') {
                    if (this.state.setFlowers1RepKMPlant6 === '') {
                      if (this.state.setFlowersRepKMPlant6 === '') {
                        ...
                        this.setState({
                          ...
                          pruneFloweringRepKMPlant6: flowerPruningNumner,
                        });
                        this.setItem(
                          'floweringTrussssRepKMPlant6',
                          floweringTruss,
                      ...
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepKMPlant6,
                      );
                      trussNum = number11;
                      summ =
                        (flowering ? flowering : 0) +
                    ...
                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepKMPlant6,
                    );
                    flowering = parseInt(this.state.setFlowers2RepKMPlant6);
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepKMPlant6,
                    );
                    summ =
                      (flowering ? flowering : 0) +
                      (flowerSetFruits ? flowerSetFruits : 0);
                  ...
                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepKMPlant6,
                  );
                ...
                flowerPruningNumner = parseInt(
                  this.state.pruningNumber4RepKMPlant6,
                );
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepKMPlant6,
              );
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepKMPlant6,
            );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepKMPlant6 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepKMPlant6: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 1 != null) {
        //Change week number
        const weekRowTruss2 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 1;
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepKMPlant6: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 2 != null) {
        //Change week number
        const weekRowTruss3 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 2;
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepKMPlant6: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 3 != null) {
        //Change week number
        const weekRowTruss4 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 3;
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepKMPlant6: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 4 != null) {
        //Change week number
        const weekRowTruss5 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 4;
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepKMPlant6: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 5 != null) {
        //Change week number
        const weekRowTruss6 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 5;
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepKMPlant6: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 6 != null) {
        //Change week number
        const weekRowTruss7 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 6;
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepKMPlant6: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 7 != null) {
        //Change week number
        const weekRowTruss8 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 7;
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepKMPlant6: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 8 != null) {
        //Change week number
        const weekRowTruss9 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 8;
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepKMPlant6: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepKMPlant6) + 9 != null) {
        //Change week number
        const weekRowTruss10 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant6) + 9;
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepKMPlant6: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepKMPlant6: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepKMPlant6: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({ KMPlant6Selected: !this.state.KMPlant6Selected });

    const vart = this.state.KMPlant6Selected;

    const vart2 = false;

    if (vart == null) {
      this.setItem('KMPlant6Selected', vart2);

      EventRegister.emit('kmEventPlant6', vart2);
    } else {
      this.setItem('KMPlant6Selected', vart);

      EventRegister.emit('kmEventPlant6', vart);
    }
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 6,
        leavesPerPlant: this.state.leavesPerPlantRepKMPlant6,
        fullySetTruss: this.state.fullySetTrussRepKMPlant6,
        setTrussLength: this.state.setTrussLengthRepKMPlant6,
        weeklyGrowth: this.state.weeklyGrowthRepKMPlant6,
        floweringTrussHeight: this.state.floweringTrussHeightRepKMPlant6,
        leafLength: this.state.leafLengthRepKMPlant6,
        leafWidth: this.state.leafWidthRepKMPlant6,
        stmDiameter: this.state.stmDiameterRepKMPlant6,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterRepKMPlant6,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepKMPlant6 !== null &&
      this.state.pruningNumberRepKMPlant6 !== null
    ) {
      let data = {
        trussNumber: this.state.trussNumberRepKMPlant6,
        fruitDiameter: this.state.fruitDiameterRepKMPlant6,
        setFruits: this.state.setFruitsRepKMPlant6,
        setFlowers: this.state.setFlowersRepKMPlant6,
        pruningNumber: this.state.pruningNumberRepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
        fruitLoad: this.state.fruitLoadRepKMPlant6,
        pruningFlower: this.state.pruneFloweringRepKMPlant6,
        floweringTruss: this.state.floweringTrussssRepKMPlant6,
        pruningSet: this.state.prunSettingRepKMPlant6,
        settingTruss: this.state.settingTrussNumberRepKMPlant6,
        pruningHarvest: this.state.pruningHarRepKMPlant6,
        harvestTruss: this.state.harvestTrussRepKMPlant6,
      };
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 1 !== null &&
            this.state.pruningNumber1RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 1 != null &&
      this.state.pruningNumber1RepKMPlant6 !== null
    ) {
      let data1 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 1,
        fruitDiameter: this.state.fruitDiameter1RepKMPlant6,
        setFruits: this.state.setFruits1RepKMPlant6,
        setFlowers: this.state.setFlowers1RepKMPlant6,
        pruningNumber: this.state.pruningNumber1RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 2 !== null &&
            this.state.pruningNumber2RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 2 != null &&
      this.state.pruningNumber2RepKMPlant6 !== null
    ) {
      let data2 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 2,
        fruitDiameter: this.state.fruitDiameter2RepKMPlant6,
        setFruits: this.state.setFruits2RepKMPlant6,
        setFlowers: this.state.setFlowers2RepKMPlant6,
        pruningNumber: this.state.pruningNumber2RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 3 !== null &&
            this.state.pruningNumber3RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 3 !== null &&
      this.state.pruningNumber3RepKMPlant6 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 3,
        fruitDiameter: this.state.fruitDiameter3RepKMPlant6,
        setFruits: this.state.setFruits3RepKMPlant6,
        setFlowers: this.state.setFlowers3RepKMPlant6,
        pruningNumber: this.state.pruningNumber3RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 4 !== null &&
            this.state.pruningNumber4RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 4 != null &&
      this.state.pruningNumber4RepKMPlant6 !== null
    ) {
      let data4 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 4,
        fruitDiameter: this.state.fruitDiameter4RepKMPlant6,
        setFruits: this.state.setFruits4RepKMPlant6,
        setFlowers: this.state.setFlowers4RepKMPlant6,
        pruningNumber: this.state.pruningNumber4RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 5 !== null &&
            this.state.pruningNumber5RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 5 != null &&
      this.state.pruningNumber5RepKMPlant6 !== null
    ) {
      let data5 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 5,
        fruitDiameter: this.state.fruitDiameter5RepKMPlant6,
        setFruits: this.state.setFruits5RepKMPlant6,
        setFlowers: this.state.setFlowers5RepKMPlant6,
        pruningNumber: this.state.pruningNumber5RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 6 !== null &&
            this.state.pruningNumber6RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 6 != null &&
      this.state.pruningNumber6RepKMPlant6 !== null
    ) {
      let data6 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 6,
        fruitDiameter: this.state.fruitDiameter6RepKMPlant6,
        setFruits: this.state.setFruits6RepKMPlant6,
        setFlowers: this.state.setFlowers6RepKMPlant6,
        pruningNumber: this.state.pruningNumber6RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 7 !== null &&
            this.state.pruningNumber7RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
          }
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 7 != null &&
      this.state.pruningNumber7RepKMPlant6 !== null
    ) {
      let data7 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 7,
        fruitDiameter: this.state.fruitDiameter7RepKMPlant6,
        setFruits: this.state.setFruits7RepKMPlant6,
        setFlowers: this.state.setFlowers7RepKMPlant6,
        pruningNumber: this.state.pruningNumber7RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 8 !== null &&
            this.state.pruningNumber8RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
          }
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 8 != null &&
      this.state.pruningNumber8RepKMPlant6 !== null
    ) {
      let data8 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 8,
        fruitDiameter: this.state.fruitDiameter8RepKMPlant6,
        setFruits: this.state.setFruits8RepKMPlant6,
        setFlowers: this.state.setFlowers8RepKMPlant6,
        pruningNumber: this.state.pruningNumber8RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant6) + 9 !== null &&
            this.state.pruningNumber9RepKMPlant6 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
          }
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant6) + 9 != null &&
      this.state.pruningNumber9RepKMPlant6 !== null
    ) {
      let data9 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant6) + 9,
        fruitDiameter: this.state.fruitDiameter9RepKMPlant6,
        setFruits: this.state.setFruits9RepKMPlant6,
        setFlowers: this.state.setFlowers9RepKMPlant6,
        pruningNumber: this.state.pruningNumber9RepKMPlant6,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 6,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 6</Text>/ Row No. 807/ Week No.{' '}
        ...
        >
          ...
          >
            <View pointerEvents={this.state.KMPlant6Selected ? 'none' : 'auto'}>
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumberRepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepKMPlant6')
                    }
                    value={this.state.setFlowersRepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumberRepKMPlant6')
                    }
                    value={this.state.pruningNumberRepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameterRepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber1RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepKMPlant6')
                    }
                    value={this.state.setFlowers1RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber1RepKMPlant6')
                    }
                    value={this.state.pruningNumber1RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter1RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber2RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepKMPlant6')
                    }
                    value={this.state.setFlowers2RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber2RepKMPlant6')
                    }
                    value={this.state.pruningNumber2RepKMPlant6}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter2RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber3RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepKMPlant6')
                    }
                    value={this.state.setFlowers3RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber3RepKMPlant6')
                    }
                    value={this.state.pruningNumber3RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter3RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber4RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepKMPlant6')
                    }
                    value={this.state.setFlowers4RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber4RepKMPlant6')
                    }
                    value={this.state.pruningNumber4RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter4RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber5RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepKMPlant6')
                    }
                    value={this.state.setFlowers5RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber5RepKMPlant6')
                    }
                    value={this.state.pruningNumber5RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter5RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber6RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepKMPlant6')
                    }
                    value={this.state.setFlowers6RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber6RepKMPlant6')
                    }
                    value={this.state.pruningNumber6RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter6RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber7RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepKMPlant6')
                    }
                    value={this.state.setFlowers7RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber7RepKMPlant6')
                    }
                    value={this.state.pruningNumber7RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter7RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber8RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepKMPlant6')
                    }
                    value={this.state.setFlowers8RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber8RepKMPlant6')
                    }
                    value={this.state.pruningNumber8RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter8RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'trussNumber9RepKMPlant6')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepKMPlant6')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepKMPlant6')
                    }
                    value={this.state.setFlowers9RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber9RepKMPlant6')
                    }
                    value={this.state.pruningNumber9RepKMPlant6}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter9RepKMPlant6')
                    }
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepKMPlant6 <= 22 ||
                      this.state.fruitLoadRepKMPlant6 >= 40
                  ...
                  >
                    ...
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.fruitLoadRepKMPlant6}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepKMPlant6 <= 0 ||
                      this.state.floweringTrussssRepKMPlant6 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepKMPlant6}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepKMPlant6 <= 1 ||
                      this.state.settingTrussNumberRepKMPlant6 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepKMPlant6}
                      </Text>
                    </View>
                    <View
                      style={{
                  ...
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.harvestTrussRepKMPlant6}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <CheckBox
                  ...
                  uncheckedColor="red"
                  checkedColor="green"
                  title="KM Plant 6 completed"
                  checked={this.state.KMPlant6Selected}

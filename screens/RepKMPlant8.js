...
export default class RepKMPlant8 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepKMPlant8 =
      this.onSubmitleavesPerPlantRepKMPlant8.bind(this);
    ...
    this.leavesPerPlantRepKMPlant8Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepKMPlant8')
        .then(text1Value => {
    ...
    try {
      AsyncStorage.getItem('fullySetTrussRepKMPlant8')
        .then(text2Value => {
    ...
    try {
      AsyncStorage.getItem('setTrussLengthRepKMPlant8')
        .then(text3Value => {
    ...
    try {
      AsyncStorage.getItem('weeklyGrowthRepKMPlant8')
        .then(text4Value => {
    ...
    try {
      AsyncStorage.getItem('floweringTrussHeightRepKMPlant8')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepKMPlant8: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepKMPlant8')
        .then(text6Value => {
    ...
    try {
      AsyncStorage.getItem('leafWidthRepKMPlant8')
        .then(text7Value => {
    ...
    try {
      AsyncStorage.getItem('stmDiameterRepKMPlant8')
        .then(text8Value => {
    ...
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepKMPlant8')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepKMPlant8: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('KMPlant8Selected')
        .then(text99Value => {
          this.setState({ KMPlant8Selected: JSON.parse(text99Value) });

          console.log(this.state.KMPlant8Selected);
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('trussNumberRepKMPlant8')
        .then(text10Value => {
          if (text10Value !== null) {
            ...
            this.setState({
              trussNumber1RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 1,
            });
            this.setState({
              trussNumber2RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 2,
            });
            this.setState({
              trussNumber3RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 3,
            });
            this.setState({
              trussNumber4RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 4,
            });
            this.setState({
              trussNumber5RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 5,
            });
            this.setState({
              trussNumber6RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 6,
            });
            this.setState({
              trussNumber7RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 7,
            });
            this.setState({
              trussNumber8RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 8,
            });
            this.setState({
              trussNumber9RepKMPlant8:
                parseInt(this.state.trussNumberRepKMPlant8) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepKMPlant8')
        .then(text11Value => {
          if (text11Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowersRepKMPlant8')
        .then(text12Value => {
          if (text12Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepKMPlant8')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepKMPlant8: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepKMPlant8')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepKMPlant8: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepKMPlant8')
        .then(text16Value => {
          if (text16Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepKMPlant8')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepKMPlant8')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepKMPlant8: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepKMPlant8')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepKMPlant8: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepKMPlant8')
        .then(text17Value => {
          if (text17Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepKMPlant8')
        .then(text18Value => {
          if (text18Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepKMPlant8')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepKMPlant8: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepKMPlant8')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepKMPlant8: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepKMPlant8')
        .then(text21Value => {
          if (text21Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepKMPlant8')
        .then(text22Value => {
          if (text22Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepKMPlant8')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepKMPlant8: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepKMPlant8')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepKMPlant8: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepKMPlant8')
        .then(text25Value => {
          if (text25Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepKMPlant8')
        .then(text26Value => {
          if (text26Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepKMPlant8')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepKMPlant8: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepKMPlant8')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepKMPlant8: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepKMPlant8')
        .then(text29Value => {
          if (text29Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepKMPlant8')
        .then(text30Value => {
          if (text30Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepKMPlant8')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepKMPlant8: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepKMPlant8')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepKMPlant8: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepKMPlant8')
        .then(text33Value => {
          if (text33Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepKMPlant8')
        .then(text34Value => {
          if (text34Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepKMPlant8')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepKMPlant8: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepKMPlant8')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepKMPlant8: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepKMPlant8')
        .then(text37Value => {
          if (text37Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepKMPlant8')
        .then(text38Value => {
          if (text38Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepKMPlant8')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepKMPlant8: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepKMPlant8')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepKMPlant8: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepKMPlant8')
        .then(text41Value => {
          if (text41Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepKMPlant8')
        .then(text42Value => {
          if (text42Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepKMPlant8')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepKMPlant8: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepKMPlant8')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepKMPlant8: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepKMPlant8')
        .then(text45Value => {
          if (text45Value !== null) {
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepKMPlant8')
        .then(text46Value => {
          if (text46Value !== null) {
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepKMPlant8')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepKMPlant8: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepKMPlant8')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepKMPlant8: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepKMPlant8')
        .then(text49Value => {
          if (text49Value !== null) {
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepKMPlant8')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepKMPlant8: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepKMPlant8')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepKMPlant8: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepKMPlant8')
        .then(text52Value => {
          if (text52Value !== null) {
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({
      trussNumber1RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 1,
    });
    this.setState({
      trussNumber2RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 2,
    });
    this.setState({
      trussNumber3RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 3,
    });
    this.setState({
      trussNumber4RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 4,
    });
    this.setState({
      trussNumber5RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 5,
    });
    this.setState({
      trussNumber6RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 6,
    });
    this.setState({
      trussNumber7RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 7,
    });
    this.setState({
      trussNumber8RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 8,
    });
    this.setState({
      trussNumber9RepKMPlant8: parseInt(this.state.trussNumberRepKMPlant8) + 9,
    });
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepKMPlant8)
        ? parseInt(this.state.setFruitsRepKMPlant8)
        : 0) +
      (parseInt(this.state.setFruits1RepKMPlant8)
        ? parseInt(this.state.setFruits1RepKMPlant8)
        : 0) +
      ...
      (parseInt(this.state.setFruits3RepKMPlant8)
        ? parseInt(this.state.setFruits3RepKMPlant8)
        : 0) +
      (parseInt(this.state.setFruits4RepKMPlant8)
        ? parseInt(this.state.setFruits4RepKMPlant8)
        : 0) +
      (parseInt(this.state.setFruits5RepKMPlant8)
        ? parseInt(this.state.setFruits5RepKMPlant8)
        : 0) +
      (parseInt(this.state.setFruits6RepKMPlant8)
        ? parseInt(this.state.setFruits6RepKMPlant8)
        : 0) +
      (parseInt(this.state.setFruits7RepKMPlant8)
        ? parseInt(this.state.setFruits7RepKMPlant8)
        : 0) +
      (parseInt(this.state.setFruits8RepKMPlant8)
        ? parseInt(this.state.setFruits8RepKMPlant8)
        : 0) +
      (parseInt(this.state.setFruits9RepKMPlant8)
        ? parseInt(this.state.setFruits9RepKMPlant8)
        : 0);
    this.setState({
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepKMPlant8 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepKMPlant8 ? this.state.setFruitsRepKMPlant8 : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepKMPlant8
            ? this.state.pruningNumberRepKMPlant8
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepKMPlant8)
          ? parseInt(this.state.trussNumberRepKMPlant8)
          : 0) + sub
      ).toFixed(2);
      this.setState({
        harvestTrussRepKMPlant8: add,
        pruningHarRepKMPlant8: prunNum,
      });
    } else {
      prunNum = parseInt(this.state.pruningNumberRepKMPlant8);
                    ...
                    if (this.state.setFruits1RepKMPlant8 === '') {
                      if (this.state.setFruitsRepKMPlant8 === '') {
                        ...
                        settingFruit = parseInt(
                          this.state.setFruitsRepKMPlant8,
                        );
                        settingTruss = (
                          trussNum +
                        ...
                        this.setState({
                          ...
                          prunSettingRepKMPlant8: pruningSet,
                        });
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepKMPlant8,
                      );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepKMPlant8,
    );
        ...
        if (this.state.setFlowers7RepKMPlant8 === '') {
          if (this.state.setFlowers6RepKMPlant8 === '') {
            if (this.state.setFlowers5RepKMPlant8 === '') {
              if (this.state.setFlowers4RepKMPlant8 === '') {
                if (this.state.setFlowers3RepKMPlant8 === '') {
                  if (this.state.setFlowers2RepKMPlant8 === '') {
                    if (this.state.setFlowers1RepKMPlant8 === '') {
                      if (this.state.setFlowersRepKMPlant8 === '') {
                        ...
                        this.setState({
                          ...
                          pruneFloweringRepKMPlant8: flowerPruningNumner,
                        });
                        this.setItem(
                          'floweringTrussssRepKMPlant8',
                          floweringTruss,
                      ...
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepKMPlant8,
                      );
                      trussNum = number11;
                      summ =
                        (flowering ? flowering : 0) +
                    ...
                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepKMPlant8,
                    );
                    flowering = parseInt(this.state.setFlowers2RepKMPlant8);
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepKMPlant8,
                    );
                    summ =
                      (flowering ? flowering : 0) +
                      (flowerSetFruits ? flowerSetFruits : 0);
                  ...
                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepKMPlant8,
                  );
                ...
                flowerPruningNumner = parseInt(
                  this.state.pruningNumber4RepKMPlant8,
                );
              ...
              flowerPruningNumner = parseInt(
                this.state.pruningNumber5RepKMPlant8,
              );
            ...
            flowerPruningNumner = parseInt(
              this.state.pruningNumber6RepKMPlant8,
            );
  ...
  getTrussData = () => {
    if (this.state.allTrussData.length != 0) {
      //1st Truss
      if (this.state.trussNumberRepKMPlant8 != null) {
        //Change week number
        const weekRowTruss1 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8);
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepKMPlant8: JSON.stringify(
      ...
      //2nd Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 1 != null) {
        //Change week number
        const weekRowTruss2 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 1;
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepKMPlant8: JSON.stringify(
      ...
      //3rd Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 2 != null) {
        //Change week number
        const weekRowTruss3 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 2;
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepKMPlant8: JSON.stringify(
      ...
      //4th Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 3 != null) {
        //Change week number
        const weekRowTruss4 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 3;
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepKMPlant8: JSON.stringify(
      ...
      //5th Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 4 != null) {
        //Change week number
        const weekRowTruss5 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 4;
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepKMPlant8: JSON.stringify(
      ...
      //6th Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 5 != null) {
        //Change week number
        const weekRowTruss6 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 5;
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepKMPlant8: JSON.stringify(
      ...
      //7th Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 6 != null) {
        //Change week number
        const weekRowTruss7 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 6;
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepKMPlant8: JSON.stringify(
      ...
      //8th Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 7 != null) {
        //Change week number
        const weekRowTruss8 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 7;
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepKMPlant8: JSON.stringify(
      ...
      //9th Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 8 != null) {
        //Change week number
        const weekRowTruss9 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 8;
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepKMPlant8: JSON.stringify(
      ...
      //10th Truss
      if (parseInt(this.state.trussNumberRepKMPlant8) + 9 != null) {
        //Change week number
        const weekRowTruss10 = d =>
          d.trussNumber === parseInt(this.state.trussNumberRepKMPlant8) + 9;
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepKMPlant8: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepKMPlant8: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepKMPlant8: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({ KMPlant8Selected: !this.state.KMPlant8Selected });

    const vart = this.state.KMPlant8Selected;

    const vart2 = false;

    if (vart == null) {
      this.setItem('KMPlant8Selected', vart2);

      EventRegister.emit('kmEventPlant8', vart2);
    } else {
      this.setItem('KMPlant8Selected', vart);

      EventRegister.emit('kmEventPlant8', vart);
    }
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 8,
        leavesPerPlant: this.state.leavesPerPlantRepKMPlant8,
        fullySetTruss: this.state.fullySetTrussRepKMPlant8,
        setTrussLength: this.state.setTrussLengthRepKMPlant8,
        weeklyGrowth: this.state.weeklyGrowthRepKMPlant8,
        floweringTrussHeight: this.state.floweringTrussHeightRepKMPlant8,
        leafLength: this.state.leafLengthRepKMPlant8,
        leafWidth: this.state.leafWidthRepKMPlant8,
        stmDiameter: this.state.stmDiameterRepKMPlant8,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterRepKMPlant8,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepKMPlant8 !== null &&
      this.state.pruningNumberRepKMPlant8 !== null
    ) {
      let data = {
        trussNumber: this.state.trussNumberRepKMPlant8,
        fruitDiameter: this.state.fruitDiameterRepKMPlant8,
        setFruits: this.state.setFruitsRepKMPlant8,
        setFlowers: this.state.setFlowersRepKMPlant8,
        pruningNumber: this.state.pruningNumberRepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
        fruitLoad: this.state.fruitLoadRepKMPlant8,
        pruningFlower: this.state.pruneFloweringRepKMPlant8,
        floweringTruss: this.state.floweringTrussssRepKMPlant8,
        pruningSet: this.state.prunSettingRepKMPlant8,
        settingTruss: this.state.settingTrussNumberRepKMPlant8,
        pruningHarvest: this.state.pruningHarRepKMPlant8,
        harvestTruss: this.state.harvestTrussRepKMPlant8,
      };
      ...
      db.addTrussDetails(data)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 1 !== null &&
            this.state.pruningNumber1RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB1();
          } else {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 1 != null &&
      this.state.pruningNumber1RepKMPlant8 !== null
    ) {
      let data1 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 1,
        fruitDiameter: this.state.fruitDiameter1RepKMPlant8,
        setFruits: this.state.setFruits1RepKMPlant8,
        setFlowers: this.state.setFlowers1RepKMPlant8,
        pruningNumber: this.state.pruningNumber1RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data1)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 2 !== null &&
            this.state.pruningNumber2RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB2();
          } else {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 2 != null &&
      this.state.pruningNumber2RepKMPlant8 !== null
    ) {
      let data2 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 2,
        fruitDiameter: this.state.fruitDiameter2RepKMPlant8,
        setFruits: this.state.setFruits2RepKMPlant8,
        setFlowers: this.state.setFlowers2RepKMPlant8,
        pruningNumber: this.state.pruningNumber2RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data2)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 3 !== null &&
            this.state.pruningNumber3RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB3();
          } else {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 3 !== null &&
      this.state.pruningNumber3RepKMPlant8 !== null
    ) {
      let data3 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 3,
        fruitDiameter: this.state.fruitDiameter3RepKMPlant8,
        setFruits: this.state.setFruits3RepKMPlant8,
        setFlowers: this.state.setFlowers3RepKMPlant8,
        pruningNumber: this.state.pruningNumber3RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data3)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 4 !== null &&
            this.state.pruningNumber4RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB4();
          } else {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 4 != null &&
      this.state.pruningNumber4RepKMPlant8 !== null
    ) {
      let data4 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 4,
        fruitDiameter: this.state.fruitDiameter4RepKMPlant8,
        setFruits: this.state.setFruits4RepKMPlant8,
        setFlowers: this.state.setFlowers4RepKMPlant8,
        pruningNumber: this.state.pruningNumber4RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data4)
        .then(result => {
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 5 !== null &&
            this.state.pruningNumber5RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB5();
          } else {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 5 != null &&
      this.state.pruningNumber5RepKMPlant8 !== null
    ) {
      let data5 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 5,
        fruitDiameter: this.state.fruitDiameter5RepKMPlant8,
        setFruits: this.state.setFruits5RepKMPlant8,
        setFlowers: this.state.setFlowers5RepKMPlant8,
        pruningNumber: this.state.pruningNumber5RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data5)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 6 !== null &&
            this.state.pruningNumber6RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB6();
          } else {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 6 != null &&
      this.state.pruningNumber6RepKMPlant8 !== null
    ) {
      let data6 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 6,
        fruitDiameter: this.state.fruitDiameter6RepKMPlant8,
        setFruits: this.state.setFruits6RepKMPlant8,
        setFlowers: this.state.setFlowers6RepKMPlant8,
        pruningNumber: this.state.pruningNumber6RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data6)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 7 !== null &&
            this.state.pruningNumber7RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB7();
          } else {
          }
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 7 != null &&
      this.state.pruningNumber7RepKMPlant8 !== null
    ) {
      let data7 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 7,
        fruitDiameter: this.state.fruitDiameter7RepKMPlant8,
        setFruits: this.state.setFruits7RepKMPlant8,
        setFlowers: this.state.setFlowers7RepKMPlant8,
        pruningNumber: this.state.pruningNumber7RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data7)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 8 !== null &&
            this.state.pruningNumber8RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB8();
          } else {
          }
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 8 != null &&
      this.state.pruningNumber8RepKMPlant8 !== null
    ) {
      let data8 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 8,
        fruitDiameter: this.state.fruitDiameter8RepKMPlant8,
        setFruits: this.state.setFruits8RepKMPlant8,
        setFlowers: this.state.setFlowers8RepKMPlant8,
        pruningNumber: this.state.pruningNumber8RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
      ...
      db.addTrussDetails(data8)
        .then(result => {
          ...
          if (
            parseInt(this.state.trussNumberRepKMPlant8) + 9 !== null &&
            this.state.pruningNumber9RepKMPlant8 !== ''
          ) {
            this.saveTrussToDB9();
          } else {
          }
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepKMPlant8) + 9 != null &&
      this.state.pruningNumber9RepKMPlant8 !== null
    ) {
      let data9 = {
        trussNumber: parseInt(this.state.trussNumberRepKMPlant8) + 9,
        fruitDiameter: this.state.fruitDiameter9RepKMPlant8,
        setFruits: this.state.setFruits9RepKMPlant8,
        setFlowers: this.state.setFlowers9RepKMPlant8,
        pruningNumber: this.state.pruningNumber9RepKMPlant8,
        plantRow: '807',
        plantName: 'REP - KM5512',
        plantWeek: this.state.weekNumber,
        plantNumber: 8,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 8</Text>/ Row No. 807/ Week No.{' '}
        ...
        >
          ...
          >
            <View pointerEvents={this.state.KMPlant8Selected ? 'none' : 'auto'}>
              <View style={styles.formContainer}>
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumberRepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruitsRepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruitsRepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowersRepKMPlant8')
                    }
                    value={this.state.setFlowersRepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumberRepKMPlant8')
                    }
                    value={this.state.pruningNumberRepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameterRepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber1RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits1RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits1RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers1RepKMPlant8')
                    }
                    value={this.state.setFlowers1RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber1RepKMPlant8')
                    }
                    value={this.state.pruningNumber1RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter1RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber2RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits2RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits2RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers2RepKMPlant8')
                    }
                    value={this.state.setFlowers2RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber2RepKMPlant8')
                    }
                    value={this.state.pruningNumber2RepKMPlant8}
                  />
                  <View
                    style={{
                      borderRightColor: 'black',
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter2RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber3RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits3RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits3RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers3RepKMPlant8')
                    }
                    value={this.state.setFlowers3RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber3RepKMPlant8')
                    }
                    value={this.state.pruningNumber3RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter3RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber4RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits4RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits4RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers4RepKMPlant8')
                    }
                    value={this.state.setFlowers4RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber4RepKMPlant8')
                    }
                    value={this.state.pruningNumber4RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter4RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber5RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits5RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits5RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers5RepKMPlant8')
                    }
                    value={this.state.setFlowers5RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber5RepKMPlant8')
                    }
                    value={this.state.pruningNumber5RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter5RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber6RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits6RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits6RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers6RepKMPlant8')
                    }
                    value={this.state.setFlowers6RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber6RepKMPlant8')
                    }
                    value={this.state.pruningNumber6RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter6RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber7RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits7RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits7RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers7RepKMPlant8')
                    }
                    value={this.state.setFlowers7RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber7RepKMPlant8')
                    }
                    value={this.state.pruningNumber7RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter7RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput22(text, 'trussNumber8RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits8RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits8RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers8RepKMPlant8')
                    }
                    value={this.state.setFlowers8RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber8RepKMPlant8')
                    }
                    value={this.state.pruningNumber8RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter8RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.rowContainer222}>
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'trussNumber9RepKMPlant8')
                    }
                    blurOnSubmit={false}
                  ...
                  <TextInput
                    ...
                    enablesReturnKeyAutomatically={true}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFruits9RepKMPlant8')
                    }
                    blurOnSubmit={false}
                    value={this.state.setFruits9RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    onChangeText={text =>
                      this.updateTextInput(text, 'setFlowers9RepKMPlant8')
                    }
                    value={this.state.setFlowers9RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'pruningNumber9RepKMPlant8')
                    }
                    value={this.state.pruningNumber9RepKMPlant8}
                  />
                  ...
                  <TextInput
                    ...
                    returnKeyType={'done'}
                    onChangeText={text =>
                      this.updateTextInput(text, 'fruitDiameter9RepKMPlant8')
                    }
                  />
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepKMPlant8 <= 22 ||
                      this.state.fruitLoadRepKMPlant8 >= 40
                  ...
                  >
                    ...
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.fruitLoadRepKMPlant8}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepKMPlant8 <= 0 ||
                      this.state.floweringTrussssRepKMPlant8 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepKMPlant8}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepKMPlant8 <= 1 ||
                      this.state.settingTrussNumberRepKMPlant8 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepKMPlant8}
                      </Text>
                    </View>
                    <View
                      style={{
                  ...
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.harvestTrussRepKMPlant8}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <CheckBox
                  ...
                  uncheckedColor="red"
                  checkedColor="green"
                  title="KM Plant 8 completed"
                  checked={this.state.KMPlant8Selected}

...
export default class Ger2ClobogoRow extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <ScrollView keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.containerView}>
            <TouchableOpacity
              ...
              onPress={() =>
                this.props.navigation.navigate('Ger2ClobogoPlantsRow1')
              }
            >
            ...
            <TouchableOpacity
              style={styles.buttonContainer}
              onPress={() =>
                this.props.navigation.navigate('Ger2ClobogoPlantsRow2')
              }
            >
              <Text style={styles.buttonText}>Row 114/115</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>

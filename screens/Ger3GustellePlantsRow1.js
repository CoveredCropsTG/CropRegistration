...
export default class Ger3GustellePlantsRow1 extends Component {
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.ger3GustelleRow1EventPlant1);
    EventRegister.removeEventListener(this.ger3GustelleRow1EventPlant2);
    EventRegister.removeEventListener(this.ger3GustelleRow1EventPlant3);
    EventRegister.removeEventListener(this.ger3GustelleRow1EventPlant4);
    EventRegister.removeEventListener(this.ger3GustelleRow1EventPlant5);
  }

...
export default class Ger1DuellePlantsRow1 extends Component {
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.ger1DuelleRow1EventPlant1);
    EventRegister.removeEventListener(this.ger1DuelleRow1EventPlant2);
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.ger1DuelleRow1EventPlant1 = EventRegister.addEventListener(
      'ger1DuelleRow1EventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.ger1DuelleRow1EventPlant2 = EventRegister.addEventListener(
      'ger1DuelleRow1EventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.ger1DuelleRow1EventPlant3 = EventRegister.addEventListener(
      'ger1DuelleRow1EventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.ger1DuelleRow1EventPlant4 = EventRegister.addEventListener(
      'ger1DuelleRow1EventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.ger1DuelleRow1EventPlant5 = EventRegister.addEventListener(
      'ger1DuelleRow1EventPlant5',
      data5 => {
    ...
    if (plant1Selected == null || plant1Selected == true) {
      return (
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('Ger1DuelleRow1Plant1')}
        >
  ...
  renderElement2() {
    if (plant2Selected == null || plant2Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('Ger1DuelleRow1Plant2')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement3() {
    if (plant3Selected == null || plant3Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('Ger1DuelleRow1Plant3')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement4() {
    if (plant4Selected == null || plant4Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('Ger1DuelleRow1Plant4')}
        >
          <Text style={styles.buttonText}>
  ...
  renderElement5() {
    if (plant5Selected == null || plant5Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() => this.props.navigation.navigate('Ger1DuelleRow1Plant5')}
        >
          <Text style={styles.buttonText}>

...
export default class RepMerliceRow1Plant10 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantRepMerliceRow1Plant10 =
      this.onSubmitleavesPerPlantRepMerliceRow1Plant10.bind(this);
    ...
    this.leavesPerPlantRepMerliceRow1Plant10Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantRepMerliceRow1Plant10')
        .then(text1Value => {
          this.setState({
            leavesPerPlantRepMerliceRow1Plant10: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussRepMerliceRow1Plant10')
        .then(text2Value => {
          this.setState({
            fullySetTrussRepMerliceRow1Plant10: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthRepMerliceRow1Plant10')
        .then(text3Value => {
          this.setState({
            setTrussLengthRepMerliceRow1Plant10: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthRepMerliceRow1Plant10')
        .then(text4Value => {
          this.setState({
            weeklyGrowthRepMerliceRow1Plant10: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightRepMerliceRow1Plant10')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightRepMerliceRow1Plant10: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthRepMerliceRow1Plant10')
        .then(text6Value => {
          this.setState({
            leafLengthRepMerliceRow1Plant10: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthRepMerliceRow1Plant10')
        .then(text7Value => {
          this.setState({
            leafWidthRepMerliceRow1Plant10: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterRepMerliceRow1Plant10')
        .then(text8Value => {
          this.setState({
            stmDiameterRepMerliceRow1Plant10: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterRepMerliceRow1Plant10')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterRepMerliceRow1Plant10: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('MerliceRow1Plant10Selected')
        .then(text99Value => {
          this.setState({
            MerliceRow1Plant10Selected: JSON.parse(text99Value),
          });
    ...
    try {
      AsyncStorage.getItem('trussNumberRepMerliceRow1Plant10')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberRepMerliceRow1Plant10: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 1,
            });
            this.setState({
              trussNumber2RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 2,
            });
            this.setState({
              trussNumber3RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 3,
            });
            this.setState({
              trussNumber4RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 4,
            });
            this.setState({
              trussNumber5RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 5,
            });
            this.setState({
              trussNumber6RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 6,
            });
            this.setState({
              trussNumber7RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 7,
            });
            this.setState({
              trussNumber8RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 8,
            });
            this.setState({
              trussNumber9RepMerliceRow1Plant10:
                parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 9,
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruitsRepMerliceRow1Plant10')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsRepMerliceRow1Plant10: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersRepMerliceRow1Plant10')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersRepMerliceRow1Plant10: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberRepMerliceRow1Plant10')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberRepMerliceRow1Plant10: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterRepMerliceRow1Plant10')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterRepMerliceRow1Plant10: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1RepMerliceRow1Plant10')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1RepMerliceRow1Plant10: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1RepMerliceRow1Plant10')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1RepMerliceRow1Plant10: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1RepMerliceRow1Plant10')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1RepMerliceRow1Plant10: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1RepMerliceRow1Plant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1RepMerliceRow1Plant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2RepMerliceRow1Plant10')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2RepMerliceRow1Plant10: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2RepMerliceRow1Plant10')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2RepMerliceRow1Plant10: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2RepMerliceRow1Plant10')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2RepMerliceRow1Plant10: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2RepMerliceRow1Plant10')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2RepMerliceRow1Plant10: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3RepMerliceRow1Plant10')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3RepMerliceRow1Plant10: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3RepMerliceRow1Plant10')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3RepMerliceRow1Plant10: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3RepMerliceRow1Plant10')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3RepMerliceRow1Plant10: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3RepMerliceRow1Plant10')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3RepMerliceRow1Plant10: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4RepMerliceRow1Plant10')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4RepMerliceRow1Plant10: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4RepMerliceRow1Plant10')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4RepMerliceRow1Plant10: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4RepMerliceRow1Plant10')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4RepMerliceRow1Plant10: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4RepMerliceRow1Plant10')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4RepMerliceRow1Plant10: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5RepMerliceRow1Plant10')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5RepMerliceRow1Plant10: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5RepMerliceRow1Plant10')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5RepMerliceRow1Plant10: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5RepMerliceRow1Plant10')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5RepMerliceRow1Plant10: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5RepMerliceRow1Plant10')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5RepMerliceRow1Plant10: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6RepMerliceRow1Plant10')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6RepMerliceRow1Plant10: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6RepMerliceRow1Plant10')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6RepMerliceRow1Plant10: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6RepMerliceRow1Plant10')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6RepMerliceRow1Plant10: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6RepMerliceRow1Plant10')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6RepMerliceRow1Plant10: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7RepMerliceRow1Plant10')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7RepMerliceRow1Plant10: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7RepMerliceRow1Plant10')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7RepMerliceRow1Plant10: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7RepMerliceRow1Plant10')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7RepMerliceRow1Plant10: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7RepMerliceRow1Plant10')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7RepMerliceRow1Plant10: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8RepMerliceRow1Plant10')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8RepMerliceRow1Plant10: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8RepMerliceRow1Plant10')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8RepMerliceRow1Plant10: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8RepMerliceRow1Plant10')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8RepMerliceRow1Plant10: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8RepMerliceRow1Plant10')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8RepMerliceRow1Plant10: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9RepMerliceRow1Plant10')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9RepMerliceRow1Plant10: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9RepMerliceRow1Plant10')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9RepMerliceRow1Plant10: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9RepMerliceRow1Plant10')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9RepMerliceRow1Plant10: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9RepMerliceRow1Plant10')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9RepMerliceRow1Plant10: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadRepMerliceRow1Plant10')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadRepMerliceRow1Plant10: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssRepMerliceRow1Plant10')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssRepMerliceRow1Plant10: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberRepMerliceRow1Plant10')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberRepMerliceRow1Plant10: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussRepMerliceRow1Plant10')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussRepMerliceRow1Plant10: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (parseInt(this.state.setFruitsRepMerliceRow1Plant10)
        ? parseInt(this.state.setFruitsRepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits1RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits1RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits2RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits2RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits3RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits3RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits4RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits4RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits5RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits5RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits6RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits6RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits7RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits7RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits8RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits8RepMerliceRow1Plant10)
        : 0) +
      (parseInt(this.state.setFruits9RepMerliceRow1Plant10)
        ? parseInt(this.state.setFruits9RepMerliceRow1Plant10)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadRepMerliceRow1Plant10',
      this.state.fruitLoadRepMerliceRow1Plant10,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersRepMerliceRow1Plant10 === '') {
      ...
      div =
        parseInt(
          this.state.setFruitsRepMerliceRow1Plant10
            ? this.state.setFruitsRepMerliceRow1Plant10
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberRepMerliceRow1Plant10
            ? this.state.pruningNumberRepMerliceRow1Plant10
            : 0,
        );
      sub = 1 - div;
      add = (
        (parseInt(this.state.trussNumberRepMerliceRow1Plant10)
          ? parseInt(this.state.trussNumberRepMerliceRow1Plant10)
          : 0) + sub
      ).toFixed(2);
      this.setState({
    ...
    this.setItem(
      'harvestTrussRepMerliceRow1Plant10',
      this.state.harvestTrussRepMerliceRow1Plant10,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2RepMerliceRow1Plant10,
    );
      ...
      if (this.state.setFruits8RepMerliceRow1Plant10 === '') {
        if (this.state.setFruits7RepMerliceRow1Plant10 === '') {
          if (this.state.setFruits6RepMerliceRow1Plant10 === '') {
            if (this.state.setFruits5RepMerliceRow1Plant10 === '') {
              if (this.state.setFruits4RepMerliceRow1Plant10 === '') {
                if (this.state.setFruits3RepMerliceRow1Plant10 === '') {
                  if (this.state.setFruits2RepMerliceRow1Plant10 === '') {
                    if (this.state.setFruits1RepMerliceRow1Plant10 === '') {
                      if (this.state.setFruitsRepMerliceRow1Plant10 === '') {
                        ...
                        trussNum = parseInt(
                          this.state.trussNumberRepMerliceRow1Plant10,
                        );
                      ...
                      pruningSet = parseInt(
                        this.state.pruningNumber1RepMerliceRow1Plant10,
                      );
                      trussNum = parseInt(number);
                      settingFruit = parseInt(
                        this.state.setFruits1RepMerliceRow1Plant10,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = parseInt(
                      this.state.pruningNumber2RepMerliceRow1Plant10,
                    );
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(
                      this.state.setFruits2RepMerliceRow1Plant10,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = parseInt(
                    this.state.pruningNumber3RepMerliceRow1Plant10,
                  );
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(
                    this.state.setFruits3RepMerliceRow1Plant10,
                  );
                ...
                pruningSet = parseInt(
                  this.state.pruningNumber4RepMerliceRow1Plant10,
                );
                trussNum = parseInt(number4);
                settingFruit = parseInt(
                  this.state.setFruits4RepMerliceRow1Plant10,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = parseInt(
                this.state.pruningNumber5RepMerliceRow1Plant10,
              );
              trussNum = parseInt(number5);
              settingFruit = parseInt(
                this.state.setFruits5RepMerliceRow1Plant10,
              );
            ...
            pruningSet = parseInt(
              this.state.pruningNumber6RepMerliceRow1Plant10,
            );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2RepMerliceRow1Plant10,
    );
    ...
    if (this.state.setFlowers9RepMerliceRow1Plant10 === '') {
      if (this.state.setFlowers8RepMerliceRow1Plant10 === '') {
        if (this.state.setFlowers7RepMerliceRow1Plant10 === '') {
          if (this.state.setFlowers6RepMerliceRow1Plant10 === '') {
            if (this.state.setFlowers5RepMerliceRow1Plant10 === '') {
              if (this.state.setFlowers4RepMerliceRow1Plant10 === '') {
                if (this.state.setFlowers3RepMerliceRow1Plant10 === '') {
                  if (this.state.setFlowers2RepMerliceRow1Plant10 === '') {
                    if (this.state.setFlowers1RepMerliceRow1Plant10 === '') {
                      if (this.state.setFlowersRepMerliceRow1Plant10 === '') {
                        ...
                        flowering = parseInt(
                          this.state.setFlowersRepMerliceRow1Plant10,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberRepMerliceRow1Plant10 + 1;
                      ...
                      flowering = parseInt(
                        this.state.setFlowers1RepMerliceRow1Plant10,
                      );
                      flowerSetFruits = parseInt(
                        this.state.setFruits1RepMerliceRow1Plant10,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberRepMerliceRow1Plant10 + 2;

                    flowerPruningNumner = parseInt(
                      this.state.pruningNumber2RepMerliceRow1Plant10,
                    );
                    flowering = parseInt(
                      this.state.setFlowers2RepMerliceRow1Plant10,
                    );
                    flowerSetFruits = parseInt(
                      this.state.setFruits2RepMerliceRow1Plant10,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberRepMerliceRow1Plant10 + 3;

                  flowerPruningNumner = parseInt(
                    this.state.pruningNumber3RepMerliceRow1Plant10,
                  );
                  flowering = parseInt(
                    this.state.setFlowers3RepMerliceRow1Plant10,
                  );
                  flowerSetFruits = parseInt(
                    this.state.setFruits3RepMerliceRow1Plant10,
                  );
                ...
                flowering = parseInt(
                  this.state.setFlowers4RepMerliceRow1Plant10,
                );
                flowerSetFruits = parseInt(
                  this.state.setFruits4RepMerliceRow1Plant10,
                );
            ...
            flowerSetFruits = parseInt(
              this.state.setFruits6RepMerliceRow1Plant10,
            );
            summ =
              (flowering ? flowering : 0) +
              (flowerSetFruits ? flowerSetFruits : 0);
          ...
          flowerPruningNumner = parseInt(
            this.state.pruningNumber7RepMerliceRow1Plant10,
          );
          flowering = parseInt(this.state.setFlowers7RepMerliceRow1Plant10);
          flowerSetFruits = parseInt(
            this.state.setFruits7RepMerliceRow1Plant10,
          );
          summ =
            (flowering ? flowering : 0) +
            (flowerSetFruits ? flowerSetFruits : 0);
        ...
        flowerPruningNumner = parseInt(
          this.state.pruningNumber8RepMerliceRow1Plant10,
        );
      ...
      flowerPruningNumner = parseInt(
        this.state.pruningNumber9RepMerliceRow1Plant10,
      );
      ...
      if (this.state.trussNumberRepMerliceRow1Plant10 != null) {
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersRepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsRepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberRepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 1 != null) {
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 2 != null) {
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 3 != null) {
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 4 != null) {
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 5 != null) {
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 6 != null) {
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 7 != null) {
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 8 != null) {
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8RepMerliceRow1Plant10: JSON.stringify(
      ...
      if (parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 9 != null) {
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9RepMerliceRow1Plant10: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9RepMerliceRow1Plant10: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      MerliceRow1Plant10Selected: !this.state.MerliceRow1Plant10Selected,
    });
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        floweringTrussHeight:
          this.state.floweringTrussHeightRepMerliceRow1Plant10,
        ...
        lastWeekStmDiameter:
          this.state.lastWeekStmDiameterRepMerliceRow1Plant10,
      };
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberRepMerliceRow1Plant10 !== null &&
      this.state.pruningNumberRepMerliceRow1Plant10 !== null
    ) {
      let data = {
  ...
  saveTrussToDB1 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 1 != null &&
      this.state.pruningNumber1RepMerliceRow1Plant10 !== null
    ) {
      let data1 = {
  ...
  saveTrussToDB2 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 2 != null &&
      this.state.pruningNumber2RepMerliceRow1Plant10 !== null
    ) {
      let data2 = {
  ...
  saveTrussToDB3 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 3 !== null &&
      this.state.pruningNumber3RepMerliceRow1Plant10 !== null
    ) {
      let data3 = {
  ...
  saveTrussToDB4 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 4 != null &&
      this.state.pruningNumber4RepMerliceRow1Plant10 !== null
    ) {
      let data4 = {
  ...
  saveTrussToDB5 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 5 != null &&
      this.state.pruningNumber5RepMerliceRow1Plant10 !== null
    ) {
      let data5 = {
  ...
  saveTrussToDB6 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 6 != null &&
      this.state.pruningNumber6RepMerliceRow1Plant10 !== null
    ) {
      let data6 = {
  ...
  saveTrussToDB7 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 7 != null &&
      this.state.pruningNumber7RepMerliceRow1Plant10 !== null
    ) {
      let data7 = {
  ...
  saveTrussToDB8 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 8 != null &&
      this.state.pruningNumber8RepMerliceRow1Plant10 !== null
    ) {
      let data8 = {
  ...
  saveTrussToDB9 = () => {
    if (
      parseInt(this.state.trussNumberRepMerliceRow1Plant10) + 9 != null &&
      this.state.pruningNumber9RepMerliceRow1Plant10 !== null
    ) {
      let data9 = {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 10</Text>/ Row No. 123/ Week No.{' '}
        ...
        >
          ...
          >
            <View
              pointerEvents={
                this.state.MerliceRow1Plant10Selected ? 'none' : 'auto'
              }
            >
              <View style={styles.formContainer}>
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadRepMerliceRow1Plant10 <= 22 ||
                      this.state.fruitLoadRepMerliceRow1Plant10 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssRepMerliceRow1Plant10 <= 0 ||
                      this.state.floweringTrussssRepMerliceRow1Plant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssRepMerliceRow1Plant10}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberRepMerliceRow1Plant10 <= 1 ||
                      this.state.settingTrussNumberRepMerliceRow1Plant10 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}
                  >
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberRepMerliceRow1Plant10}
                      </Text>
                    </View>
                    <View
                      style={{
